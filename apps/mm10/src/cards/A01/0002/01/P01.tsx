...
import TitleIconSVG from '@/assets/A01/0002/01/title.svg';
import CheckIconSVG from '@/assets/A01/0002/01/check.svg';
    ...
    <Container headerInfo={null} useExtend>
      <ContentsContainer>
        ...
        <ItemContainer>
          ...
          <Contents>
            <ul>
              <li>소인수분해의 뜻을 알고, 자연수를 소인수분해 할 수 있다.</li>
              <li>소인수분해의 뜻을 알고, 약수를 구할 수 있다.</li>
            </ul>
          </Contents>
        </ItemContainer>
      </ContentsContainer>
