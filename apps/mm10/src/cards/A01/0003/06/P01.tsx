...
function P01() {
  ...
  const hasEmptyValue = useMemo(() => {
    return getEmptyValue([getValueInputData(0, 'TEXT-0') as string, getValueInputData(1, 'TEXT-0') as string]);
  }, [getValueInputData]);
    ...
    <Container
      ...
      questionInfo={{
        text: (
          <Title>
            <span>
              문제<span>1</span> <GradeCheck isGradeAll />
            </span>
          ...
          <Items>
            <Item>
              <Question>
                ...
                <span>×</span>5, 2<span>×</span>3<span>×</span>5<sup>2</sup>
              </Question>
              <Input
                width='312px'
                inputSize='medium'
