...
const imgContent = {
  imgSrc: `/L07/C05/A03/ME1-L07-C05-A03-P01.jpg`,
  imgAlt: `여학생이 해가 높게 뜬 사막에서 산등성이를 바라보고 있다.`,
};
...
const P01 = () => {
  ...
  const pageKey = currentPage.toLowerCase() as 'p01';
      ...
      <Box>
        <Typography>
          ...
          <Dropdown
            ...
            ariaLabel='2번째 답 선택칸'
          />
          . I couldn’t find water in the desert.
        </Typography>
      </Box>
    </BoxWrap>
  );
  ...
  const handleDropdownClick = (index: number, value: string) => {
    ...
    setCardData(prev => ({ ...prev, p01: { ...prev[pageKey], answer: updatedAnswers } }));
  ...
  const submitAnswer = () => {
    ...
    setCardData(prev => ({ ...prev, p01: { ...prev[pageKey], isSubmitted: true, isCorrect: isCorrect } }));
