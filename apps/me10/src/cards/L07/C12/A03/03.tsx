...
const P03 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(L07C12A03);
  ...
  const questionInfo: IQuestionProps = {
    text: (
      <Box>
        ...
        <Typography>잘 듣고, 빈칸에 알맞은 말을 써 봅시다.</Typography>
      </Box>
    ),
  ...
  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L07/C12/A03/ME1-L07-C12-A03-P03.mp3',
    captionSrc: '/L07/C12/A03/ME1-L07-C12-A03-P03.srt',
  };
  ...
  return (
    ...
    >
      <Box background={'white'} hAlign='center' useRound>
        <Box>
          The movie <span style={{ fontStyle: 'italic' }}>Moana</span> is about a girl and her
          <br />
          <Input
            name='value'
            ariaLabel={'답란'}
