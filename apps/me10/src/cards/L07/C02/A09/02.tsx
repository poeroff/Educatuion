...
const P02 = () => {
  ...
  const imageInfo = {
    src: '/L07/C02/A09/ME1-L07-C02-A09-P02.jpg',
    alt: '빅벤',
    txt: 'Big Ben',
    exp: (
      <>
        <IndentTypography useGap={false}>- in the UK</IndentTypography>
        <IndentTypography useGap={false}>- It is a big clock.</IndentTypography>
      </>
    ),
  };
  ...
  const data: IListenAndAnswer[] = [
    ...
    },
    {
      ...
      audioSrc: '/L07/C02/A09/ME1-L07-C02-A09-P02.mp3',
    },
    {
      type: 'A',
      labelColor: 'var(--color-blue-100)',
  ...
  const solution: React.ReactNode = (
    <>
      <Box>
        <BlockTypography>A: Do you know about Big Ben?</BlockTypography>
        <BlockTypography style={{ marginLeft: '40px' }}>It’s in the UK.</BlockTypography>
      </Box>
      <Box>
      ...
      <Box>
        <BlockTypography>A: Sure. It is a big clock.</BlockTypography>
      </Box>
    </>
  );
      ...
      if (userSubmissionList && userSubmissionList.length > 0) {
        ...
        setCardData(prev => ({
          ...
          p02: {
            ...
            answer3: userSubmissionList[0].inputData[5]?.value || cardData.p02.answer3 || '',
