...
const P03 = () => {
  ...
  const imageInfo = {
    src: '/L07/C02/A09/ME1-L07-C02-A09-P03.jpg',
    alt: '에펠탑',
    txt: 'The Eiffel Tower',
    exp: (
      <>
        <IndentTypography useGap={false}>- in France</IndentTypography>
        <IndentTypography useGap={false}>- It has the names of 72 scientists on it.</IndentTypography>
      </>
    ),
  };
  ...
  const data: IListenAndAnswer[] = [
    ...
    },
    {
      ...
      audioSrc: '/L07/C02/A09/ME1-L07-C02-A09-P03.mp3',
    },
    {
      type: 'A',
      labelColor: 'var(--color-blue-100)',
  ...
  const solution: React.ReactNode = (
    <>
      <Box>
        <BlockTypography>A: Do you know about the Eiffel Tower?</BlockTypography>
        <BlockTypography style={{ marginLeft: '40px' }}>It’s in France.</BlockTypography>
      </Box>
      <Box>
      ...
      <Box>
        <BlockTypography>A: Sure. It has the names of 72 scientists on it.</BlockTypography>
      </Box>
    </>
  );
      ...
      if (userSubmissionList && userSubmissionList.length > 0) {
        ...
        setCardData(prev => ({
          ...
          p03: {
            ...
            answer3: userSubmissionList[0].inputData[5]?.value || cardData.p03.answer3 || '',
            isAudioPlayed: [userSubmissionList[0].inputData[2]?.value || cardData.p03.isAudioPlayed?.[0] || false],
            isSubmitted,
      ...
      <Box hAlign='center'>
        ...
        <Box>
          ...
          <BoxWrap marginBottom={'18px'} lineHeight={'40px'}>
            ...
            <Box width={'20%'} hAlign='flex-end' vAlign='flex-start' minWidth='131px' marginRight='20px'>
              <HiddenDiv isHidden={isEmptyAudioData(cardData.p03.audioData?.[1])}>
                <SimpleAudioPlayer
                  ref={ref => {
