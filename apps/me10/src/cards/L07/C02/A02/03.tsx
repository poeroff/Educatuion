...
const P03 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(L07C02A02);
    ...
    >
      <BoxWrap height='340px' paddingLeft='16px' paddingRight='16px'>
        <Box useFull width='50%'>
          <PinchZoom>
            <Image
              src={'/L07/C02/A02/ME1-L07-C02-A02-P03.jpg'}
              width='100%'
              height='100%'
              alt={`매우 기쁘고 행복한 표청을 짓고 있는 Tim이 Sera에게 질문하고 있고, Sera는 "Sure. It gives you candy and chocolate."라고 답하고 있는 모습. Tim의 말풍선은 비어있다.`}
            />
          </PinchZoom>
        </Box>
        <Box useFull width='50%'>
