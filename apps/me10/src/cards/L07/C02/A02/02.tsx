  ...
  const data: IListenAndAnswer[] = [
    {
      ...
      answer: '너는 이것에 대해 알고 있니?',
    },
    {
      name: 'Sera :',
      question: `Yes. It's a sweet machine.`,
      answer: '응. 그것은 달콤한 기계야.',
    },
  ];
  ...
  return (
    <Container headerInfo={headerInfo} questionInfo={questionInfo} vAlign='center'>
      ...
      <BoxWrap height='354px'>
        <Box marginTop='14px'>
          <VideoPlayer videoSrc={'/L07/C02/A02/ME1-L07-C02-A02-P02.mp4'} srtFile={'/L07/C02/A02/ME1-L07-C02-A02-P02.srt'} width={465} />
        </Box>
        <Box height='340px'>
