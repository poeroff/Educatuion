...
const P01 = () => {
  ...
  const data: IListenAndAnswer[] = [
    {
      type: 'A',
      content: 'Can you tell me more about Kiruna?',
      color: 'var(--color-blue-100)',
      audioSrc: '/L07/C02/A06/ME1-L07-C02-A06-P01-1.mp3',
    },
    {
      type: 'B',
      content: `Sure. It's a beautiful city in Sweden.`,
      color: 'var(--color-orange-200)',
      audioSrc: '/L07/C02/A06/ME1-L07-C02-A06-P01-2.mp3',
    },
  ];
