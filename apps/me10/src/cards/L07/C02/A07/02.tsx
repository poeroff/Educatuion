...
const P02 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(L07C02A07);
  const { userId } = useRecoilValue(studentAtom);
  const pageIds = useRecoilValue(pageIdsAtom);
  const pageData = useRecoilValue(pageDataAtom);
  const pageNo = 'P02';
  const audioSrc = '/L07/C02/A07/ME1-L07-C02-A07-P02.mp3';
