...
const dataTop: IListenAndAnswer[] = [
  {
    type: 'A',
    content: <>How can we get there?</>,
    color: 'var(--color-blue-100)',
  },
  {
    type: 'B',
    content: <>Go to the second floor and turn right.</>,
...
const dataBottom: IListenAndAnswer[] = [
  {
    type: 'A',
    content: <>There are so many new places.</>,
    color: 'var(--color-blue-100)',
  },
  {
    type: 'B',
    content: <>Wow, I'm so excited!</>,
    color: 'var(--color-yellow-100)',
  },
];
        ...
        <BoxWrap flexDirection='column'>
          <Box display='flex' flexDirection='column'>
            <BoxWrap marginBottom={10}>
              <Typography useGap={false}>길 묻고 답하기</Typography>
            </BoxWrap>
            <List data={dataTop}>
          ...
          <Box display='flex' flexDirection='column' marginTop='24px'>
            <BoxWrap marginBottom={10}>
              <Typography useGap={false}>희망•기대 표현하기</Typography>
            </BoxWrap>
