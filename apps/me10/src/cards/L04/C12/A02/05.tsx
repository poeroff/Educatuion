...
import { L04C12A02, wordArr } from './store';

const P05 = () => {
  const { changeData, initData, submitDataWithResult, saveData } = usePageData();
  const [cardData, setCardData] = useRecoilState(L04C12A02);
  ...
  const question = (
    <>
      <Typography>He was late for school. He</Typography>
      <Input
        value={cardData.p05.answer}
      ...
      />
      <Typography>on his shoes quickly.</Typography>
    </>
  );
