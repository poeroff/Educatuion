...
const P01 = () => {
  ...
  const content1: React.ReactNode = <Typography>We’ll go on a field trip tomorrow.</Typography>;
  const content2: React.ReactNode = (
    <Typography>
      Wow, <Typography type='blank' width='300px' underlineColor='var(--color-black)'></Typography>!
    </Typography>
  );
