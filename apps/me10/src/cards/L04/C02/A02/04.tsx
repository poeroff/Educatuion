...
const P04 = () => {
  ...
  const data: IListenAndAnswer[] = [
    ...
    {
      name: 'Mom :',
      question: `Moon Restaurant is in the park.`,
      answer: '달 식당은 공원에 있단다.',
    },
  ];
  ...
  return (
    <Container headerInfo={headerInfo} questionInfo={questionInfo} vAlign='center'>
      ...
      <BoxWrap height='354px'>
        <Box marginTop='14px'>
          <VideoPlayer videoSrc={'/L04/C02/A02/ME1-L04-C02-A02-P04.mp4'} srtFile={'/L04/C02/A02/ME1-L04-C02-A02-P04.srt'} width={465} />
        </Box>
        <Box height='340px'>
