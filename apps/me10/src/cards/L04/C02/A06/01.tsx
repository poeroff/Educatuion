...
const P01 = () => {
  ...
  const questionInfo: IQuestionProps = {
    text: '지도를 보며 다음 대화문을 듣고, 따라 말해 보세요.',
  };

  const data: IListenAndAnswer[] = [
    {
      type: 'A',
      content: <Typography>Where is the library?</Typography>,
      color: 'var(--color-blue-100)',
      audioSrc: '/L04/C02/A06/ME1-L04-C02-A06-P01-1.mp3',
    },
    {
      type: 'B',
      content: (
        <>
          <Box>
            <Typography>Go straight one block and turn left.</Typography>
          </Box>
          <Box>
            <Typography>It's next to the pizza store.</Typography>
          </Box>
        </>
      ),
      color: 'var(--color-orange-200)',
      audioSrc: '/L04/C02/A06/ME1-L04-C02-A06-P01-2.mp3',
    },
  ];
    ...
    >
      <Box vAlign='center' hAlign='center' marginBottom='24px'>
        <PinchZoom pinchType={'image'}>
          <Image alt='' ariaDescribedby='img_desc' src={'/L04/C02/A06/ME1-L04-C02-A06-P01.jpg'} width='320px' />
        </PinchZoom>
