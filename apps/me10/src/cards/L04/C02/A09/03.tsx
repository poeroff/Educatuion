...
const P03 = () => {
  ...
  const data: IListenAndAnswer[] = [
    {
      ...
      audioSrc: '/L04/C02/A09/ME1-L04-C02-A09-P03-1.mp3',
    },
    {
      type: 'B',
    ...
    },
    {
      ...
      labelColor: 'var(--color-blue-100)',
      audioSrc: '/L04/C02/A09/ME1-L04-C02-A09-P03-2.mp3',
    },
    {
      type: 'B',
      content: (
  ...
  const solution: React.ReactNode = (
    <>
      ...
      <BlockTypography>B: Wow, I’m so excited! Let’s go to the clothes shop.</BlockTypography>
      <BlockTypography>A: Okay. How can we get there?</BlockTypography>
      <BlockTypography>B: It’s on the first floor. It’s between the bag store and the candy shop.</BlockTypography>
    </>
  );
