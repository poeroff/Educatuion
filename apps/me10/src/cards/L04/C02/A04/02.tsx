...
const P02 = () => {
  ...
  const questionInfo: IQuestionProps = {
    text: 'A가 되어 즐거운 제안을 하는 문장을 완성한 후, 대화를 연습해 봅시다.',
  };
  ...
  const data: IListenAndAnswer[] = [
    {
      ...
      content: (
        <Box vAlign='middle'>
          <Typography useGap={false}>Let's &nbsp;</Typography>
          <Input
            maxLength={50}
    ...
    },
    {
      ...
      content: (
        <Box>
          <Typography useGap={false}>Really? I’m so excited!</Typography>
        </Box>
      ),
      color: 'var(--color-orange-100)',
      audioSrc: '/L04/C02/A04/ME1-L04-C02-A04-P02.mp3',
    },
  ];
