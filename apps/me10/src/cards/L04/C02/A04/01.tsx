  ...
  const data: IListenAndAnswer[] = [
    {
      ...
      content: (
        <Box>
          <Typography useGap={false}>Let's go to the amusement park.</Typography>
        </Box>
      ),
      audioSrc: '/L04/C02/A04/ME1-L04-C02-A04-P01-1.mp3',
    },
    {
      type: 'B',
      ...
      audioSrc: '/L04/C02/A04/ME1-L04-C02-A04-P01-2.mp3',
    },
  ];
