...
const P09 = () => {
  ...
  const isAllFilled = useMemo(() => Object.values(cardData.p09.audioData ?? {}).every(val => val), [cardData.p09.audioData]);
  ...
  const audioPrefix = '/L01/SP02/ME1-L01-SP02-P09';
  ...
  const data: IListenAndAnswer[] = [
    {
      ...
      content: <>Mira, do you like music?</>,
      audioSrc: audioPrefix + '-01' + audioSurfix,
    },
    {
      type: 'B',
      color: 'var(--color-orange-200)',
      content: <>Yes, I do. K-pop is my favorite music.</>,
  ...
  return (
    <Container
      ...
      useExtend
      submitDisabled={cardData.p09.isSubmitted || !isAllFilled}
      submitLabel='완료하기'
      submitBtnColor={isAllFilled && !cardData.p09.isSubmitted ? EStyleButtonTypes.PRIMARY : EStyleButtonTypes.SECONDARY}
    >
      <Box hAlign='center'>
        <List data={data}>
          {({ value, index = 1 }: { value?: IListenAndAnswer; index?: number }) => (
            <BoxWrap>
              ...
              <Box hAlign='flex-end'>
                ...
                <Recorder
                  recorderIndex={index}
                  initialData={cardData.p09.audioData?.[index]}
