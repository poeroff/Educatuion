...
const P11 = () => {
  ...
  const isAllFilled = useMemo(() => Object.values(cardData.p11.audioData ?? {}).every(val => val), [cardData.p11.audioData]);
  const disabled = useMemo(() => !cardData.p11.isSubmitted && !isAllFilled, [cardData.p11.isSubmitted, isAllFilled]);
  ...
  }, [cardData.p11.isSubmitted, isAllFilled, isShowAnswer]);
  ...
  return (
    <Container
      ...
      submitLabel={cardData.p11.isSubmitted ? (isShowAnswer ? '답안 닫기' : '답안 보기') : '완료하기'}
    ...
    >
      <BoxWrap height='60px'>
        ...
        <OverlayTooltip
          ...
          isShow
        >
          <Typography size={EStyleFontSizes['X-MEDIUM']}>What kind of movies do you like?</Typography>
        </OverlayTooltip>
        <Box marginLeft='350px' vAlign='flex-start'>
          <SimpleAudioPlayer
            ref={ref => {
              audioRefs.current[1] = ref;
            }}
            audioSrc={'/L01/SP02/ME1-L01-SP02-P11.mp3'}
            ariaLabel={'대화 듣기 버튼'}
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isShowAnswer}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box marginTop='12px'>
            <Typography usePre>{cardData.p11.solution}</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
