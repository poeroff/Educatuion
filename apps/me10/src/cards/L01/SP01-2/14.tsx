...
const P14 = () => {
  ...
  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L01/SP01-1/ME1-L01-SP01-1-P10.mp3',
    captionSrc: '/L01/SP01-1/ME1-L01-SP01-1-P10.srt',
  };
      ...
      <Box marginTop='15px'>
        <Box hAlign='flex-start'>
          <Box display='flex' marginRight='8px' alignSelf='start'>
            ...
            <Typography>Hi, I'm Judy. Nice to</Typography>
            <Dropdown
        ...
        <Box display='flex' alignItems='center' marginTop={10}>
          ...
          <Typography>Nice to meet you, too. My name is Max.</Typography>
        </Box>
      </Box>
    </HE01102>
  );
