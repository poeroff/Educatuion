...
const P02 = () => {
  ...
  const content = `This box is my school survival kit. 
  I have many things in it. First, I have some sticky notes. 
  I use them on the first day. I write your names and remember them. Next, 
  I have some candies. These are for you. They’re sweet, like your smiles.
  `;
  return (
    <Container
      ...
      <BoxWrap useFull>
        <Box vAlign={'center'} hAlign={'center'} useFull useRound>
          <Box padding={'0px 20px 0px 20px'}>
            ...
            and candies in her school survival kit.
          </Box>
        </Box>
