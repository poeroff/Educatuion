...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(L01C12A04);
  ...
  const content: React.ReactNode = <Typography>My name is Alicia. Nice to meet you.</Typography>;
