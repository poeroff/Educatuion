...
const page = 'P01';
const answers = ['nervous', 'ervous'];
const answerText = '(n)ervous';
const headerText = 'Words and Expressions';
const questionText = '1. 그림을 보고, 빈칸에 알맞은 말을 써 봅시다.';
const text = ['I’m n', ' on the first day of', 'school.'];
const imageSrc = '/L01/C12/A02/ME1-L01-C12-A02-P01.jpg';
const alt = '여자 아이가 복도의 교실 문 앞에서 긴장하며 서 있는 모습';
      ...
      <BoxWrap>
        ...
        <Box>
          <Box lineHeight='42px' paddingTop={'70px'}>
            ...
            <Typography title='빈칸' type='blank' boxColor='var(--color-black)' width='80px' />
            <Typography style={{ padding: '4px 12px' }}>{text[1]}</Typography>
            <Typography style={{ padding: '4px 12px' }}>{text[2]}</Typography>
          </Box>
          <Box display='flex'>
