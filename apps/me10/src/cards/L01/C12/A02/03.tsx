...
const page = 'P03';
const answers = ['sticky', 'ticky'];
const answerText = '(s)ticky';
const headerText = 'Words and Expressions';
const questionText = '3. 그림을 보고, 빈칸에 알맞은 말을 써 봅시다.';
const text = ['He writes ideas on the s', ' note.'];
const imageSrc = '/L01/C12/A02/ME1-L01-C12-A02-P03.jpg';
const alt = '남자 아이가 책상 앞에 앉아 포스트잇에 무언가를 적고 있는 모습';
