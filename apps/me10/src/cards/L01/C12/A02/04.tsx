...
const page = 'P04';
const answers = ['remember', 'emember'];
const answerText = '(r)emember';
const headerText = 'Words and Expressions';
const questionText = '4. 그림을 보고, 빈칸에 알맞은 말을 써 봅시다.';
const text = ['She doesn’t r', ' my name.'];
const imageSrc = '/L01/C12/A02/ME1-L01-C12-A02-P04.jpg';
const alt = '책을 들고 있는 여자 아이가 갸우뚱거리고 있고 주변에 물음표가 떠다니고 있는 모습';
...
const P04 = () => {
  ...
  const { userAnswer, isSubmitted, isCorrect } = cardData.p04;
  ...
  const handleInputChange: ChangeEventHandler<HTMLInputElement> = e => {
    setCardData(prev => ({ ...prev, p04: { ...prev.p04, userAnswer: e.target.value } }));
      ...
      <BoxWrap>
        ...
        <Box>
          <Box lineHeight='42px' paddingTop={'70px'}>
            ...
            <Typography title='빈칸' type='blank' boxColor='var(--color-black)' width='80px'></Typography>
