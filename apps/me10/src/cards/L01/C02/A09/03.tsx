...
const P03 = () => {
  ...
  const questionInfo = {
    text: `B가 되어 좋아하는 동물에 대해 묻는 말에 대답하는 대사를 완성한 후, 대화를 연습해 봅시다.`,
  };
  ...
  const data: IListenAndAnswer[] = [
    {
      ...
      audioSrc: '/L01/C02/A09/ME1-L01-C02-A09-P03-1.mp3',
    },
    {
      type: 'B',
    ...
    },
    {
      type: 'A',
      labelColor: 'var(--color-blue-100)',
      audioSrc: '/L01/C02/A09/ME1-L01-C02-A09-P03-2.mp3',
    },
    {
      type: 'B',
      labelColor: 'var(--color-orange-200)',
  ...
  return (
    <Container
      ...
      submitDisabled={isSubmitDisabled || cardData.p03.isSubmitted}
      submitBtnColor={
        isSubmitDisabled ? EStyleButtonTypes.SECONDARY : !cardData.p03.isSubmitted ? EStyleButtonTypes.PRIMARY : EStyleButtonTypes.SECONDARY
      }
    >
      <Box>
        ...
        <BoxWrap marginBottom={'18px'} lineHeight={'40px'}>
          ...
          <Box width={'80%'} whiteSpace='nowrap'>
            <Typography usePre>What’s your favorite animal?</Typography>
          </Box>
          <Box width={'20%'} hAlign='flex-end' vAlign='flex-start'>
