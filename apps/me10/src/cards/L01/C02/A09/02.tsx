...
const P02 = () => {
  ...
  const questionInfo = {
    text: `A가 되어 좋아하는 음식에 대해 묻는 대사를 완성한 후, 대화를 연습해 봅시다.`,
  };
  ...
  const data: IListenAndAnswer[] = [
    ...
    },
    {
      ...
      audioSrc: '/L01/C02/A09/ME1-L01-C02-A09-P02-1.mp3',
    },
    {
      type: 'A',
      labelColor: 'var(--color-blue-100)',
    },
    {
      type: 'B',
      labelColor: 'var(--color-orange-200)',
      audioSrc: '/L01/C02/A09/ME1-L01-C02-A09-P02-2.mp3',
    },
  ];
  ...
  return (
    <Container
      ...
      submitDisabled={isSubmitDisabled || cardData.p02.isSubmitted}
      submitBtnColor={
        isSubmitDisabled ? EStyleButtonTypes.SECONDARY : !cardData.p02.isSubmitted ? EStyleButtonTypes.PRIMARY : EStyleButtonTypes.SECONDARY
      }
    >
      <Box>
        ...
        <BoxWrap marginBottom={'18px'} lineHeight={'40px'}>
          ...
          <Box width={'80%'} whiteSpace='nowrap'>
            <Typography usePre>{'Hi. My name is Mina.\nNice to meet you, too.'}</Typography>
          </Box>
          <Box width={'20%'} hAlign='flex-end' vAlign='flex-start'>
        ...
        <BoxWrap marginBottom={'18px'} lineHeight={'40px'}>
          ...
          <Box width={'80%'} whiteSpace='nowrap'>
            <Typography>My favorite food is pizza.</Typography>
          </Box>
          <Box width={'20%'} hAlign='flex-end' vAlign='flex-start'>
            <HiddenDiv
              isHidden={
