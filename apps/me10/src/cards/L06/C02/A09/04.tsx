...
const P04 = () => {
  ...
  const imageInfo = {
    src: '/L06/C02/A09/ME1-L06-C02-A09-P04.jpg',
    alt: '콘서트장에 놀러가 공연을 즐기고 있는 남학생',
    exp: 'go to a concert',
  };
  ...
  const data: IListenAndAnswer[] = [
    {
      ...
      audioSrc: '/L06/C02/A09/ME1-L06-C02-A09-P04.mp3',
    },
    {
      type: 'B',
  ...
  const solution: React.ReactNode = (
    <>
      ...
      <BlockTypography>B: I want to go to a concert. I’m interested in music.</BlockTypography>
    </>
  );
    ...
    if (pageId) {
      ...
      if (userSubmissionList && userSubmissionList.length > 0) {
        ...
        setCardData(prev => ({
          ...
          p04: {
            ...prev.p04,
            answer1: userSubmissionList[0].inputData[2]?.value || cardData.p04.answer1 || '',
            answer2: userSubmissionList[0].inputData[3]?.value || cardData.p04.answer2 || '',
            isAudioPlayed: [userSubmissionList[0].inputData[1]?.value || cardData.p04.isAudioPlayed?.[0] || false],
            isSubmitted,
            audioData: newAudioData,
          },
        }));
        console.log('cardData.p04', cardData.p04);
      }
            ...
            <Box width={'80%'}>
              ...
              <Typography usePre>
                ...
                <Dropdown
                  ...
                  selectedValue={cardData.p04.answer2}
