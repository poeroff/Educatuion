...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(L06C02A02);
    ...
    >
      <BoxWrap height='340px' paddingLeft='16px' paddingRight='16px'>
        <Box useFull width='50%'>
          <PinchZoom>
            <Image
              src={'/L06/C02/A02/ME1-L06-C02-A02-P01.jpg'}
              width='418px'
              height='270px'
              alt={`비버가 스케이트장 앞에서 Luca라는 펭귄에게 "What are you interested in, Luca?"라고 묻고 있는 모습. Luca의 말풍선이 비어있다.`}
            />
          </PinchZoom>
        </Box>
        <Box useFull width='50%'>
