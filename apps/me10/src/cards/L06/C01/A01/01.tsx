...
const dataTop: IListenAndAnswer[] = [
  ...
  {
    type: 'B',
    content: <>I want to take swimming lessons.</>,
...
const dataBottom: IListenAndAnswer[] = [
  ...
  {
    type: 'B',
    content: <>I'm interested in sports.</>,
    color: 'var(--color-yellow-100)',
  },
];
        ...
        <BoxWrap flexDirection='column'>
          <Box display='flex' flexDirection='column'>
            <BoxWrap marginBottom={10}>
              <Typography useGap={false}>바람•소원 묻고 답하기</Typography>
            </BoxWrap>
            <List data={dataTop}>
          ...
          <Box display='flex' flexDirection='column' marginTop='24px'>
            <BoxWrap marginBottom={10}>
              <Typography useGap={false}>관심사 묻고 답하기</Typography>
            </BoxWrap>
