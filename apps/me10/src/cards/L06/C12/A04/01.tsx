...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(L06C12A04);
  ...
  const content: React.ReactNode = <Typography>What do you want to do on a free day?</Typography>;
