...
const P01 = () => {
  ...
  const content2 = ` person in the future. I will listen to others and think of their feelings. I will help
  people in need around the world. How about you? Who do you want to be in the future?`;

  const data = [{ text: 'brave' }, { text: 'caring' }, { text: 'smart' }];
    ...
    text: (
      <>
        <Box marginRight='10px'>
          ...
          <Typography fontSize='32px'>다음 글에서 빈칸에 들어갈 말로 알맞은 것을 골라 봅시다.</Typography>
        </Box>
      </>
    ),
