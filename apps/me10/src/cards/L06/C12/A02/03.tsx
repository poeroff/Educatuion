...
import { L06C12A02, wordArr } from './store';

const P03 = () => {
  const { changeData, initData, submitDataWithResult, saveData } = usePageData();
  const [cardData, setCardData] = useRecoilState(L06C12A02);
  ...
  const question = (
    <>
      <Typography>She wants to be a(n)</Typography>
      <Input
        value={cardData.p03.answer}
      ...
      />
      <Typography>and go to the moon.</Typography>
    </>
  );
