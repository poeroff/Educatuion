...
const question = 'Taeho is interested in playing the guitar.';
...
const P01 = () => {
  ...
  const questionInfo: IQuestionProps = {
    text: '7. 잘 듣고, 대화의 내용과 일치하면 T, 일치하지 않으면 F에 표시해 봅시다.',
    mark: getMarking(isSubmitted, isCorrect),
  };

  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L06/C12/A03/ME1-L06-C12-A03-P03.mp3',
    captionSrc: '/L06/C12/A03/ME1-L06-C12-A03-P03.srt',
  };
  ...
  return (
    <Container
      ...
      submitDisabled={answer === undefined}
