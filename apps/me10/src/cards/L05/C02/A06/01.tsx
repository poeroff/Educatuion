...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(L05C02A06);
  ...
  const data: IListenAndAnswer[] = [
    {
      type: 'A',
      content: <Typography>Why don't you play soccer with me?</Typography>,
      color: 'var(--color-blue-100)',
      audioSrc: '/L05/C02/A06/ME1-L05-C02-A06-P01-1.mp3',
    },
    {
      type: 'B',
      content: <Typography>Sure. That sounds good!</Typography>,
      color: 'var(--color-orange-200)',
      audioSrc: '/L05/C02/A06/ME1-L05-C02-A06-P01-2.mp3',
    },
  ];
