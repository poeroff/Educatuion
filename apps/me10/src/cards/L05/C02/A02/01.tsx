...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(L05C02A02);
    ...
    >
      <BoxWrap height='340px' paddingLeft='16px' paddingRight='16px'>
        <Box useFull width='50%'>
          <PinchZoom>
            <Image
              src={'/L05/C02/A02/ME1-L05-C02-A02-P01.jpg'}
              width='418px'
              height='270px'
              alt={`판다가 Sophie라는 다람취에게 "What are you going to do, Sophie?"라며 묻고 있고, Sophie는 도토리를 믹서기에 넣고 있는 모습. Sophie의 말풍선이 비어있다.`}
            />
          </PinchZoom>
        </Box>
        <Box useFull width='50%'>
