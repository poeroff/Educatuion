...
const P02 = () => {
  ...
  const data: IListenAndAnswer[] = [
    {
      name: 'A :',
      question: `What are you going to do, Sophie?`,
      answer: 'Sophie, 너는 무엇을 할 거니?',
    },
    {
      name: 'Sophie :',
      question: `I'm going to make juice for you.`,
      answer: '너를 위해 주스를 만들 거야.',
    },
  ];
  ...
  return (
    <Container headerInfo={headerInfo} questionInfo={questionInfo} vAlign='center'>
      ...
      <BoxWrap height='354px'>
        <Box marginTop='14px'>
          <VideoPlayer videoSrc={'/L05/C02/A02/ME1-L05-C02-A02-P02.mp4'} srtFile={'/L05/C02/A02/ME1-L05-C02-A02-P02.srt'} width={465} />
        </Box>
        <Box height='340px'>
