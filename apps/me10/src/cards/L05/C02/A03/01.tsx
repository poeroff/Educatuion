...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(L05C02A03);
  ...
  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L05/C02/A03/ME1-L05-C02-A03-P01.mp3',
    captionSrc: '/L05/C02/A03/ME1-L05-C02-A03-P01.srt',
  };

  const imageList: IImageList[] = [
    {
      src: '/L05/C02/A03/ME1-L05-C02-A03-P01-01.jpg',
      alt: '등산을 하고 있는 여자 아이',
      answer: false,
    },
    {
      src: '/L05/C02/A03/ME1-L05-C02-A03-P01-02.jpg',
      alt: '서핑을 하고 있는 여자 아이',
      answer: true,
    },
    {
      src: '/L05/C02/A03/ME1-L05-C02-A03-P01-03.jpg',
      alt: '자전거를 타고 있는 여자 아이',
      answer: false,
    },
  ];

  const questionText = 'What is Emma going to do this weekend?';
