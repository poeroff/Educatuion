  ...
  const data: IListenAndAnswer[] = [
    {
      ...
      audioSrc: '/L05/C02/A04/ME1-L05-C02-A04-P01-1.mp3',
    },
    {
      type: 'B',
      ...
      content: (
        <Box>
          <Typography useGap={false}>I’m going to play soccer.</Typography>
        </Box>
      ),
      audioSrc: '/L05/C02/A04/ME1-L05-C02-A04-P01-2.mp3',
    },
  ];
