...
const P02 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(L03C02A06);
  ...
  const questionInfo = {
    text: `A가 되어 감정이나 상태를 말하는 문장을 완성한 후, 대화를 연습해 봅시다.`,
  };
  ...
  const data = {
    1: {
      ...
      content: (
        <>
          <Box>
            <Typography>You look </Typography>
            <Input
    ...
    2: {
      ...
      content: <Typography>I lost my smartphone.</Typography>,
    },
  };
      ...
      <Box vAlign='center'>
        ...
        <Box width={'20%'} hAlign='flex-end' vAlign='center'>
          {!isEmptyAudioData(cardData[pageKey].audioData?.[1]) ? (
            <SimpleAudioPlayer audioSrc={'/L03/C02/A06/ME1-L03-C02-A06-P02.mp3'} onEnded={handleAudioEnded} ref={audioRef} />
          ) : null}
        </Box>
      </Box>
    </Container>
