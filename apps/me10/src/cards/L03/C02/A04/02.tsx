...
const P02 = () => {
  ...
  const questionInfo: IQuestionProps = {
    text: 'A가 되어 도움을 요청하는 문장을 완성한 후, 대화를 연습해 봅시다.',
  };
  ...
  const data: IListenAndAnswer[] = [
    {
      ...
      content: (
        <Box vAlign='middle'>
          <Typography useGap={false}>Can you &nbsp;</Typography>
          <Input
            maxLength={50}
    ...
    },
    {
      ...
      content: (
        <Box>
          <Typography useGap={false}>Sure.</Typography>
        </Box>
      ),
      color: 'var(--color-orange-100)',
      audioSrc: '/L03/C02/A04/ME1-L03-C02-A04-P02.mp3',
    },
  ];
