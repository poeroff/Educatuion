...
const P01 = () => {
  ...
  const imageInfo = {
    src: '/L03/C02/A09/ME1-L03-C02-A09-P01.jpg',
    alt: '지루해 보이는 여학생',
  };

  const content: React.ReactNode[] = [
    <>
      <Typography>You don’t look happy.</Typography>
      <Typography>What’s wrong?</Typography>
    </>,
    <>
      <Typography>I’m bored.</Typography>
      <Typography>Can you play with me?</Typography>
    </>,
    <>
      <Typography>- Of course.</Typography>
      <Typography>- Sorry, I can’t.</Typography>
    </>,
  ];
  ...
  const data: IListenAndAnswer[] = [
    {
      ...
      audioSrc: '/L03/C02/A09/ME1-L03-C02-A09-P01-1.mp3',
    },
    {
      type: 'B',
      content: content[1],
      color: 'var(--color-orange-200)',
      audioSrc: '/L03/C02/A09/ME1-L03-C02-A09-P01-2.mp3',
    },
    {
      type: 'A',
      content: content[2],
      color: 'var(--color-blue-100)',
      audioSrc: '/L03/C02/A09/ME1-L03-C02-A09-P01-3.mp3',
    },
  ];
  ...
  const init = async () => {
    ...
    if (pageId) {
      ...
      if (userSubmissionList && userSubmissionList.length > 0) {
        ...
        console.log('cardData', cardData.p01);
      }
