...
const P01 = () => {
  ...
  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L03/C12/A03/ME1-L03-C12-A03-P01.mp3',
    captionSrc: '/L03/C12/A03/ME1-L03-C12-A03-P01.srt',
  };
    ...
    >
      <BoxWrap flexDirection='column' useFull paddingTop='40px'>
        <Box background={'white'} useRound marginTop='50px' flexDirection='row'>
          <Typography useGap={true}>Dylan is upset. He got a bad grade on his</Typography>
          <Input
            value={cardData[pageKey].answer1}
