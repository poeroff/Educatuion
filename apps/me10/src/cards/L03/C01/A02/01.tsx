...
import { L03C01A02 } from './store';

const headerText = 'Warm Up';
const questionText = '예시를 참고하여 그림 속 노란 오리들이 하얀 오리에게 무슨 말을 하고 있을지 말해 봅시다.';
const answer = `Wow, you look cute! I like you.`;
const example = ['Wow, you look cute! I like you.'];
const audioSrc = '/L03/C01/A02/ME1-L03-C01-A02-P01.mp3';
const imageSrc = '/L03/C01/A02/ME1-L03-C01-A02-P01.jpg';
const alt = '10마리의 노란 오리와 1마리의 하얀 오리가 숲 속에 있으며, 노란 오리들이 모두 하얀 오리 1마리를 바라 보고 있는 모습';

const page = 'P01';
const pageKey = 'p01';
const cardPath = 'L03/C01/A02';
const subKey = 1;
...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(L03C01A02);
  ...
  return (
    ...
    >
      <BoxWrap>
        <Box>
          <PinchZoom>
            <Image src={imageSrc} width='473px' height='340px' ariaDescribedby='img_desc' />
