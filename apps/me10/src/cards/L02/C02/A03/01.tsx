...
const P01 = () => {
  ...
  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L02/C02/A03/ME1-L02-C02-A03-P01.mp3',
    captionSrc: '/L03/C02/A03/ME1-L03-C02-A03-P01.srt',
  };

  const imageList: IImageList[] = [
    {
      src: '/L02/C02/A03/ME1-L02-C02-A03-P01-01.jpg',
      alt: '웃고 있는 해님',
      answer: false,
    },
    {
      src: '/L02/C02/A03/ME1-L02-C02-A03-P01-02.jpg',
      alt: '표정이 있는 알록달록 우산',
      answer: false,
    },
    {
      src: '/L02/C02/A03/ME1-L02-C02-A03-P01-03.jpg',
      alt: '바람을 내뿜고 있는 구름',
      answer: true,
    },
  ];

  const questionText = 'What’s the weather like today?';
