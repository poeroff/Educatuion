...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(L02C02A02);
    ...
    >
      <BoxWrap height='340px' paddingLeft='16px' paddingRight='16px'>
        <Box useFull width='50%'>
          <PinchZoom>
            <Image
              src={'/L02/C02/A02/ME1-L02-C02-A02-P01.jpg'}
              width='418px'
              height='270px'
              alt={`먹구름이 끼고 비가 오는 날에 Jenny라는 두더지와 통화하고 있는 나무늘보가 "It's ... cloudy. Oh, no ... rainy"라고 말하고 있는 모습. Jenny의 말풍선이 비어 있다.`}
            />
          </PinchZoom>
        </Box>
        <Box useFull width='50%'>
