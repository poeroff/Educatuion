...
const P04 = () => {
  ...
  const imageInfo = {
    src: '/L02/C02/A09/ME1-L02-C02-A09-P04.jpg',
    alt: 'Busan에 있는 Yena가 먹구름이 가득한 날에 공원에서 강아지를 산책시키고 있는 사진',
    exp: 'walk a dog',
  };
  ...
  const data: IListenAndAnswer[] = [
    {
      ...
      audioSrc: '/L02/C02/A09/ME1-L02-C02-A09-P04-1.mp3',
    },
    {
      type: 'B',
    ...
    },
    {
      type: 'A',
      labelColor: 'var(--color-blue-100)',
      audioSrc: '/L02/C02/A09/ME1-L02-C02-A09-P04-2.mp3',
    },
    {
      type: 'B',
      labelColor: 'var(--color-orange-200)',
  ...
  const solution: React.ReactNode = (
    <>
      ...
      <BlockTypography>B: It’s cloudy.</BlockTypography>
      <BlockTypography>A: What is Yena doing?</BlockTypography>
      <BlockTypography>B: She’s walking her dog.</BlockTypography>
    </>
  );
        ...
        <Box>
          <BoxWrap marginBottom={'18px'} lineHeight={'40px'}>
            ...
            <Box width={'80%'} whiteSpace='nowrap'>
              <Typography usePre>What’s the weather like in Busan?</Typography>
            </Box>
          ...
          <BoxWrap marginBottom={'18px'} lineHeight={'40px'}>
            ...
            <Box width={'80%'} whiteSpace='nowrap'>
              <Typography usePre>What is Yena doing?</Typography>
            </Box>
            <Box width={'20%'} hAlign='flex-end' vAlign='flex-start' minWidth='131px'>
              <HiddenDiv isHidden={!cardData.p04.isAudioPlayed?.[0] || isEmptyAudioData(cardData.p04.audioData?.[1])}>
                <SimpleAudioPlayer
                  ref={ref => {
          ...
          <BoxWrap marginBottom={'18px'} lineHeight={'40px'}>
            ...
            <Box width={'20%'} hAlign='flex-end' vAlign='flex-start' minWidth='131px'>
              <HiddenDiv
                isHidden={!cardData.p04.isAudioPlayed?.[0] || isEmptyAudioData(cardData.p04.audioData?.[1]) || !cardData.p04.isAudioPlayed?.[1]}
              >
                <Recorder
                  recorderIndex={2}
