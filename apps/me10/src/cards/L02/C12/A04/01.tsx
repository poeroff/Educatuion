...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(L02C12A04);
  ...
  const content: React.ReactNode = <Typography>What’s the weather like outside?</Typography>;
