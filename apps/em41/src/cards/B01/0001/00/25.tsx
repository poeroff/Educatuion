...
const P25 = () => {
  ...
  const iconInfo = {
    bigIconSrc: '/B00/DJC410015-1.png',
    bigIconAlt: '10개를 나타내는 큰 달걀 그림입니다.',
    bigIconW: '48px',
    bigIconH: '48px',
    smallIconSrc: '/B00/DJC410015-2.png',
    smallIconAlt: '1개를 나타내는 작은 달걀 그림입니다.',
    smallIconW: '29px',
    smallIconH: '29px',
  };
