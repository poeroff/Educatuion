...
import { BoxWrap, Dialog, Dropdown, EStyleFontSizes, Image, PinchZoom, Scroll, Typography } from '@maidt-cntn/ui';
import { Box, Button, EStyleButtonTypes, EStyleSizes, TMainHeaderInfoTypes, Question, IQuestionProps } from '@maidt-cntn/ui';
...
const HE0180203 = () => {
  ...
  return (
    <Container headerInfo={headerInfo} questionInfo={questionInfo} useExtend submitLabel='채점하기' onSubmit={() => {}}>
      ...
      <BoxWrap>
        ...
        <Box width='490px' height='342px'>
          <Scroll tabIndex={0}>
            <Box>
              <Typography weight='var(--font-weight-bold)'>Neanderthals</Typography>
              <Typography>were intelligent and had stronger bodies, living in </Typography>
              <Box vAlign='center'>
            ...
            <Box marginTop='20px'>
              <Typography weight='var(--font-weight-bold)'>Homo Sapiens</Typography>
              <Typography>lived in larger communities, working together and</Typography>
            </Box>
          </Scroll>
        </Box>
      </BoxWrap>
