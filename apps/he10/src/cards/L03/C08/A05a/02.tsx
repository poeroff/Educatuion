  ...
  const nodeData: IContentList[] = [
    {
      children: (
        <Box marginTop='24px'>
          ...
          <Typography useGap={false}> Individuals should be aware of the impact of misinformation on public </Typography>
          <Typography> opinion. </Typography>
          <Box vAlign='center' marginTop='10px'>
            <SvgIcon src={arrow_right} size='34px' />
            <Typography useGap={false}> It is crucial&nbsp; </Typography>
            <Input
              value={cardData[pageKey].answer}
