  ...
  const nodeData: IContentList[] = [
    {
      children: (
        <Box>
          <Typography>1. He {''}</Typography>
          <Typography textDecoration='underline' useGap={false}>
            Seldom
          </Typography>
          <Typography>says no to his friends when they ask for help.</Typography>
        </Box>
      ),
    },
    {
        ...
        <>
          <BoxWrap>
            <Box hAlign={'flex-start'} marginTop='10px'>
              ...
              />
              <Typography>no to his friends</Typography>
            </Box>
          </BoxWrap>
          <Box>
            <Typography>when they ask for help.</Typography>
          </Box>
        </>
      ),
    },
