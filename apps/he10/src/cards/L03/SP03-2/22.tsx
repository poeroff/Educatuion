...
const P22 = () => {
  ...
  const contents: ITranslation[] = [
    {
      en: ', such as ticket offices at tourist attractions which are often very noisy.',
      ko: '보통 매우 시끄러운 관광 명소의 매표소와 같은 다른 분야에서도 이 기술을 활용한다.',
    },
  ];
  ...
  const answer = 'Other fields also take advantage of this technology';
  ...
  return (
    ...
    >
      <Box marginBottom='24px' useRound height='207px' background='white' padding='10px'>
        <Scroll tabIndex={0}>
          <List<ITranslation>
            data={contents}
            row={({ value, index = 1 }) => (
