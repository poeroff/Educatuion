...
const P24 = () => {
  ...
  const contents: ITranslation[] = [
    {
      en: 'A common source of these problems is noisy neighbors, as ',
      ko: '이러한 문제의 흔한 원인은 시끄러운 이웃인데, 이는 이웃이 발생시키는 소음이 주민 간의 갈등으로 이어질 수 있기 때문이다.',
    },
  ];
  const [chipButtonInfo, setChipButtonInfo] = useState<IChipButtonInfo[]>([
    ...
    {
      text: 'among residents',
      isError: false,
    },
  ]);

  const answer = 'the noise they make can lead to conflict among residents';
