    ...
    >
        ...
        <TextView title='보기' hAlign='start'>
          <Box>
            <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
              I can explain why the sky looks blue.
            </Typography>
          </Box>
          <Box>
            <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
      ...
      <Box marginTop='20px'>
        <Box hAlign='end'>
          <Box backgroundColor='var(--color-red-100)' border='none' useRound hAlign='center' padding='12px' margin='0 8px'>
            <Typography>Blue light from the sun spreads more easily than other colors.</Typography>
          </Box>
      ...
      <Box marginTop='20px'>
        <Box hAlign='start'>
          ...
          <Box backgroundColor='var(--color-blue-100)' border='none' useRound hAlign='center' padding='12px' margin='0 8px'>
            <Typography>I see. That's interesting!</Typography>
          </Box>
        </Box>
      </Box>
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isAnswerShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>I wonder why the sky is blue.</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
