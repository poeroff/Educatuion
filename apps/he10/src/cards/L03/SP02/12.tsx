    ...
    >
        ...
        <TextView title='보기' hAlign='start'>
          <Box>
            <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
              Can you tell me who invented the incredible house?
            </Typography>
          </Box>
          <Box>
            <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
              Have you heard of Frances Gabe?
            </Typography>
          </Box>
        </TextView>
      </Box>
      <Box marginTop='20px'>
        <Box hAlign='end'>
          <Box backgroundColor='var(--color-red-100)' border='none' useRound hAlign='center' padding='12px' margin='0 8px'>
            <Typography>No, I haven't. Who is that?</Typography>
          </Box>
      ...
      <Box marginTop='20px'>
        <Box hAlign='start'>
          ...
          <Box backgroundColor='var(--color-blue-100)' border='none' useRound hAlign='center' padding='12px' margin='0 8px'>
            <Typography>
              She was an American waman who invented
              <br />a self-cleaning house.
            </Typography>
          </Box>
        </Box>
      </Box>
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isAnswerShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>Have you heard of Frances Gabe?</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
