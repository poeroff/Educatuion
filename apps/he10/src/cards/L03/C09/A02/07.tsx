...
import { Box, Input, Typography, EStyleFontSizes, Scroll, InputStatus, IQuestionProps } from '@maidt-cntn/ui';
    ...
    <>
      ...
      <Box hAlign='center' vAlign='flex-start'>
        <Box paddingLeft='25px'>
          <Box>
            <Typography useGap={false}>The dish soap can 6)</Typography>
            <Input
              width='210px'
              maxLength={20}
              name={'value1'}
          ...
          <Typography useGap={false}>the fat in the milk into tiny pieces.</Typography>
        </Box>
      </Box>
    </>
  );
