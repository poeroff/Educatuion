...
import { Box, TMainHeaderInfoTypes, Recorder, Textarea, EStyleButtonTypes, IRecorderRef, IUploadRecordData, makeAudioData } from '@maidt-cntn/ui';
import { Container } from '@maidt-cntn/ui/en';
import { ChangeEvent, useEffect, useRef, useState } from 'react';
import { useRecoilState, useRecoilValue } from 'recoil';
import { L03C05A02, getUserSubmissionStoreP02 } from './store';
...
const P02 = () => {
  ...
  const questionInfo = {
    text: 'Write and talk about what the main text will be about.',
  };
  ...
  const handleSubmit = () => {
    ...
    const userSubmission = getUserSubmissionStoreP02(cardData.p02.answer || '');
