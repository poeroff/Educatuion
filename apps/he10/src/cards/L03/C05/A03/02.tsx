...
const P02 = () => {
  ...
  const handleRadioClick = (index: number) => {
    setCardData(prev => ({ ...prev, p02: { ...prev.p02, answer: index.toString() } }));
    changeData('P02', 1, 1, index.toString());
  };
      ...
      <Box useFull hAlign='center' padding='10px 0px'>
        <Box width='926px' display='flex' flexDirection='column' justifyContent='center' padding='20px' background='white' useRound>
          <Box display='flex' justifyContent='center'>
            Before turning in your report,
          </Box>
          <Box display='flex' justifyContent='center'>
            make sure to <CustomUnderline width={'130px'} /> any unnecessary words.
          </Box>
        </Box>
      </Box>
      <BoxWrap>
        {imgs.map((item, index) => {
          ...
          return (
            <Radio
              ...
              value={adjustedIndex === Number(cardData.p02.answer)}
            ...
            >
              <ShadowedButton
                ...
                type='img'
                state={
                  adjustedIndex === Number(cardData.p02.answer)
                    ? cardData.p02.isSubmitted
                      ? adjustedIndex === Number(cardData.p02.solution)
