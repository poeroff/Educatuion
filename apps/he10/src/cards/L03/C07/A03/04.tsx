...
const P04 = () => {
  ...
  const checkAnswerCorrect = () => {
    ...
    setCardData(prev => ({
      ...prev,
      p04: { ...prev.p04, isSubmitted: true, isCorrect: isCorrect },
    }));
  ...
  return (
    <Container
      ...
      submitBtnColor={cardData.p04.answer !== 0 ? (showAnswer ? EStyleButtonTypes.DEFAULT : EStyleButtonTypes.PRIMARY) : EStyleButtonTypes.SECONDARY}
    >
            ...
            <Box hAlign={'space-between'} useFull>
              <PinchZoom>
                <Image
                  ...
                  height={'73px'}
                  alt='버스 사진
                       A Tour Bus Driver from Sunshine Tours 별 다섯 개
                       “Driving is a peaceful and quiet experience for me now.” 네모 체크 박스'
                  src={'/L03/C07/A03/HE1-L03-C07-A03-P04.jpg'}
                />
              </PinchZoom>
              <Box hAlign='right'>
                <Button
