...
const P02 = () => {
  ...
  return (
    <Container
      ...
      submitBtnColor={cardData.p02.answer !== 0 ? (showAnswer ? EStyleButtonTypes.DEFAULT : EStyleButtonTypes.PRIMARY) : EStyleButtonTypes.SECONDARY}
    >
            ...
            <Box hAlign={'space-between'} useFull>
              <PinchZoom>
                <Image
                  ...
                  height={'73px'}
                  alt='티켓 사진
                     A Ticket Oice Agent from Heritage National Park 별 다섯 개 “I can hear the customers’ voices clearly and communicate with them easily.” 네모 체크 박스'
                  src={'/L03/C07/A03/HE1-L03-C07-A03-P02.jpg'}
                />
              </PinchZoom>
              <Box hAlign='right'>
                <Button
