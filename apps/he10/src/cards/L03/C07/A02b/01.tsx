...
const P01 = () => {
  const [cardData] = useRecoilState(L03C07A02b);
    ...
    <Container headerInfo={headerInfo} questionInfo={questionInfo} useExtend vAlign='flex-start'>
      ...
      <Box hAlign='center'>
        <PinchZoom pinchType={'image'}>
          <Image type={EImageType.IMG} src={'/L03/C07/A02/HE1-L03-C07-A02b-P01.jpg'} width={'320px'} height='377px' ariaDescribedby='img_desc' />
          <Box type='hidden' id='img_desc'>
            <p>글의 구조가 보이는 인포그래픽</p>
            <p>제목 How Noise-Cancellation Works</p>
            <p>소제목 1 Scientific Principle</p>
            <p>내용1 Constructive Interference와 2 빈칸 Interference에 대한 문장</p>
            <p>아래로 이어지는 화살표</p>
