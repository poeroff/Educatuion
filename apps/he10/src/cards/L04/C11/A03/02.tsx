...
const P02 = () => {
  ...
  const data: IListenAndAnswer[] = [
    {
      type: 'A',
      content: <>Hey, Jake! Are you throwing that broken glass into the recycling box?</>,
      audioSrc: '/L04/C11/A03/HE1-L04-C11-A03-P02-01.mp3',
    },
    {
      type: 'B',
      content: <>Oh, hi, Dad. I accidentally dropped a cup, and it broke. Why? Is there a problem?</>,
      audioSrc: '/L04/C11/A03/HE1-L04-C11-A03-P02-02.mp3',
    },
    {
      type: 'A',
      content: <>Indeed. Broken glass can’t be recycled. It should go in the general waste.</>,
      audioSrc: '/L04/C11/A03/HE1-L04-C11-A03-P02-03.mp3',
    },
    {
      type: 'B',
      content: <>Oh, I had no idea. So, what should I do with it?</>,
      audioSrc: '/L04/C11/A03/HE1-L04-C11-A03-P02-04.mp3',
    },
    {
      type: 'A',
      content: <>Broken glass can be dangerous. Why don’t you wrap it up in paper or an old cloth before putting it in the trash?</>,
      audioSrc: '/L04/C11/A03/HE1-L04-C11-A03-P02-05.mp3',
    },
    {
      type: 'B',
      content: <>Good idea. I don’t want to hurt anyone.</>,
      audioSrc: '/L04/C11/A03/HE1-L04-C11-A03-P02-06.mp3',
    },
    {
      type: 'A',
      content: <>Absolutely, let’s make sure we recycle and dispose of things appropriately for the environment and the safety of others.</>,
      audioSrc: '/L04/C11/A03/HE1-L04-C11-A03-P02-07.mp3',
    },
  ];
        ...
        setCardData(prev => ({
          ...
          p02: {
            ...
            isAudioPlayed: [
              ...
              userSubmissionList[0].inputData[12].value || cardData.p02.isAudioPlayed?.[6] || false,
            ],
          },
        }));
      }
