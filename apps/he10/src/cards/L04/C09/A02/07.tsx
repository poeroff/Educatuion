      ...
      <BoxWrap height='calc(100% - 108px)'>
          ...
          <TextBoard color={'var(--color-blue-200)'}>
            ...
            <Box>
              <Typography useGap={false}>
                With more people striving to recycle waste paper, the average rate of recycling in Korea may increase.
              </Typography>
            </Box>
          </TextBoard>
        </Box>
        <Box display='flex' flexDirection='column' justifyContent='center' gap='12px' useFull>
          <Box display='flex' hAlign='center'>
            <Typography weight='var(--font-weight-bold)'>Conclusion</Typography>
          </Box>
          <Box hAlign='center' vAlign='flex-start'>
            <Box paddingLeft='48px'>
              <Typography useGap={false}>
                With more people striving to recycle 6)&nbsp;
                <Input
                  width='245px'
                  value={cardData[pageNumber].answer}
                  ...
                  ariaLabel='6번 문제의 답란'
                />
                &nbsp;, Korea’s average recycling rate may increase.
              </Typography>
            </Box>
          </Box>
        </Box>
