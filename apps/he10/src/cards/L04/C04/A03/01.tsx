...
import { TMainHeaderInfoTypes, Typography, Input, Box, List, BottomSheet, Tag, ETagLine, EStyleButtonTypes } from '@maidt-cntn/ui';
import { Container } from '@maidt-cntn/ui/en';
import { ChangeEvent, useEffect, useState } from 'react';
import { useRecoilState, useRecoilValue } from 'recoil';
import { L04C04A03, getUserSubmissionStore01 } from './store';
...
const P01 = () => {
  ...
  const questionInfo = {
    text: 'Answer the questions to prepare for a news report.',
  };
