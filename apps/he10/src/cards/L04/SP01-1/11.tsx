...
const P11 = ({ _page = 'P11' }: { _page?: string }) => {
  ...
  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L04/SP01-1/HE1-L04-SP01-1-P11.mp3',
  };
  ...
  const answer = 'alert to the potential dangers and take appropriate action';
  ...
  return (
    ...
    >
      <Box marginBottom='24px' useRound height='175px' background='white' padding='10px'>
        <Box display='flex'>
          <Box>
            <Label value='G' type='paint' background='var(--color-yellow-100)' />
          </Box>
          <Box>
            <Typography>Exactly. It's a shame that the rising sea level is mostly due to</Typography>
            <Typography>human activities.</Typography>
          </Box>
        </Box>
        <Box>
          <Label value='B' type='paint' background='var(--color-blue-100)' />
          <Typography>
            You're right. We should be <Typography type='blank' width='400px' title='빈칸' boxColor='var(--color-black)'></Typography>.
          </Typography>
        </Box>
      </Box>
