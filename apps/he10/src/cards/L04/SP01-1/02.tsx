...
const P02 = () => {
  ...
  const wordList = useMemo(
    () => [
      { id: 1, word: 'ecosystem', meaning: '생태계', meaningOrder: 6 },
      { id: 2, word: 'confirm', meaning: '확인하다', meaningOrder: 2 },
      { id: 3, word: 'suppose', meaning: '가정하다', meaningOrder: 4 },
      { id: 4, word: 'recover', meaning: '회복하다', meaningOrder: 3 },
      { id: 5, word: 'alert', meaning: '경계하는', meaningOrder: 9 },
      { id: 6, word: 'substance', meaning: '물질', meaningOrder: 7 },
      { id: 7, word: 'sew', meaning: '바느질하다', meaningOrder: 1 },
      { id: 8, word: 'on track', meaning: '(원하는 결과를 위해) 나아가는', meaningOrder: 5 },
      { id: 9, word: 'appliance', meaning: '전자제품', meaningOrder: 10 },
      { id: 10, word: 'consumption', meaning: '소비', meaningOrder: 8 },
    ],
    [],
  );
