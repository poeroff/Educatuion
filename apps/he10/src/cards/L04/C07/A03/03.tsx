...
const P03 = () => {
  ...
  const dialog = '“Our clothing and shoes are crafted from ... They ... Wear our products and ...!”';
    ...
    >
      <BoxWrap>
        <Box width='30%' hAlign={'center'} useRound border={'1px solid var(--color-grey-600)'}>
          <Image
            src={'/L04/C07/A03/HE1-L04-C07-A03-P03.jpg'}
            width='250px'
            height='200px'
            alt='한 손에 핸드폰을 들고 있는
              사람의 상체 사진과 연결된
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='30%' show={isShow} closeOption={{ useYn: true, onClose: () => setShow(false) }}>
        <Box background='lightGray' borderRadius='12px' marginTop='35px'>
          ...
          <Box marginTop='12px'>
            Our clothing and shoes are crafted from recycled coffee grounds. They absorb sweat, dry quickly, and provide UV protection. Wear our
            products and become a leader in sustainable fashion!
          </Box>
        </Box>
      </BottomSheet>
    </Container>
