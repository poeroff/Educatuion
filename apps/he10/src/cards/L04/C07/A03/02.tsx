...
const P02 = () => {
  ...
  const submitBtnColor = !cardData.p02.answer ? EStyleButtonTypes.SECONDARY : isShow ? EStyleButtonTypes.GRAY : EStyleButtonTypes.PRIMARY

  const dialog =
    '“We make our products from ... Being eco-friendly is just one of the benefits of our logs; they also ... Purchase our products for yourself and the environment!”';
    ...
    >
      <BoxWrap>
        <Box width='30%' hAlign={'center'} useRound border={'1px solid var(--color-grey-600)'}>
          <Image
            src={'/L04/C07/A03/HE1-L04-C07-A03-P02.jpg'}
            width='200px'
            height='200px'
            alt='벽난로 앞 Coffee Logs 라고
              써있는 봉투 사진과 연결된
              이름표 Coffee Log Maker'
            title='벽난로 앞 Coffee Logs 라고
              써있는 봉투 사진과 연결된
              이름표 Coffee Log Maker'
          />
        </Box>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='30%' show={isShow} closeOption={{ useYn: true, onClose: () => setShow(false) }}>
        <Box background='lightGray' borderRadius='12px' marginTop='35px'>
          ...
          <Box marginTop='12px'>
            We make our products from used coffee grounds. Being eco-friendly is just one of the benefits of our logs; they also produce more heat and
            burn longer than wood. Purchase our products for yourself and the environment!
          </Box>
        </Box>
      </BottomSheet>
    </Container>
