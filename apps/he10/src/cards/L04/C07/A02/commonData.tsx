export const textContentA02 = {
  title: `A Better Future for Coffee Waste`,
...
Recycled coffee grounds have a wide range of uses, including coffee logs, fabrics for clothing and shoes, and reusable cups. Coffee logs, for instance, generate more heat and burn for a longer time than wood. Fabric made from coffee grounds absorbs sweat, dries quickly, and provides UV protection. Reusable cups from coffee grounds not only have a visually appealing appearance but also preserve the taste of the coffee. Korea has shown a growing interest in recycling spent coffee grounds in recent years. The government is taking steps toward the creation of a sustainable recycling system in the coffee industry, while companies are dedicating themselves to researching and developing new uses for coffee waste. By recycling materials such as coffee waste, individuals can also help protect the environment. With continued efforts, the recycling of used coffee grounds is expected to increase, encouraging more sustainable methods of enjoying coffee for years to come.`,
  subTitleIndexes: new Set<number>(),
};

export const imgContentA02P01 = {
  imgSrc: `/L04/C07/A02/HE1-L04-C07-A02-P01.jpg`,
  imgAlt: (
    <>
      <p>글의 구조가 보이는 인포그래픽</p>
      <h1>제목 Consuming Coffee</h1>
      <h2>소제목1 Problem</h2>
      <p>내용1 The Production of Coffee Waste에 관한 문장</p>
      <p>아래로 이어지는 화살표</p>
      <p>첫 번째 칸 Buried에 관한 문장</p>
      <p>두 번째 칸 빈칸에 관한 문장</p>
      <p>아래로 이어지는 화살표</p>
      <h2>소제목2 Solution</h2>
      <p>내용2 Introducing a(n) 빈칸 Economy에 관한 문장</p>
      <h2>소제목3 Examples</h2>
      <p>내용3 examples에 관한 표현들</p>
    </>
  ),
};

export const imgContentA02P02 = {
  imgSrc: `/L04/C07/A02/HE1-L04-C07-A02-P02.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 제목 Consuming Coffee 소제목 Problem 내용 The Production of Coffee Waste에 관한 문장`,
};

export const imgContentA02P03 = {
  imgSrc: `/L04/C07/A02/HE1-L04-C07-A02-P03.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 제목 Consuming Coffee 소제목 Problem 내용 The Production of Coffee Waste에 관한 문장`,
};

export const imgContentA02P04 = {
  imgSrc: `/L04/C07/A02/HE1-L04-C07-A02-P04.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 소제목 Solution 내용 Introducing a(n) 빈칸 Economy에 관한 문장`,
};

export const imgContentA02P05 = {
  imgSrc: `/L04/C07/A02/HE1-L04-C07-A02-P05.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 소제목 Examples 내용 examples에 관한 표현들`,
};
