...
export const imgContentA02aP01 = {
  imgSrc: `/L04/C07/A02/HE1-L04-C07-A02a-P01.jpg`,
};

export const imgContentA02aP02 = {
  imgSrc: `/L04/C07/A02/HE1-L04-C07-A02a-P02.jpg`,
...
export const imgContentA02aP03 = {
  imgSrc: `/L04/C07/A02/HE1-L04-C07-A02a-P03.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 제목 Consuming Coffee 소제목 Problem 내용 The Production of Coffee Waste에 관한 문장
`,
};

export const imgContentA02aP04 = {
  imgSrc: `/L04/C07/A02/HE1-L04-C07-A02a-P04.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 소제목 Solution 내용 Introducing a 4 C 빈칸, E 빈칸에 관한 문장`,
};

export const imgContentA02aP05 = {
  imgSrc: `/L04/C07/A02/HE1-L04-C07-A02a-P05.jpg`,
