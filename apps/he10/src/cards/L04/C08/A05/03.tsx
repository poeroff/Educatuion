  ...
  const nodeData: IContentList[] = [
    {
      children: (
        <Box>
          <Typography>
            3. Nora enjoys watching movies in her free time. Or she enjoys playing games. (either ~ or ...) <br />
          </Typography>
        </Box>
      ),
    },
    {
      children: (
        <Box hAlign={'flex-start'} marginTop='10px'>
          ...
          <Typography>Nora enjoys </Typography>
          <Input
            maxLength={70}
            name={'value1'}
            ...
            inputSize={'x-small'}
          />
          <Typography>in her free time.</Typography>
        </Box>
      ),
    },
  ];
