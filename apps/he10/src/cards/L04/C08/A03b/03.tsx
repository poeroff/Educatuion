...
const page = 'P03';
const answer = 'with birds singing';
  ...
  const nodeData: { children: React.ReactNode }[] = [
    {
      children: (
        <Box>
          <Typography>3. They enjoyed a peaceful time in the garden </Typography>
          <Input
            ariaLabel='답란'
            value={userAnswer}
          ...
          />
          <Typography>in the trees.</Typography>
        </Box>
      ),
    },
    {
