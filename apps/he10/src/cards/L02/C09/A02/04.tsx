  ...
  const boxNode = (
    <>
      <Box display='flex'>
        ...
        <Typography weight='var(--font-weight-bold)'>Which was the most moving part?</Typography>
      </Box>
      <Box hAlign='center' vAlign='flex-start'>
        <Box paddingLeft='48px'>
          <Typography useGap={false}>When Nani and his daughter </Typography>
          <Input
            inputSize='x-small'
            width='280px'
            value={cardData[pageKey].answer}
          ...
          />
          <Typography useGap={false}> on their journey to Murupara. </Typography>
        </Box>
      </Box>
    </>
  );
