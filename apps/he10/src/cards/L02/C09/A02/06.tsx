  ...
  const boxNode = (
    <>
      <Box display='flex'>
        ...
        <Typography weight='var(--font-weight-bold)'>Why does Minho recommend this book?</Typography>
      </Box>
      <Box hAlign='center' vAlign='flex-start'>
        <Box paddingLeft='48px'>
          <Typography useGap={false}>It shows the importance of preserving one’s own culture and </Typography>
          <Input
            inputSize='x-small'
            width='280px'
            value={cardData[pageKey].answer}
      ...
      <Box>
        <Scroll height='245px'>
          <Typography useGap={false}>
            I recommend this story because it shows how important it is to preserve one’s own culture and traditions.
          </Typography>
        </Scroll>
      </Box>
    </TextBoard>
