...
const P02 = () => {
  ...
  const boxNode = (
    <>
      <Box display='flex'>
        ...
        <Typography weight='var(--font-weight-bold)'>What is the title of the story, and who is the author?</Typography>
      </Box>
      <Box hAlign='center' vAlign='flex-start'>
        <Box paddingLeft='48px'>
          <Typography useGap={false}>Gathering of the by</Typography>
  ...
  const textViewNode = (
    <TextBoard color={'var(--color-pink-300)'}>
      <Box>
      ...
      <Box>
        <Scroll height='245px'>
          <Typography useGap={false}>Gathering of the</Typography>
          <Typography useGap={false} style={{ fontStyle: 'italic' }}>
            Whakapapa
          </Typography>
          <Typography useGap={false}> is a short story written by Witi lhimaera, a famous Maori writter.</Typography>
        </Scroll>
      </Box>
    </TextBoard>
  );
