...
export const imgContentA02P01 = {
  imgSrc: `/L02/C07/A02/HE1-L02-C07-A02-P01.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 왼쪽부터 첫 번째 그림 제목 story structure: “Gathering of the Whakapapa” beginning 성냥개비 한 개 두 번째 그림 Rising Action Climax 타오르는 성냥개비 한 개 세 번째 그림 Ending 다 타버린 성냥 개비 한 개`,
};
export const imgContentA02P02 = {
  imgSrc: `/L02/C07/A02/HE1-L02-C07-A02-P02.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 제목 story structure: “Gathering of the Whakapapa” 성냥개비 한 개 beginning`,
};
export const imgContentA02P03 = {
  imgSrc: `/L02/C07/A02/HE1-L02-C07-A02-P03.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 타오르는 성냥개비 한 개 Rising Action에서 Climax로 향하는 그래프 `,
};
export const imgContentA02P04 = {
  imgSrc: `/L02/C07/A02/HE1-L02-C07-A02-P04.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 타오르는 성냥개비 한 개 Rising Action에서 Climax로 향하는 그래프 `,
};
export const imgContentA02P05 = {
  imgSrc: `/L02/C07/A02/HE1-L02-C07-A02-P05.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 다 타버린 성냥 개비 한 개 Ending `,
};
