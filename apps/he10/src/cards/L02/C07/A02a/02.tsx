    ...
    >
      ...
      <BoxWrap>
        <Box hAlign={'center'} flexDirection={'column'} height={'342px'}>
          <PinchZoom>
            <Image type={EImageType.IMG} src={'/L02/C07/A02/HE1-L02-C07-A02a-P02.jpg'} height='282px' width='430px' />
          ...
          <Box useFull hAlign={'center'} gap={8}>
            <Box flex={1} background='var(--color-yellow-300)' borderRadius={'16px'}>
              <Typography weight={700}>Beginning</Typography>
            </Box>
            <Dropdown
              type='up'
              width='264px'
              ...
              isError={cardData.p02.isSubmitted && !cardData.p02.answer[0]}
              ariaLabel='2페이지 답 선택칸'
            />
          </Box>
        </Box>
