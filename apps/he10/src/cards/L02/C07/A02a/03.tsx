    ...
    >
      ...
      <BoxWrap>
        <Box hAlign={'center'} flexDirection={'column'} height={'342px'}>
          <PinchZoom>
            <Image type={EImageType.IMG} src={'/L02/C07/A02/HE1-L02-C07-A02a-P03.jpg'} height='282px' width='430px' />
          ...
          <Box useFull hAlign={'center'} gap={8}>
            <Box flex={1} background='var(--color-pink-200)' borderRadius={'16px'} hAlign={'center'}>
              <CustomTypography fontSize={'22px'} weight={700}>
                Rising Action
              </CustomTypography>
            </Box>
            <Dropdown
