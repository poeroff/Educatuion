    ...
    >
      <BoxWrap height={'340px'} paddingLeft={'16px'} paddingRight={'16px'}>
        <Box useFull width='40%' vAlign='center' hAlign='center'>
          <PinchZoom>
            <Image
              src={'/L02/C05/A03/HE1-L02-C05-A03-04.jpg'}
              width='100%'
              height='100%'
              alt='노트북 화면으로 한 가족의 계보를 나타내는 그림이 보이고 있다.'
            />
          </PinchZoom>
        </Box>
        <Box useFull width='60%'>
          <Typography useGap={false}>Exploring my family's &nbsp;</Typography>
          <Typography useGap={false} textDecoration={'underline'} style={{ textUnderlinePosition: 'under' }}>
            genealogy
          </Typography>
          ,<Typography useGap={false}> I learned more about where I came from.</Typography>
          <Box marginTop='10px'>
            <Textarea
              height='240px'
              value={cardData[PAGE_KEY].answer}
