    ...
    >
      <BoxWrap height={'340px'} paddingLeft={'16px'} paddingRight={'16px'}>
        <Box useFull width='40%' vAlign='center' hAlign='center'>
          <PinchZoom>
            <Image src={'/L02/C05/A03/HE1-L02-C05-A03-05.jpg'} width='100%' height='100%' alt='여자 아이가 엄마에게 귓속말로 말하고 있다.' />
          </PinchZoom>
        </Box>
        <Box useFull width='60%'>
          <Typography useGap={false}>The girl came over to </Typography>
          <Typography textDecoration={'underline'} style={{ textUnderlinePosition: 'under' }}>
            whisper
          </Typography>
          <Typography useGap={false}> something in her mother's ear.</Typography>
          <Box marginTop='10px'>
            <Textarea
              height='240px'
              value={cardData[PAGE_KEY].answer}
