...
const P01 = () => {
  ...
  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L02/C02/A04/HE1-L02-C02-A04.mp3',
  };
  ...
  const data: IListenAndAnswer[] = [
    {
      type: 'A',
      content: <Typography>What kind of books do you like?</Typography>,
      color: 'var(--color-blue-100)',
      audioSrc: '/L02/C02/A04/HE1-L02-C02-A04-1.mp3',
    },
    {
      type: 'B',
      content: (
      ...
      audioSrc: '/L02/C02/A04/HE1-L02-C02-A04-2.mp3',
    },
    {
      type: 'A',
      content: <Typography>Why are you interested in them?</Typography>,
      color: 'var(--color-blue-100)',
      audioSrc: '/L02/C02/A04/HE1-L02-C02-A04-3.mp3',
    },
    {
      type: 'B',
      content: (
        <>
          <Typography>They </Typography>
          <Typography weight={'var(--font-weight-bold)'} useGap={false}>
            inspire me to live my life to the fullest.
          </Typography>
        </>
      ),
      color: 'var(--color-red-300)',
      audioSrc: '/L02/C02/A04/HE1-L02-C02-A04-4.mp3',
    },
  ];

  const checkDisableInput = () => {
    return Object.values(cardData.p01.audioData!).length !== 4;
  };
