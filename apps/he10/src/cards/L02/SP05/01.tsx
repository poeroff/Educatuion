  ...
  return (
    ...
    >
      <Box vAlign='center' marginTop='20px' textAlign='center' tabIndex={101} flexDirection='column' gap='8px'>
        <Typography> Tell your friend what he or she should </Typography>
        <Typography> not do on public transportation. Use an </Typography>
        <Typography> expression you learned in this lesson. </Typography>
      </Box>
