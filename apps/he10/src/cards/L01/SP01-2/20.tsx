...
const P20: React.FC<P20Props> = ({ pageNumber = 'p20', store = 'SP01-2' }) => {
  ...
  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L01/SP01-2/HE1-L01-SP01-2-P20.mp3',
  };
  ...
  const answer = 'Why don’t you tell him about your concern';
  ...
  return (
    ...
    >
      <Box marginBottom='20px' useRound height='137px' background='white' padding='10px'>
        <Box>
          <Typography>
            I understand how you feel. <Typography type='blank' width='300px' title='빈칸' boxColor='var(--color-black)'></Typography> instead of
          </Typography>
        </Box>
        <Box marginTop={10}>
          <Typography>worrying about it too much?</Typography>
        </Box>
      </Box>
