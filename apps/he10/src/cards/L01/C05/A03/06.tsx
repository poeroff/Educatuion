...
const P06 = () => {
  ...
  const context = ' Walking on two legs was an evolutionary development that enabled humans to use two hands.';
  const underlineText = 'evolutionary';
  ...
  return (
    <Container
      ...
      submitBtnColor={cardData.p06.answer !== 0 ? (isShow ? EStyleButtonTypes.GRAY : EStyleButtonTypes.PRIMARY) : EStyleButtonTypes.SECONDARY}
    ...
    >
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={cardData.p06.isSubmitted && isShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box marginTop='12px'>{cardData.p06.solution}</Box>
        </Box>
      </BottomSheet>
    </Container>
  );
