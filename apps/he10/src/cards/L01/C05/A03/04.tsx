...
const P04 = () => {
  ...
  const context = ' We should cooperate to overcome global challenges such as climate change.';
  const underlineText = 'cooperate';
  const data = [
  ...
  return (
    <Container
      ...
      submitBtnColor={cardData.p04.answer !== 0 ? (isShow ? EStyleButtonTypes.GRAY : EStyleButtonTypes.PRIMARY) : EStyleButtonTypes.SECONDARY}
    ...
    >
            ...
            <List
              ...
              row={({ value, index = 1 }) => (
                <Radio
                  ...
                  label={value?.text}
                  value={index === cardData.p04.answer}
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={cardData.p04.isSubmitted && isShow}>
