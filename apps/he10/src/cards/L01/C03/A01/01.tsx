...
import { BoxWrap, Box, TMainHeaderInfoTypes, Textarea, EStyleButtonTypes } from '@maidt-cntn/ui';
...
import { L01C03A01 } from './store';

const P01 = () => {
  const { changeData, initData, submitData, saveData } = usePageData();
  const pageIds = useRecoilValue(pageIdsAtom);
  const [cardData, setCardData] = useRecoilState(L01C03A01);
  ...
  const questionText = `What do you do when your\nfriends talk about their problems?`;
