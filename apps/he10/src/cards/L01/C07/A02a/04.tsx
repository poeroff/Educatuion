...
const P04 = () => {
  ...
  const checkAnswerCorrect = () => {
    const isCorrect1 =
      cardData.p04.answer1.value.trim().toLowerCase() === cardData.p04.answer1.solution ||
      cardData.p04.answer1.value.trim().toLowerCase() === cardData.p04.answer1.solution.substring(1);
    const isCorrect2 =
      cardData.p04.answer2.value.trim().toLowerCase() === cardData.p04.answer2.solution ||
      cardData.p04.answer2.value.trim().toLowerCase() === cardData.p04.answer2.solution.substring(1);
    const isCorrect3 =
      cardData.p04.answer3.value.trim().toLowerCase() === cardData.p04.answer3.solution ||
      cardData.p04.answer3.value.trim().toLowerCase() === cardData.p04.answer3.solution.substring(1);
    ...
    setCardData(prev => ({
      ...
      p04: {
        ...
        answer3: { ...prev.p04.answer3, isCorrect: isCorrect3 },
  ...
  const checkInputAllFilled = (): boolean => {
    return (
      isNotEmptyString(cardData.p04.answer1.value.trim().toLowerCase()) &&
      isNotEmptyString(cardData.p04.answer2.value.trim().toLowerCase()) &&
      isNotEmptyString(cardData.p04.answer3.value.trim().toLowerCase())
    );
  };
          ...
          <Scroll height={'282px'} width={'434px'} tabIndex={0}>
            ...
            <Box>
              <Typography useGap={false} weight={'medium'} size={EStyleFontSizes.MEDIUM}>
                were intelligent and had stronger bodies, living in (5) s{' '}
                <Input
                  width='118px'
                  name={'answer5'}
                  maxLength={20}
            ...
            <Box hAlign='flex' marginTop={'20px'}>
              ...
              <Typography useGap={false} weight={'medium'} size={EStyleFontSizes.MEDIUM}>
                ...
                <Input
                  ...
                  status={cardData.p04.isSubmitted && !cardData.p04.answer3.isCorrect ? InputStatus.ERROR : InputStatus.ENABLE}
                  ariaLabel={'7번 답 입력란'}
                  readOnly={cardData.p04.isSubmitted}
                />{' '}
              </Typography>
        ...
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box display={'flex'} flexDirection={'column'} marginTop='12px' gap={'20px'}>
            <Typography useGap={false}>
              (5) {cardData.p04.answer1.solution.substring(1)}
              <br />
              {cardData.p04.answer1.solution}(정답 인정)
            </Typography>
            <Typography useGap={false}>
              (6) {cardData.p04.answer2.solution.substring(1)}
              <br />
              {cardData.p04.answer2.solution}(정답 인정)
            </Typography>
            <Typography useGap={false}>
              (7) {cardData.p04.answer3.solution.substring(1)}
              <br />
              {cardData.p04.answer3.solution}(정답 인정)
            </Typography>
          </Box>
        </Box>
      </BottomSheet>
