...
const P03 = () => {
  ...
  const checkAnswerCorrect = () => {
    const isCorrect1 =
      cardData.p03.answer1.value.trim().toLowerCase() === cardData.p03.answer1.solution ||
      cardData.p03.answer1.value.trim().toLowerCase() === cardData.p03.answer1.solution.substring(1);
    const isCorrect2 =
      cardData.p03.answer2.value.trim().toLowerCase() === cardData.p03.answer2.solution ||
      cardData.p03.answer2.value.trim().toLowerCase() === cardData.p03.answer2.solution.substring(1);
  ...
  const checkInputAllFilled = (): boolean => {
    return isNotEmptyString(cardData.p03.answer1.value.trim().toLowerCase()) && isNotEmptyString(cardData.p03.answer2.value.trim().toLowerCase());
  };
        ...
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box display={'flex'} flexDirection={'column'} marginTop='12px' gap={'20px'}>
            <Typography useGap={false}>
              (3) {cardData.p03.answer1.solution.substring(1)}
              <br />
              {cardData.p03.answer1.solution}(정답 인정)
            </Typography>
            <Typography>
              (2) {cardData.p03.answer2.solution.substring(1)}
              <br />
              {cardData.p03.answer2.solution}(정답 인정)
            </Typography>
          </Box>
        </Box>
      </BottomSheet>
