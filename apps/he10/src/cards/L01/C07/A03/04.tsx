...
const P04 = () => {
  ...
  return (
    <Container
      ...
      submitDisabled={cardData.p04.answer?.some(value => value === '' || value === undefined)}
      submitBtnColor={
        !cardData.p04.answer?.some(value => value === '' || value === undefined)
          ? isShow
            ...
            <Scroll width='510px' height='295px'>
              <Box hAlign='flex' whiteSpace='nowrap'>
                <Question type='dot' size='small'>
                  We naturally want to help people
                </Question>
              </Box>
              <Box hAlign='flex' whiteSpace='nowrap'>
                <Question size='small'>in need.</Question>
              </Box>
              <Box hAlign='flex' whiteSpace='nowrap'>
                <Question type='dot' size='small'>
                  Dogs and wolves share a
                </Question>
              </Box>
              <Box hAlign='flex' whiteSpace='nowrap'>
                ...
                <Dropdown
                  ...
                  ariaLabel='3번째 답 선택칸'
                />
                <Question size='small'> ancestor, and</Question>
              </Box>
              <Box hAlign='flex' whiteSpace='nowrap'>
                <Question size='small'>only those who interacted well with</Question>
              </Box>
              <Box hAlign='flex' whiteSpace='nowrap'>
                <Question size='small'>humans eventually evolved</Question>
              </Box>
              <Box hAlign='flex' whiteSpace='nowrap'>
                <Question size='small'> evolved into</Question>
