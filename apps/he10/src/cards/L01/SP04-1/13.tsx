...
const P13 = () => {
  ...
  const handleSubmit = () => {
    if (cardData.p13.isSubmitted) {
      ...
      const isCorrect = cardData.p13.answer === cardData.p13.solution;
  ...
  return (
    <Container
      ...
      submitDisabled={!cardData.p13.isSubmitted && cardData.p13.answer === 0}
      submitBtnColor={cardData.p13.answer !== 0 ? (showAnswer ? EStyleButtonTypes.GRAY : EStyleButtonTypes.PRIMARY) : EStyleButtonTypes.SECONDARY}
    >
            ...
            <List gap={24} data={data}>
              {({ value, index = 1 }) => (
                <Radio
                  ...
                  defaultValue={index === cardData.p13.answer}
                  onClick={() => handleChange(index)}
                  disabled={cardData.p13.isSubmitted}
                  isError={cardData.p13.isSubmitted && cardData.p13.answer !== cardData.p13.solution}
                >
                  <Box>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={showAnswer}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box marginTop='12px'>{cardData.p13.solution}</Box>
          <Box marginTop='40px'>
