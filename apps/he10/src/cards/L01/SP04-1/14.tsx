...
const P14 = () => {
  ...
  const handleSubmit = () => {
    if (cardData.p14.isSubmitted) {
      ...
      const isCorrect = cardData.p14.answer === cardData.p14.solution;
  ...
  const handleChange = (index: number) => {
    setCardData(prev => ({ ...prev, p14: { ...prev.p14, answer: index } }));
  ...
  return (
    <Container
      ...
      submitDisabled={!cardData.p14.isSubmitted && cardData.p14.answer === 0}
      submitBtnColor={cardData.p14.answer !== 0 ? (showAnswer ? EStyleButtonTypes.GRAY : EStyleButtonTypes.PRIMARY) : EStyleButtonTypes.SECONDARY}
    >
      <BoxWrap>
          ...
          <List
            ...
            row={({ value, index = 1 }) => (
              <Radio
                ...
                label={value?.text}
                value={index === cardData.p14.answer}
                defaultValue={index === cardData.p14.answer}
                onClick={() => handleChange(index)}
                disabled={cardData.p14.isSubmitted}
                isError={cardData.p14.isSubmitted && cardData.p14.answer !== cardData.p14.solution}
              >
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={showAnswer}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box marginTop='12px'>{cardData.p14.solution}</Box>
          <Box marginTop='40px'>
