        ...
        <Box background='white' paddingRight='10px' flexDirection={'column'} width={'50%'} useRound>
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <PinchZoom pinchType={'image'}>
              <Image alt='' src={'/L01/C06/A05/HE1-L01-C06-A05.jpg'} width='400px' height='130px' ariaDescribedby='img_desc' />
              <Box type='hidden' id='img_desc'>
                <p>침팬지와 보노보의 비교 사진</p>
                <p>이미지 제목</p>
                <p>Chimpanzees vs. Bonobos(Case 1)</p>
                <p>슬라이드 텍스트</p>
                <p>Similar look, Different Nature Chimpanzees and Bonobos</p>
                <p>보노보 두 마리가 철장 속 바나나를 꺼내기 위해 협력하는 그림</p>
                <p>이미지 제목</p>
                <p>Chimpanzees vs. Bonobos(Case 2)</p>
                <p>슬라이드 텍스트</p>
          ...
          <br />
          <Box>
            <TextView title='보노보(Bonobos)' height='235px'>
