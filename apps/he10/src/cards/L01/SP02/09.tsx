...
const P09 = () => {
  ...
  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L01/SP02/HE1-L01-SP02-P09.wav',
  };
  ...
  const handleClickSubmit = () => {
    if (cardData.p09.isSubmitted) {
      ...
      if (pageData.find(value => value.page === 'P09')) {
        userSubmission[0].inputData.push(pageData.find(value => value.page === 'P09')!.userSubmission[0].inputData[0]);
      }
    ...
    if (pageId) {
      ...
      if (userSubmissionList && userSubmissionList.length > 0) {
        ...
        setCardData(prev => ({
          ...
          p09: {
            ...prev.p09,
            audioData: newAudioData || cardData.p09.audioData,
            isSubmitted,
          },
        }));
      }
  ...
  const checkDisableInput = () => {
    return !(Object.values(cardData.p09.audioData || {}).length > 0);
  };
  ...
  return (
    <Container
      ...
      submitLabel={!cardData.p09.isSubmitted ? '완료하기' : !showAnswer ? '답안보기' : '답안닫기'}
    ...
    >
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={showAnswer}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>Personally, I hope I'll start to learn Spanish.</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
