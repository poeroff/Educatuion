...
const P11 = () => {
  ...
  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L01/SP02/HE1-L01-SP02-P11.wav',
  };
  ...
  const handleClickSubmit = () => {
    if (cardData.p11.isSubmitted) {
      ...
      if (pageData.find(value => value.page === 'P11')) {
        userSubmission[0].inputData.push(pageData.find(value => value.page === 'P11')!.userSubmission[0].inputData[0]);
      }
      submitData('P11', userSubmission);
    }
  };
    ...
    if (pageId) {
      ...
      if (userSubmissionList && userSubmissionList.length > 0) {
        ...
        setCardData(prev => ({
          ...
          p11: {
            ...prev.p11,
            audioData: newAudioData || cardData.p11.audioData,
            isSubmitted,
          },
        }));
      }
  ...
  const checkDisableInput = () => {
    return !(Object.values(cardData.p11.audioData || {}).length > 0);
  };
  ...
  return (
    <Container
      ...
      submitLabel={!cardData.p11.isSubmitted ? '완료하기' : !showAnswer ? '답안보기' : '답안닫기'}
    ...
    >
      <Box hAlign='start'>
        ...
        <Box backgroundColor='var(--color-blue-100)' border='none' useRound hAlign='center' padding='12px' margin='0 8px'>
          <Typography>I feel nervous when I give a presentation.</Typography>
        </Box>
          ...
          <TextView title='보기' hAlign='start'>
            <Box vAlign='flex-start'>
              ...
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                I know how you feel. Why don’t you practice <br />
                speaking in front of your family?
              </Typography>
            </Box>
            <Box vAlign='flex-start'>
              <Box>
              ...
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                I know how you feel. Why don’t you think <br />
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={showAnswer}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>Why don't you practice speaking in front of your family?</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
