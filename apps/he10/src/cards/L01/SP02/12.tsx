...
const P12 = () => {
  ...
  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L01/SP02/HE1-L01-SP02-P12.wav',
  };
  ...
  const handleClickSubmit = () => {
    if (cardData.p12.isSubmitted) {
      ...
      if (pageData.find(value => value.page === 'P12')) {
        userSubmission[0].inputData.push(pageData.find(value => value.page === 'P12')!.userSubmission[0].inputData[0]);
      }
    ...
    if (pageId) {
      ...
      if (userSubmissionList && userSubmissionList.length > 0) {
        ...
        setCardData(prev => ({
          ...
          p12: {
            ...prev.p12,
            audioData: newAudioData || cardData.p12.audioData,
            isSubmitted,
          },
        }));
      }
  ...
  const checkDisableInput = () => {
    return !(Object.values(cardData.p12.audioData || {}).length > 0);
  };
  ...
  return (
    <Container
      ...
      submitLabel={!cardData.p12.isSubmitted ? '완료하기' : !showAnswer ? '답안보기' : '답안닫기'}
    ...
    >
      <Box hAlign='start'>
        ...
        <Box backgroundColor='var(--color-blue-100)' border='none' useRound hAlign='center' padding='12px' margin='0 8px'>
          <Typography>I am concerned about the exam.</Typography>
        </Box>
          ...
          <TextView title='보기' hAlign='start'>
            <Box vAlign='flex-start'>
              ...
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                I understand how you feel. Why don’t you <br />
                try deep breathing?
              </Typography>
            </Box>
            <Box vAlign='flex-start'>
              ...
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                I understand how you feel. Why not learn <br />
                to speak English?
              </Typography>
            </Box>
          </TextView>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={showAnswer}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>I understand how you feel. Why don't you try deep breathing?</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
