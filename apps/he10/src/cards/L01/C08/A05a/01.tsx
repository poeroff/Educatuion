...
const P01 = () => {
  ...
  const submitBtnColor = cardData.p01.isSubmitted
    ...
    : !(cardData.p01.answer1 === 'O' || isNotEmptyString(cardData.p01.answer2))
  ...
  const handleSubmit = () => {
    if (cardData.p01.isSubmitted) {
      ...
      setIsCorrect(cardData.p01.answer1.toLowerCase().trim() === cardData.p01.solution1 && cardData.p01.answer2 === cardData.p01.solution2);
      setCardData(prev => ({
        ...prev,
        p01: {
          ...prev.p01,
  ...
  return (
    <Container
      ...
      submitDisabled={!(cardData.p01.answer1 === 'O' || isNotEmptyString(cardData.p01.answer2))}
      ...
      <Box>
        ...
        <Box marginTop='20px'>
          <Box hAlign={'flex-start'}>
            <StyledTypography>
              1. Jenny ran to the train station,{' '}
