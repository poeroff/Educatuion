...
const P02 = () => {
  ...
  const submitBtnColor = cardData.p02.isSubmitted
    ...
    : !(cardData.p02.answer1 === 'O' || isNotEmptyString(cardData.p02.answer2))
  ...
  const handleSubmit = () => {
    if (cardData.p02.isSubmitted) {
      ...
      setIsCorrect(
        cardData.p02.answer1.toLowerCase().trim() === cardData.p02.solution1 && cardData.p02.answer2.toLowerCase().trim() === cardData.p02.solution2,
      );
      setCardData(prev => ({
        ...prev,
        p02: {
          ...
          isSubmitted: true,
          isCorrect:
            cardData.p02.answer1.toLowerCase().trim() === cardData.p02.solution1 &&
            cardData.p02.answer2.toLowerCase().trim() === cardData.p02.solution2,
        },
      }));
  ...
  const handleInputChangeEvent = ({ target }: ChangeEvent<HTMLInputElement>) => {
    setCardData(prev => ({ ...prev, p02: { ...prev.p02, answer2: target.value } }));
    changeData('P02', 1, 2, target.value);
  };
  useEffect(() => {
    if (inputRef.current != null) {
      if (cardData.p02.answer1 === 'O') {
        setCardData(prev => ({ ...prev, p02: { ...prev.p02, answer2: '' } }));
        changeData('P02', 1, 2, '');
        inputRef.current.value = '';
        inputRef.current.disabled = true;
      } else if (cardData.p02.answer1 === 'X') {
  ...
  return (
    <Container
      ...
      submitDisabled={!(cardData.p02.answer1 === 'O' || isNotEmptyString(cardData.p02.answer2))}
        ...
        <Box marginTop='20px'>
          <Box hAlign={'flex-start'}>
            <StyledTypography>
              ...
              a local craft artist, this hair band is original and unique.
            </StyledTypography>
          </Box>
        </Box>
      </Box>
              ...
              <TD width='10px' color={EStyleTableTypes.GRAY}>
                <Box display='flex'>
                  ...
                  <Dropdown
                    ...
                    ariaLabel={'2번 문제의 O/X 선택란'}
                    readOnly={cardData.p02.isSubmitted}
                    isError={cardData.p02.isSubmitted && !isAnswer(cardData.p02.answer1, cardData.p02.solution1)}
