...
const P04 = () => {
  ...
  const submitBtnColor = cardData.p04.isSubmitted
    ...
    : !(cardData.p04.answer1 === 'O' || isNotEmptyString(cardData.p04.answer2))
  ...
  return (
    <Container
      ...
      submitDisabled={!(cardData.p04.answer1 === 'O' || isNotEmptyString(cardData.p04.answer2))}
      ...
      <Box>
        ...
        <Box marginTop='20px'>
          <Box hAlign={'flex-start'}>
            <StyledTypography>
              4. The students work hard to achieve their goals,{' '}
