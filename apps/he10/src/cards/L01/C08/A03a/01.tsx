          ...
          <Box paddingLeft={'10px'}>
            <Typography>
              ...
              <Input
                ...
                ariaLabel='1번 답 입력란'
                status={isNotEmptyString(cardData.p01.answer) ? InputStatus.ENABLE : InputStatus.DEFAULT}
              />{' '}
        ...
        <Box background='lightGray' borderRadius='12px' marginTop='40px'>
          ...
          <Box marginTop='10px'>
            <Typography size={EStyleFontSizes.MEDIUM} usePre>
              a restaurant which offers, a restaurant that offers
            </Typography>
          </Box>
        </Box>
      </BottomSheet>
