...
const EEL04C02A08P03 = ({ layout, pageData, contentInfo }: Props) => {
  const CONST = { ...layout };
      ...
      <Scroll>
        <BoxWrap>
          <Box useFull textAlign='center'>
            <LabelTypes info='title' fontSize={32} background='#9747ff' color='#fff' type='paint' value={contentInfo} />
            <Box {...{ marginTop: '20px' }}>
              <Textarea
                height='256px'
