import { Box, TMainHeaderInfoTypes, Image, PinchZoom, IQuestionProps, EStyleButtonTypes, VideoPlayer } from '@maidt-cntn/ui';
...
const EEL03C02A02P03 = ({ videoInfo, inputInfo, answerInfo, pageInfo, getDefaultData, getCorrectData }: EEL03C02A02P03) => {
    ...
    >
      <Box useFull display='flex' flexDirection='column' alignItems='center' padding={'30px'} alignContent='center'>
        <Box display='flex' gap='30px' justifyContent='center' alignItems='center' marginBottom={'30px'}>
          <Box width={videoInfo.width || 448} height={videoInfo.height || 336}>
