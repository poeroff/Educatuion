...
const EEL11C03A05P01 = ({ headerInfo, questionInfo, data, pageInfo, getCorrectData, getDefaultData, imageInfo }: IEEL11C03A05P01) => {
  ...
  return (
    ...
    >
      <BoxWrap useFull display='flex' alignItems='flex-start' justifyContent='center'>
        <Box marginRight={20}>
