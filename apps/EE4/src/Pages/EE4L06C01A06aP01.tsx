    ...
    >
      <Box useFull>
        <BoxWrap useFull justifyContent={'center'} padding={'0px 40px'}>
          <GridBox onDragEnd={() => handleDragEnd()}>
            <AudioBox>
            ...
            <ImageBox>
              {imageList.map((img, idx) => {
                return (
                  <ImageWrap key={idx}>
                    <Box useShadow={true} useRound={true} background='white' width={`200px`} height={'188px'}>
...
export default EE4L06C01A06aP01;
