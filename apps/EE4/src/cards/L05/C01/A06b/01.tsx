  ...
  return (
    <EE4L05C01A06b
      layout={{
        ...
        audioInfo: { audioSrc: '/L05/C01/A06b/EE4-L05-C01-A06b-P01.mp3', captionSrc: '/L05/C01/A06b/EE4-L05-C01-A06b-P01.srt' },
      }}
      imgArr={[
        {
...

        {
          ...
          alt: '야구 글러브를 끼고, 야구 공을 들고 있는 여자아이',
          title: '야구 글러브를 끼고, 야구 공을 들고 있는 여자아이',
          value: '야구 하는 모습',
        },
