...
const P02 = () => {
  const data: IListenAndAnswer[] = [
    {
      ...
      audioSrc: '/L05/C02/A05b/EE4-L05-C02-A05b-P02-01.mp3',
    },
    {
      type: 'B',
      color: '#FFF0CC',
      content: <>Sorry, I can’t.</>,
      audioSrc: '/L05/C02/A05b/EE4-L05-C02-A05b-P02-02.mp3',
    },
  ];
  ...
  return (
    <EEL01C02A05P01
      ...
      audioInfo={{
        audioSrc: '/L05/C02/A05b/EE4-L05-C02-A05b-P02.mp3',
        captionSrc: '/L05/C02/A05b/EE4-L05-C02-A05b-P02.srt',
      }}
      data={data}
      mainKey={2}
      ...
      imageList={[
        {
          src: '/L05/C02/A05b/EE4-L05-C02-A05b-P02.jpg',
