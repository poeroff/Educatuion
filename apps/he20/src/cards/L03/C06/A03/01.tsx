...
const P01 = () => {
  ...
  const text = (
    <Typography>
      Welcome to the Dream Art Gallery! I'm Isabel Williams, the docent for the From Shadows to Spotlights exhibit. Today, you're going to meet three
      amazing artists who never gave up on their art, despite challenges in their lives. Each artist has a unique painting style and story that has
      made their work highly valued. Let's explore each artist's life and artwork.
    </Typography>
  );
