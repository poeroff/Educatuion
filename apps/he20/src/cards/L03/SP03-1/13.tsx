...
const P13 = ({ _page = 'P13' }) => {
  ...
  const contents: ITranslation[] = [
    {
      en: 'Today, you’re going to meet three amazing artists who never gave up on their art, ',
      ko: '오늘은 인생의 어려움에도 불구하고, 결코 예술을 포기하지 않은 세 명의 놀라운 예술가들을 만나보려고 합니다.',
    },
  ];
  ...
  const answer = 'despite challenges in their lives';
