...
const P16 = ({ _page = 'P16' }) => {
  ...
  const contents: ITranslation[] = [
    {
      en: 'Lewis went to live with her aunt in Digby, Nova Scotia, ',
      ko: 'Lewis는 노바 스코샤 주 딕비에 있는 이모와 함께 살게 되었고, 그곳에서 미래의 남편을 만났습니다.',
    },
  ];
  ...
  const answer = 'where she met her future husband';
