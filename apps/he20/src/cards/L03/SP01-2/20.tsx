...
const P20 = () => {
  ...
  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L03/SP01-2/HE2-L03-SP01-2-P20.mp3',
  };
    ...
    >
          ...
          <Box display='flex'>
            ...
            <Box>
              <Box display='flex' alignItems='end'>
                <Typography>Please note that photography is allowed, but you're not allowed to</Typography>
              </Box>
              <Box display='flex' alignItems='end'>
                <Typography>use flash as it may damage the exhibits.</Typography>
              </Box>
              <Box display='flex' alignItems='end'>
                <Typography>
                  We also ask that &nbsp;
                ...
                <Typography>for the comfort of other visitors.</Typography>
              </Box>
            </Box>
          </Box>
        </Box>
      ...
      <BottomSheet bottomSheetTargetId='container' height='40%' show={isAnswerShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>any phone call be made outside</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
