...
const P03 = () => {
  ...
  const questionInfo = {
    text: 'Write and talk about what these people have in common.',
  };
  ...
  return (
    <Container
      ...
      submitDisabled={
        !isNotEmptyString(cardData[pageKey].answer!) || Object.values(cardData[pageKey].audioData!).length === 0 || cardData[pageKey].isSubmitted
      }
      submitBtnColor={
        !isNotEmptyString(cardData[pageKey].answer!) || Object.values(cardData[pageKey].audioData!).length === 0
