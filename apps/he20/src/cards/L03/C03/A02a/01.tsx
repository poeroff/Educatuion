...
const P01 = () => {
  ...
  const questionInfo: IQuestionProps = {
    text: 'What is the boy allowed to do in the festival? Choose all.',
  ...
  const data = [
    {
      text: 'to bring a long umbrella inside',
    },
    {
      text: 'to use a locker near the entrance',
    },
    {
      text: 'to get a rain poncho at the information center',
    },
    {
      text: 'to re-enter showing a wrist band',
    },
    {
      text: 'to bring and eat any food inside',
    },
  ];
