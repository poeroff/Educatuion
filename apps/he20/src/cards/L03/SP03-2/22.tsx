...
const P22 = () => {
  ...
  const contents: ITranslation[] = [
    {
      en: 'After that, she even studied abroad in Paris, ',
      ko: '그 후 그녀는 파리에서 유학도 했는데, 이는 당시 여성으로서는 드문 일이었습니다.',
    },
  ];
  ...
  const answer = 'which was unusual for women at the time';
  ...
  return (
    ...
    >
      <Box marginBottom='24px' useRound height='162px' background='white' padding='10px'>
        <Scroll tabIndex={0}>
          <List<ITranslation>
            data={contents}
            row={({ value, index = 1 }) => (
