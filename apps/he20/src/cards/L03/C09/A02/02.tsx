...
const P02 = () => {
  ...
  const textView: ITextView = {
    title: 'Name & Job',
    text: 'Arturo Toscanini (1867–1957) was an Italian conductor who succeeded in the face of some of life’s challenges.',
  ...
  const boxNode = (
    <>
      <Box hAlign='center'>
        <Typography weight='var(--font-weight-bold)'>Name & Job</Typography>
      </Box>
      <Box display='flex'>
        <Question size={'small'}>
          <Typography weight='var(--font-weight-bold)'>1. Who is the artist?</Typography>
        </Question>
      </Box>
      <Box hAlign='center' vAlign='flex-start' paddingLeft='25px'>
        <Typography useGap={false}>
          {`Arturo Toscanini, an Italian `}
          <Input
            width='230px'
