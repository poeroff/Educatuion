...
const P07 = () => {
  ...
  const textView: ITextView = {
    title: 'Reputation',
    text: 'He made some very remarkable achievements, which is why he is still regarded as one of the most influential musicians of the  20th century.',
  ...
  const boxNode = (
    <>
      <Box hAlign='center'>
        <Typography weight='var(--font-weight-bold)'>Reputation</Typography>
      </Box>
      <Box display='flex'>
        <Question size={'small'}>
          <Typography weight='var(--font-weight-bold)'>5. What is he considered now?</Typography>
        </Question>
      </Box>
