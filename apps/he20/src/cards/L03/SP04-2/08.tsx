  ...
  return (
    ...
    >
      <Box useFull flexDirection='column' hAlign='center' gap='48px'>
        <Box vAlign='center' width='750px' height='156px' hAlign={'center'} background='white' useRound useShadow>
          <Box display='flex' hAlign='center'>
            <Typography>
              Sarah hosted a personal gallery with her photographs, <Typography type='blank' width='100px' title='빈칸' boxColor='var(--color-black)'></Typography> was her dream.
            </Typography>
          </Box>
        </Box>
        <BoxWrap>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isShowAnswer}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box marginTop='12px'>
            <Typography>{ cardData.p08.answerKor }</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
