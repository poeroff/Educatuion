...
const P11 = () => {
  ...
  const answer = 'They had to call off their family gathering due to the bad weather.';
  ...
  const questionInfo: IQuestionProps = {
    text: '단어카드를 알맞게 배열하여 빈칸에 들어갈 문장을 완성해 봅시다.',
    markSize: 'middle',
    mark: mark,
  };
  ...
  return (
    ...
    >
      <Box marginBottom='24px' useRound height='137px' background='white'>
          <Box padding='25px 110px'>
            <Typography> 좋지 않은 날씨 때문에, 그들은 가족 모임을 취소해야 했다. </Typography>
          </Box>
      </Box>
