...
const P07 = () => {
  ...
  const questionInfo: IQuestionProps = {
    text: <Typography>빈칸에 들어갈 알맞은 단어를 골라 봅시다.</Typography>,
  ...
  return (
    ...
    >
      <Box useFull flexDirection='column' hAlign='center' gap='48px'>
        <Box vAlign='center' width='800px' height='156px' hAlign={'center'} background='white' useRound useShadow>
          <Box display='flex' hAlign='center'>
            <Typography>
              <Typography type='blank' width='100px' title='빈칸' boxColor='var(--color-black)'></Typography> her continuous efforts, he doesn’t want to have a conversation with her until now.
            </Typography>
          </Box>
        </Box>
        <BoxWrap>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isShowAnswer}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box marginTop='12px'>
            <Typography>{ cardData.p07.answerKor }</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
