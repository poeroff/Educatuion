...
const P12 = () => {
  ...
  const answer = 'Juan is going to move to Spain, where he spent his childhood.';
    ...
    >
      <Box marginBottom='24px' useRound height='137px' background='white'>
          <Box padding='25px 30px'>
            <Typography> Juan은 스페인으로 이사할 예정인데, 그곳에서 그의 유년 시절을 보냈다. </Typography>
          </Box>
      </Box>
