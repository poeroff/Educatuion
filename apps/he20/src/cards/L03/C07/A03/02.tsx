    ...
    >
      <BoxWrap>
        <Box width='30%' hAlign={'center'} useRound border={'1px solid var(--color-grey-600)'}>
          <Image
            src={'/L03/C07/A03/HE2-L03-C07-A03-P02.jpg'}
            width='150px'
            height='200px'
            alt='모자를 쓰고 앞치마를 입은 채
              한 손에 붓을 들고 환하게
              웃는 여자 화가'
          />
        </Box>
      ...
      <Box vAlign='center' marginTop='20px'>
        ...
        <Typography color='var(--color-blue-400)'>Imagine you are Anna Ancher.</Typography>
      </Box>
      <Box>
        <Textarea
          value={cardData.p02.answer}
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='30%' show={isShow} closeOption={{ useYn: true, onClose: () => setShow(false) }}>
        <Box background='lightGray' borderRadius='12px' marginTop='35px'>
          ...
          <Box marginTop='12px'>
            Hi, I’m Anna Ancher. I’m excited to share my artworks with you. The Maid in the Kitchen and Sewing Fisherman’s Wife focus on portraying
            women actively engaged in everyday tasks. Additionally, Sunlight in the Blue Room captures the reflection of the sunlight on the blue
            wall, and it contributed to the Impressionist movement in Denmark.
          </Box>
        </Box>
      </BottomSheet>
    </Container>
