...
const P03 = () => {
  ...
  const submitBtnColor = !cardData.p03.answer ? EStyleButtonTypes.SECONDARY : isShow ? EStyleButtonTypes.GRAY : EStyleButtonTypes.PRIMARY
  const dialog = '“Hello, I’m Maud Lewis. My art captures the beauty of the world around me. In ...”';
  ...
  return (
    ...
    >
      ...
      <Box width='30%' hAlign={'center'} useRound border={'1px solid var(--color-grey-600)'}>
          <Image
            src={'/L03/C07/A03/HE2-L03-C07-A03-P03.jpg'}
            width='250px'
            height='200px'
            alt='안경을 쓰고 한 손에 붓과
              다른 한 손에 팔레트를 들고
      ...
      <Box>
        <Textarea
          value={cardData.p03.answer}
          readOnly={cardData.p03.isSubmitted ? true : false}
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='30%' show={isShow} closeOption={{ useYn: true, onClose: () => setShow(false) }}>
        <Box background='lightGray' borderRadius='12px' marginTop='35px'>
          ...
          <Box marginTop='12px'>
            Hello, I’m Maud Lewis. My art captures the beauty of the world around me. In Edge of Digby Harbor, I portray the beautiful views of Digby,
            where I met my husband. I also enjoy using bright colors and simple shapes to show my endless imagination. Red Sleigh contrasts red leaves
            with snow, and Pair of Oxen depicts decorated cows in a field of flowers, like in a fairy tale.
          </Box>
        </Box>
      </BottomSheet>
    </Container>
