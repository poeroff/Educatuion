...
export const imgContentA02P01 = {
  imgSrc: `/L03/C07/A02/HE2-L03-C07-A02-P01.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽
  제목 Artists Who Never Gave up on Their Art Despite 빈칸 in Their Lives
  첫 번째 칸 Bill Traylor의 born, Life History, Works에 관한 내용
  두 번째 칸 Maud Lewis의 born, Life History, Works에 관한 내용
  세 번째 칸 Anna Ancher의 born, Life History, Works에 관한 내용`,
};

export const imgContentA02P02 = {
  imgSrc: `/L03/C07/A02/HE2-L03-C07-A02-P02.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽
  제목 Artists Who Never Gave up on Their Art Despite 빈칸 in Their Lives
  첫 번째 칸 Bill Traylor의 born, Life History, Works에 관한 내용
  두 번째 칸 Maud Lewis의 born, Life History, Works에 관한 내용
...
export const imgContentA02P03 = {
  imgSrc: `/L03/C07/A02/HE2-L03-C07-A02-P03.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽
  제목 Artists Who Never Gave up on Their Art Despite 빈칸 in Their Lives
  첫 번째 칸 Bill Traylor의 born, Life History, Works에 관한 내용
  두 번째 칸 Maud Lewis의 born, Life History, Works에 관한 내용
...
export const imgContentA02P04 = {
  imgSrc: `/L03/C07/A02/HE2-L03-C07-A02-P04.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽
  제목 Artists Who Never Gave up on Their Art Despite 빈칸 in Their Lives
  첫 번째 칸 Bill Traylor의 born, Life History, Works에 관한 내용
  두 번째 칸 Maud Lewis의 born, Life History, Works에 관한 내용
...
export const imgContentA02P05 = {
  imgSrc: `/L03/C07/A02/HE2-L03-C07-A02-P05.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽
  제목 Artists Who Never Gave up on Their Art Despite 빈칸 in Their Lives
  첫 번째 칸 Bill Traylor의 born, Life History, Works에 관한 내용
  두 번째 칸 Maud Lewis의 born, Life History, Works에 관한 내용
