...
const P02 = () => {
  ...
  const questionInfo: IQuestionProps = {
    text: '2. Listen again. Which tip is NOT mentioned in the dialogue?',
  ...
  const data = [
    {
      text: `Don’t record the live concert.`,
    },
    {
      text: `Don’t use your cell phone.`,
    },
    {
      text: `Don’t clap until each piece has finished.`,
    },
    {
      text: `Don’t dress too casually.`,
    },
  ];
