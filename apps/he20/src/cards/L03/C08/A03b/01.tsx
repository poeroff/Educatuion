  ...
  const nodeData: IContentList[] = [
    {
      children: (
        <Box marginTop='12px'>
          <Typography>1. 다른 그룹이 캠핑장을 청소하는 동안에, 한 그룹은 요리를 했다. </Typography>
        </Box>
      ),
    },
    {
      children: (
        <BoxWrap height='100px' flexDirection='column' marginTop='24px'>
          <Box vAlign='center' hAlign='flex-start' flexDirection='row'>
            ...
            <Box>
              <Typography>One group cooked the food</Typography>
            </Box>
            <Dropdown
              width='264px'
              type='up'
            ...
            />
            <Typography>the other</Typography>
          </Box>
          <Box>
            <Typography>cleaned the camping site.</Typography>
          </Box>
        </BoxWrap>
      ),
    },
