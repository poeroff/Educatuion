  ...
  const nodeData: IContentList[] = [
    {
      children: (
        <Box marginTop='12px'>
          <Typography>3. 에베레스트 산에서의 힘든 코스에도 불구하고, 그 등산가들은 꼭대기로 나아갔다.</Typography>
        </Box>
      ),
    },
    {
      children: (
        <BoxWrap height='100px' flexDirection='column' marginTop='24px'>
          <Box vAlign='center' hAlign='flex-start' flexDirection='row'>
            ...
            />
            <Box>
              <Typography>the challenging courses on Mt. Everest, </Typography>
            </Box>
          </Box>
          <Box>
            <Typography>the climbers made their way to the top.</Typography>
          </Box>
        </BoxWrap>
      ),
    },
