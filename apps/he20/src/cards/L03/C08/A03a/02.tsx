...
const P02 = () => {
  ...
  const submitBtnColor = cardData.p02.isSubmitted
    ...
    : cardData.p02.answer1 === 'O' || (cardData.p02.answer1 === 'X' && isNotEmptyString(cardData.p02.answer2))
    ? EStyleButtonTypes.PRIMARY
  ...
  const handleSubmit = () => {
    if (cardData.p02.isSubmitted) {
      ...
      const isCorrect =
        ...
        (cardData.p02.answer1 === 'O' || isAnswer(cardData.p02.answer2, cardData.p02.solution2));
      setCardData(prev => ({
        ...prev,
        p02: {
          ...prev.p02,
    ...
    if (value !== undefined) {
      ...
      setCardData(prev => ({
        ...
        p02: {
          ...prev.p02,
          answer1: value,
          answer2: value === 'O' ? '' : prev.p02.answer2,
        },
      }));
  ...
  return (
    <Container
      ...
      submitDisabled={!(cardData.p02.answer1 === 'O' || (cardData.p02.answer1 === 'X' && isNotEmptyString(cardData.p02.answer2)))}
              ...
              <TD color={EStyleTableTypes.GRAY}>
                <Box display='flex'>
                  ...
                  <Input
                    ...
                    maxLength={20}
                    readOnly={cardData.p02.isSubmitted}
                    disabled={cardData.p02.answer1 !== 'X'}
                    status={
