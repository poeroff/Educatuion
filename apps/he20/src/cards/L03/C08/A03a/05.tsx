...
const P05 = () => {
  ...
  const submitBtnColor = cardData.p05.isSubmitted
    ...
    : cardData.p05.answer1 === 'O' || (cardData.p05.answer1 === 'X' && isNotEmptyString(cardData.p05.answer2))
    ? EStyleButtonTypes.PRIMARY
  ...
  const handleSubmit = () => {
    if (cardData.p05.isSubmitted) {
      ...
      const isCorrect =
        ...
        (cardData.p05.answer1 === 'O' || isAnswer(cardData.p05.answer2, cardData.p05.solution2));
      setCardData(prev => ({
        ...prev,
        p05: {
          ...prev.p05,
    ...
    if (value !== undefined) {
      ...
      setCardData(prev => ({
        ...
        p05: {
          ...prev.p05,
          answer1: value,
          answer2: value === 'O' ? '' : prev.p05.answer2,
        },
      }));
  ...
  return (
    <Container
      ...
      submitDisabled={!(cardData.p05.answer1 === 'O' || (cardData.p05.answer1 === 'X' && isNotEmptyString(cardData.p05.answer2)))}
            ...
            <Box hAlign='flex-start'>
              <BoxWrap>
                <StyledTypography>
                  ...
                  her writing was not well-organized, she got an A because of the informative content.{' '}
                </StyledTypography>
              </BoxWrap>
            </Box>
          </Box>
              ...
              <TD color={EStyleTableTypes.GRAY}>
                <Box display='flex'>
                  ...
                  <Input
                    ...
                    maxLength={20}
                    readOnly={cardData.p05.isSubmitted}
                    disabled={cardData.p05.answer1 !== 'X'}
                    status={
        ...
        <Box background='lightGray' borderRadius='12px' marginTop='35px'>
          ...
          <Box marginTop='12px'>
            <Typography size={EStyleFontSizes.MEDIUM} usePre>
              (1) {`${cardData.p05.solution1} \n (2) ${cardData.p05.solution2} `}
            </Typography>
          </Box>
        </Box>
      </BottomSheet>
