...
const P01 = () => {
  ...
  const submitBtnColor = cardData.p01.isSubmitted
    ...
    : cardData.p01.answer1 === 'O' || (cardData.p01.answer1 === 'X' && isNotEmptyString(cardData.p01.answer2))
    ? EStyleButtonTypes.PRIMARY
  ...
  const handleSubmit = () => {
    if (cardData.p01.isSubmitted) {
      ...
      const isCorrect =
        ...
        (cardData.p01.answer1 === 'O' || isAnswer(cardData.p01.answer2, cardData.p01.solution2));
      setCardData(prev => ({
        ...prev,
        p01: {
          ...prev.p01,
    ...
    if (value !== undefined) {
      ...
      setCardData(prev => ({
        ...
        p01: {
          ...prev.p01,
          answer1: value,
          answer2: value === 'O' ? '' : prev.p01.answer2,
        },
      }));
  ...
  useEffect(() => {
    if (inputRef.current != null) {
      if (cardData.p01.answer1 === 'O') {
        setCardData(prev => ({ ...prev, p01: { ...prev.p01, answer2: '' } }));
        changeData('P01', 1, 2, '');
        inputRef.current.value = '';
        inputRef.current.disabled = true;
      } else if (cardData.p01.answer1 === 'X') {
  ...
  return (
    <Container
      ...
      submitDisabled={!(cardData.p01.answer1 === 'O' || (cardData.p01.answer1 === 'X' && isNotEmptyString(cardData.p01.answer2)))}
              ...
              <TD color={EStyleTableTypes.GRAY}>
                <Box display='flex'>
                  ...
                  <Input
                    ...
                    maxLength={20}
                    readOnly={cardData.p01.isSubmitted}
                    disabled={cardData.p01.answer1 !== 'X'}
                    status={
