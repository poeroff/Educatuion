import {  Box,  TMainHeaderInfoTypes,  Typography,  Recorder,  EStyleButtonTypes,  BottomSheet,  Tag,  ETagLine,  IRecorderRef, IUploadRecordData,  IAudioData,} from '@maidt-cntn/ui';
  ...
  return (
    ...
    >
      <Box vAlign='center' marginTop='20px' textAlign='center' tabIndex={101} flexDirection='column' gap='8px'>
        <Typography> What movie have you watched recently and how was it? </Typography>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='30%' show={isShowAnswer}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box vAlign='flex-start' marginTop='10px' textAlign='left' tabIndex={103} flexDirection='column' gap='10px'>
            ...
            <Typography> {cardData.p01.questionKor} </Typography>
