    ...
    >
      <Box hAlign='start'>
        ...
        <Box backgroundColor='var(--color-blue-100)' border='none' useRound hAlign='center' padding='12px' margin='0 8px'>
          <Typography>How was your class trip to the theme park?</Typography>
        </Box>
      </Box>
      <Box marginTop='20px'>
        <Box hAlign='end'>
          ...
          <TextView title='보기' hAlign='start'>
            <Box>
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                It was truly amazing! I had so much fun with my classmates.
              </Typography>
            </Box>
            <Box>
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                I'll probably go on a trip right before the summer vacation.
              </Typography>
            </Box>
          </TextView>
        </Box>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isAnswerShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>It was truly amazing! I had so much fun with my classmates.</Typography>
          </Box>
          ...
          <Box marginTop='10px' display='flex' flexDirection='column'>
            <Typography>A: 놀이공원으로 간 학급 여행은 어땠어?</Typography>
            <Typography>B: 정말 멋졌어! 나는 반 친구들과 정말 즐거웠어.</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
