...
const P10 = () => {
  ...
  return (
    <Container
      ...
      submitLabel={!cardData.p10.isSubmitted ? '완료하기' : !isAnswerShow ? '답안 보기' : '답안 닫기'}
      onSubmit={onSubmit}
      submitDisabled={
    ...
    >
      <Box hAlign='start'>
        ...
        <Box backgroundColor='var(--color-blue-100)' border='none' useRound hAlign='center' padding='12px' margin='0 8px'>
          <Typography>How was the singers' performance at the concert?</Typography>
        </Box>
      </Box>
      <Box marginTop='20px'>
        <Box hAlign='end'>
          ...
          <TextView title='보기' hAlign='start'>
            <Box>
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                It was incredible. I was impressed by their energy.
              </Typography>
            </Box>
            <Box>
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                I wish I could have been there. Let's go there next time.
              </Typography>
            </Box>
          </TextView>
        </Box>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isAnswerShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>It was incredible. I was impressed by their energy.</Typography>
          </Box>
          ...
          <Box marginTop='10px' display='flex' flexDirection='column'>
            <Typography>A: 콘서트에서 가수들의 공연은 어땠어?</Typography>
            <Typography>B: 대단했어. 나는 그들의 에너지가 인상 깊었어.</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
