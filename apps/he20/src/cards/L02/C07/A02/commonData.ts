export const textContentA02 = {
  ...
  subTitleIndexes: new Set<number>([1, 3, 5]),
};

export const imgContentA02P01 = {
  imgSrc: `/L02/C07/A02/HE2-L02-C07-A02-P01.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 cause에 관한 내용 아래로 향하는 화살표 Dark Patterns 양쪽으로 향하는 화살표 왼쪽 Meaning에 관한 내용 오른쪽 Types에 관한 내용 아래로 향하는 화살표 Actions Against Dark Patterns 양쪽으로 향하는 화살표 왼쪽 Society에 관한 내용 오른쪽 Individuals 에 관한 내용`,
};

export const imgContentA02P02 = {
  imgSrc: `/L02/C07/A02/HE2-L02-C07-A02-P02.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 cause에 관한 내용 아래로 향하는 화살표 Dark Patterns 양쪽으로 향하는 화살표 왼쪽 Meaning에 관한 내용 오른쪽 Types에 관한 내용 아래로 향하는 화살표 Actions Against Dark Patterns 양쪽으로 향하는 화살표 왼쪽 Society에 관한 내용 오른쪽 Individuals 에 관한 내용`,
};

export const imgContentA02P03 = {
  imgSrc: `/L02/C07/A02/HE2-L02-C07-A02-P03.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 cause에 관한 내용 아래로 향하는 화살표 Dark Patterns 양쪽으로 향하는 화살표 왼쪽 Meaning에 관한 내용 오른쪽 Types에 관한 내용 아래로 향하는 화살표 Actions Against Dark Patterns 양쪽으로 향하는 화살표 왼쪽 Society에 관한 내용 오른쪽 Individuals 에 관한 내용`,
};

export const imgContentA02P04 = {
  imgSrc: `/L02/C07/A02/HE2-L02-C07-A02-P04.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 cause에 관한 내용 아래로 향하는 화살표 Dark Patterns 양쪽으로 향하는 화살표 왼쪽 Meaning에 관한 내용 오른쪽 Types에 관한 내용 아래로 향하는 화살표 Actions Against Dark Patterns 양쪽으로 향하는 화살표 왼쪽 Society에 관한 내용 오른쪽 Individuals 에 관한 내용`,
};

export const imgContentA02P05 = {
  imgSrc: `/L02/C07/A02/HE2-L02-C07-A02-P05.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 cause에 관한 내용 아래로 향하는 화살표 Dark Patterns 양쪽으로 향하는 화살표 왼쪽 Meaning에 관한 내용 오른쪽 Types에 관한 내용 아래로 향하는 화살표 Actions Against Dark Patterns 양쪽으로 향하는 화살표 왼쪽 Society에 관한 내용 오른쪽 Individuals 에 관한 내용`,
};
