...
const P03 = () => {
  ...
  return (
    <Container
      ...
      submitDisabled={cardData.p03.isSubmitted ? false : !isNotEmptyString(cardData.p03.answer1)}
    ...
    >
        ...
        <Box hAlign='center'>
          <PinchZoom>
            ...
            <Box type='hidden' id='img_desc'>
              <p>계산서</p>
              <p>Order Details Confirm and Pay</p>
              <p>You’ll pay 300 dollar per ticket.</p>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' show={cardData.p03.isSubmitted && isShowAnswer} height='30%'>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px' tabIndex={103}>
            <Typography size={EStyleFontSizes.SMALL}>
              I chose “ hidden fees” and made them user-friendly. Before the change, users may have been surprised at the final step of the ordering
              process. With my changes, however, I have made the extra costs clear from the beginning so that users will know about them.
            </Typography>
          </Box>
        </Box>
      </BottomSheet>
