...
const P04 = () => {
  ...
  const answerImage = '/L02/C07/A03/HE2-L02-C07-A03-P04-02.jpg';
  ...
  return (
    <Container
      ...
      submitLabel={cardData.p04.isSubmitted ? (isShowAnswer ? '답안 닫기' : '답안 보기') : '완료하기'}
    ...
    >
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' show={cardData.p04.isSubmitted && isShowAnswer} height='30%'>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          <Box>
            <Tag type={ETagLine.GREEN} label='답안' />
          </Box>
          <Box marginTop='10px'>
            <Box hAlign='flex-left' tabIndex={103}>
              <PinchZoom>
                <Image src={answerImage} width='200px' height='150px' alt='' ariaDescribedby='img_desc2' />
                <Box type='hidden' id='img_desc2'>
                  <p>커뮤니티 사이트 창</p>
                  <p>메뉴 Home Search Settings Help About Us Settings Account</p>
                  <p>상세 메뉴 Profile Payment Info Collections Cancle Subscription</p>
                </Box>
              </PinchZoom>
            </Box>
          </Box>
