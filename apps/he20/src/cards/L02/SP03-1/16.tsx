...
const P16 = ({ _page = 'P16' }) => {
  ...
  const contents: ITranslation[] = [
    {
      en: ' even if it goes against the members’ intentions.',
      ko: '기업들은 회원들의 의도에 어긋난다고 할지라도 회원들의 구독 상태를 유지하기 위해서 이를 사용한다.',
    },
  ];
  ...
  const answer = 'Companies use this to keep their members subscribed';
                ...
                <Box>
                  ...
                  <Box>
                    <Typography tabIndex={Number(`1${index}3`)} size={EStyleFontSizes.MEDIUM}>
                      <Typography type='blank' width='200px' title='빈칸' boxColor='var(--color-black)'></Typography>,{value?.en}
                    </Typography>
                  </Box>
                </Box>
              </BoxWrap>
