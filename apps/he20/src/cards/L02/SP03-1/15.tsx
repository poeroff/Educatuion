...
const P15 = ({ _page = 'P15' }) => {
  ...
  const contents: ITranslation[] = [
    {
      en: 'As a result, users have to pay membership fees ',
      ko: '그 결과, 사용자는 더 이상 서비스를 이용하고 싶지 않아도 회비를 지불해야 한다.',
    },
  ];
  ...
  const answer = 'even if they no longer want to use the service';
