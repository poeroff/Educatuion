    ...
    >
      <Box hAlign='start'>
        ...
        <Box backgroundColor='var(--color-blue-100)' border='none' useRound hAlign='center' padding='12px' margin='0 8px'>
          <Typography>What do you think about the facial cream?</Typography>
        </Box>
      </Box>
      <Box marginTop='20px'>
        <Box hAlign='end'>
          ...
          <TextView title='보기' hAlign='start'>
            <Box>
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                I think using facial cream is better for my skin.
              </Typography>
            </Box>
            <Box>
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                I’m not satisfied with the cream because it’s too oily
                <br />
                for me.
              </Typography>
            </Box>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isAnswerShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>I’m not satisfied with the cream because it’s too oily for me.</Typography>
          </Box>
          ...
          <Box marginTop='10px' display='flex' flexDirection='column'>
            <Typography>A: 그 얼굴용 크림에 대해 어떻게 생각해?</Typography>
            <Typography>B: 나한테 너무 기름져서 나는 그 크림에 만족하지 않아.</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
