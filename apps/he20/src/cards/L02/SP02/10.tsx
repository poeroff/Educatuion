    ...
    >
      <Box hAlign='start'>
        ...
        <Box backgroundColor='var(--color-blue-100)' border='none' useRound hAlign='center' padding='12px' margin='0 8px'>
          <Typography>
            What kind of sweater do you want more,
            <br />
            wool sweaters or cotton sweaters?
          </Typography>
        </Box>
      </Box>
      <Box marginTop='20px'>
          ...
          <TextView title='보기' hAlign='start'>
            <Box>
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                I’d like to buy cotton sweaters because cotton is
                <br />
            ...
            <Box>
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                I want to put on a sweater that doesn’t feel too tight.
              </Typography>
            </Box>
          </TextView>
        </Box>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isAnswerShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>I’d like to buy cotton sweaters because cotton is more comfortable than wool.</Typography>
          </Box>
          ...
          <Box marginTop='10px' display='flex' flexDirection='column'>
            <Typography>A: 양모 스웨터와 면 스웨터 중 어떤 종류의 스웨터를 더 원하시나요?</Typography>
            <Typography>B: 면이 양모보다 더 편하기 때문에 저는 면 스웨터를 사고 싶습니다.</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
