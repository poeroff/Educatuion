...
const P01 = () => {
  ...
  const solution = '(should) pay';
  const dropDownOptions = [solution, 'paid'];
  ...
  return (
    <HE20L02C08A05b
      hint='회사는 이제부터 고객이 배송비를 지불해야 한다고 주장한다.'
      solution={solution}
      ...
      questionBox={
        <Typography>
          <Box>
            1. The company insists customers &nbsp;
            <DropdownContainer>
              <Dropdown
