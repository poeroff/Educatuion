...
const P04 = ({ imgSrc, imgAlt }: { imgSrc: string; imgAlt: string }) => {
  ...
  return (
    ...
    >
      ...
      <Box marginTop='24px'>
        <Box>
          <Typography>4. 나는 용돈을 다 써 버렸어. 지난주에 그 헤드폰을 사지 말았어야 했어.</Typography>
        </Box>
        <Box hAlign={'flex-start'}>
          <StyledTypography>
            <SvgIcon style={{ verticalAlign: 'text-top', padding: '4px 12px', margin: '0 0 0 20px' }} src={arrow_right} size='36px' />
            <TextPartRight>I used up all of my allowance. I</TextPartRight>
            <Input
              width={'320px'}
              textAlign='start'
              value={answer}
            ...
            <TextPartLeft>headphones last week.</TextPartLeft>
          </StyledTypography>
        </Box>
      </Box>
