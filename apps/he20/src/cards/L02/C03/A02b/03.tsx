...
const P03 = () => {
  ...
  const list: IData[] = [
    {
      contents: '(1) The girl is not happy with the class she’s taking.',
      answer: cardData.p03.answer1,
      solution: cardData.p03.solution1,
    },
    {
      contents: '(2) The boy advises the girl to take the most popular course.',
      answer: cardData.p03.answer2,
      solution: cardData.p03.solution2,
    },
    {
      contents: '(3) The girl will watch introduction videos for a course next time.',
