...
const P01 = () => {
  ...
  const questionInfo: IQuestionProps = {
    text: '1. What does the man ask the woman to do?',
  ...
  const data = [
    {
      text: 'go for lunch with his family',
    },
    {
      text: 'provide directions to the nearest park',
    },
    {
      text: 'make a reservation at a Korean restaurant',
    },
    {
      text: 'recommend a place for a family gathering',
    },
  ];
