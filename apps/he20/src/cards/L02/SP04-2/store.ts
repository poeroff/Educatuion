...
export const L02SP04_2 = atom<object>({
  key: 'L02SP04_2',
  default: {
    p05: {
      answer1: '',
    ...
    p07: {
      answer1: '',
      solution1: 'should',
      examples: ['He has no money now. He', '___', 'not have spent all his', 'allowance on shopping.'],
      options: ['must', 'should', 'may'],
      translations: ['그는 지금 돈이 없다. 그는 쇼핑에 그의 용돈 전부를 쓰지 않았어야 했다.'],
      isCorrect: false,
      isSubmitted: false,
    },
    ...
    p08: {
      answer1: '',
      solution1: 'is',
      examples: ['Research suggests that too much exercise', '___', 'harmful to our health.'],
      options: ['is', 'be', 'should be'],
      translations: ['연구는 너무 많은 운동이 우리의 건강에 해롭다고 제시한다.'],
      isCorrect: false,
      isSubmitted: false,
    },
    ...
    p11: {
      ...
      correctExamples: [
        {
          text: 'I can’t find my backpack. I',
        },
        {
          text: 'may(might)',
          underline: true,
        ...
        {
          text: 'have left it at the library.',
        },
      ],
      examples: [
        {
      ...
      exampleTranslation: '나는 내 가방을 찾을 수 없다. 도서관에 가방을 두고 왔을지도 모른다.',
      isSubmitted: false,
    },
    ...
    p12: {
      ...
      correctExamples: [
        {
          text: 'I’m late to school again. I',
        },
        {
          text: 'should',
          underline: true,
      ...
      exampleTranslation: '나는 또 학교에 늦었다. 나는 더 일찍 일어났어야 했다.',
      isSubmitted: false,
    },
