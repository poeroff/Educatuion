...
export const P01 = () => {
  ...
  const onGrade = () => {
    if (cardData.p01.isSubmitted) {
      ...
      const isCorrect1 = cardData.p01.answer1.trim().toUpperCase() === cardData.p01.solution1;
  ...
  return (
    ...
    >
      <StyleReceipt.BackgroundWrap isNoLine={true}>
        <StyleReceipt.Content>
          <StyleReceipt.TextWrap>
            <Box paddingTop='40px' paddingLeft='12px' width='422px'>
              <Typography>{`\n`}</Typography>
            </Box>
          </StyleReceipt.TextWrap>
          ...
          <Scroll height='290px'>
            <StyleReceipt.TextWrap>
              <Box paddingLeft='12px' width='430px' vAlign='left'>
                <StyleReceipt.ContentText weight={800}>ORGANIC</StyleReceipt.ContentText>
                ...
                <Input
                  ...
                  status={
                    !cardData.p01.isSubmitted
                      ? InputStatus.ENABLE
                      : cardData.p01.answer1.trim().toUpperCase() !== cardData.p01.solution1
                      ? InputStatus.ERROR
                      : ''
                  }
                />
            ...
            <StyleReceipt.TextWrap>
              <Box paddingLeft='12px' width='553px'>
                <StyleReceipt.ContentText weight={800}>SWEATER</StyleReceipt.ContentText>
              </Box>
            </StyleReceipt.TextWrap>
            ...
            <StyleReceipt.TextWrap>
              ...
              <Box marginTop='12px'>
                ...
                <Input
                  ...
                  readOnly={cardData.p01.isSubmitted}
                  status={
                    !cardData.p01.isSubmitted ? InputStatus.ENABLE : cardData.p01.answer4.trim() !== cardData.p01.solution4 ? InputStatus.ERROR : ''
                  }
                />
              </Box>
            </StyleReceipt.TextWrap>
            ...
            <StyleReceipt.TextWrap>
              ...
              <Box marginTop='25px'>
                ...
                <Input
                  ...
                  readOnly={cardData.p01.isSubmitted}
                  status={
                    !cardData.p01.isSubmitted ? InputStatus.ENABLE : cardData.p01.answer5.trim() !== cardData.p01.solution5 ? InputStatus.ERROR : ''
                  }
                />
              </Box>
            </StyleReceipt.TextWrap>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={showAnswer}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box marginTop='10px'>
            <Typography>(1) COTTON (2) 50 (3) 20 (4) 10 (5) 35</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
