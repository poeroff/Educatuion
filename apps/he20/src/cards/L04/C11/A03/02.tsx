...
const P02 = () => {
  ...
  const data: IListenAndAnswer[] = [
    {
      type: 'A',
      content: <>Which job do you think will become important in the future?</>,
      audioSrc: '/L04/C11/A03/HE2-L04-C11-A03-P02-01.mp3',
    },
    {
      type: 'B',
      content: (
      ...
      audioSrc: '/L04/C11/A03/HE2-L04-C11-A03-P02-02.mp3',
    },
    {
      type: 'A',
      content: <>They’re already popular now, but will they become even more important?</>,
      audioSrc: '/L04/C11/A03/HE2-L04-C11-A03-P02-03.mp3',
    },
    {
      type: 'B',
      content: (
      ...
      audioSrc: '/L04/C11/A03/HE2-L04-C11-A03-P02-04.mp3',
    },
    {
      type: 'A',
      content: <>What makes you think so?</>,
      audioSrc: '/L04/C11/A03/HE2-L04-C11-A03-P02-05.mp3',
    },
    {
      type: 'B',
      content: (
        <>
          ...
          This will make people feel lonely.
        </>
      ),
      audioSrc: '/L04/C11/A03/HE2-L04-C11-A03-P02-06.mp3',
    },
    {
      type: 'A',
      content: <>I see your point. Thanks for sharing your thoughts!</>,
      audioSrc: '/L04/C11/A03/HE2-L04-C11-A03-P02-07.mp3',
    },
  ];
  ...
  const isShowRecordAudio = (value: IListenAndAnswer | undefined, index: number) => {
    ...
    return {
      audio: !isMyRole && (isDone || isInProgress) && !cardData.p02.isSubmitted,
      recorder: isMyRole && (isDone || (isInProgress && !isStop)),
    };
  };
  ...
  const handleAudioEnded = (subKey: number) => {
    ...
    changeData(currentPage, 1, subKey, true);
  };
