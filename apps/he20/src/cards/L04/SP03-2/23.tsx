...
const P23 = () => {
  ...
  const contents: ITranslation[] = [
    {
      en: 'The integration of AI technology with the human brain raises concerns about ',
      ko: 'AI 기술과 인간의 뇌를 통합하는 것은 인간 존재의 의미가 무엇인지에 대한 우려를 제기할 수 있습니다.',
    },
  ];
  ...
  const answer = 'what it means to be human';
  ...
  const chipButtonOnClick = (index: number) => {
    ...
    if (clickedChipButtons.includes(index)) {
      ...
      changeData(pageName, 1, 1, [...cardData.p23.answer, index]);
    }
  };
