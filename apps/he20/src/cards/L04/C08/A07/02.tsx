...
const P02 = () => {
  ...
  const checkDisableInput = () => {
    return !Object.keys(cardData.p02.audioData!).length;
  };
  ...
  return (
    ...
    >
      <BoxWrap justifyContent={'center'}>
        <Image
          alt={`The fact that I got 19,000 likes on my post. 라고 말하면서 휴대전화를 보고 있는 여자 옆에 I need likes. 라고 쓰인 노트북에 대고 기도하는 여자가 있다`}
          src={'/L04/C08/A07/HE2-L04-C08-A07-02.jpg'}
          width='450px'
          height='300px'
        />
      </BoxWrap>
