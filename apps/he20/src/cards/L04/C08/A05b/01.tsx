  ...
  const nodeData: IContentList[] = [
    {
      children: (
        <Box>
          ...
          <Typography>I agree with the opinion. The opinion is that we should have a </Typography>
          <Typography>flea market this Friday.</Typography>
        </Box>
      ),
    },
    {
        ...
        <BoxWrap flexDirection={'column'} marginTop={'10px'}>
          <Box display={'flex'} alignItems={'center'}>
            ...
            <Input
              ...
              inputSize={'x-small'}
            />
            <Typography>we should have a flea market</Typography>
          </Box>
          <Box>
            <Typography> this Friday.</Typography>
          </Box>
        </BoxWrap>
      ),
    },
