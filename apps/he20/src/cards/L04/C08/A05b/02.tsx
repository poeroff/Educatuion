  ...
  const nodeData: IContentList[] = [
    {
      children: (
        <Box>
          ...
          <Typography useGap={false}>He has a dream. His dream is that one day he will open a restaurant </Typography>
          <Typography>named after himself.</Typography>
        </Box>
      ),
    },
    {
        ...
        <BoxWrap flexDirection={'column'} marginTop={'10px'}>
          <Box display={'flex'} alignItems={'center'}>
            ...
            <Input
              ...
              inputSize={'x-small'}
            />
            <Typography>one day he will open a restaurant </Typography>
          </Box>
          <Box>
            <Typography> named after himself.</Typography>
          </Box>
