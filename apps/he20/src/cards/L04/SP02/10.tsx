  ...
  return (
    ...
    >
      <SpeechBallon
        part='A'
        hasRecord={false}
        speech='What job do you think will be popular in the future?
        '
        marginTop={20}
      />
      <SpeechBallon
        ...
        hasRecord={true}
        sentences={[
          'The job is already popular now, but they will become more important.',
          'I believe that genetic researchers will be one of the most popular jobs in the future.',
        ]}
        marginTop={20}
      />
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isAnswerShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>I believe that genetic researchers will be one of the most popular jobs in the future.</Typography>
          </Box>
          ...
          <Box marginTop='10px' display='flex' flexDirection='column'>
            <Typography>A: 미래에는 어떤 직업이 인기 있을 것이라고 생각하니?</Typography>
            <Typography>B: 나는 유전공학자가 미래에 가장 인기 있는 직업 중 하나가 될 것이라고 생각해.</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
