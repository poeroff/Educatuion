  ...
  return (
    ...
    >
      <SpeechBallon
        part='A'
        hasRecord={false}
        speech='What do you think about AI art?
        '
        marginTop={20}
      />
      <SpeechBallon
        part='B'
        hasRecord={true}
        sentences={['I believe that AI art can’t be called real art.', 'I’ll show you how to use AI programs to create artworks.']}
        marginTop={20}
      />
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isAnswerShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>I believe that AI art can’t be called real art.</Typography>
          </Box>
          ...
          <Box marginTop='10px' display='flex' flexDirection='column'>
            <Typography>A: AI 예술에 대해 어떻게 생각해?</Typography>
            <Typography>B: 나는 AI 예술이 진정한 예술로 불릴 수 없다고 생각해.</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
