  ...
  return (
    ...
    >
      <SpeechBallon
        part='A'
        hasRecord={true}
        sentences={['What kind of restaurant do you want to visit today?', 'Can you show me how to use this restaurant review app?']}
        marginTop={20}
      />
      <SpeechBallon
        part='B'
        hasRecord={false}
        speech={'Sure. Enter your location, and then arrange the restaurants in the order of the highest ratings.'}
        marginTop={20}
      />
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isAnswerShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>Can you show me how to use this restaurant review app?</Typography>
          </Box>
          ...
          <Box marginTop='10px' display='flex' flexDirection='column'>
            <Typography>A: 식당 리뷰 앱을 사용하는 방법 좀 알려줄래?</Typography>
            <Typography>B: 물론이지. 네 현재 위치를 입력하고 평점이 높은 순서대로 식당을 정렬해 봐.</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
