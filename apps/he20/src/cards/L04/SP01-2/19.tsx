...
const P19 = () => {
  ...
  const audioInfo: IAudioPlayerProps = {
    audioSrc: '/L04/SP01-2/HE2-L04-SP01-2-P19.mp3',
  };
    ...
    >
      <Box marginBottom='20px' useRound background='white' padding='10px'>
        <Box useFull display='flex' flexDirection='column' gap={'10px'}>
          <Box display='flex'>
            ...
            <Typography>Others are concerned about meat consumption</Typography>
      ...
      <BottomSheet bottomSheetTargetId='container' height='40%' show={isAnswerShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>because of the greenhouse gases produced by cows</Typography>
          </Box>
          ...
          <Box marginTop='22px' display='flex' flexDirection='column'>
            <Typography>여: 소가 배출하는 온실가스 때문에 육류 소비에 대해 우려하는 사람들도 있습니다.</Typography>
