...
const P03 = () => {
  ...
  const list: IData[] = [
    {
      contents: 'The speaker is talking about the history of food technology.',
      answer: cardData.p03.answer1,
      solution: cardData.p03.solution1,
    },
    {
      contents: 'People will be able to grow crops in AI-controlled buildings.',
      answer: cardData.p03.answer2,
      solution: cardData.p03.solution2,
    },
    {
      contents: 'Future food will be both delicious and environmentally friendly.',
        ...
        <List data={list}>
          {({ value, index = 1 }) => (
            <BoxWrap justifyContent='space-between' useFull>
              <Box vAlign='start'>
                <Typography width={'48px'}>{`(${index})`}</Typography>
