...
const P15 = ({ _page = 'P15' }: { _page?: string }) => {
  ...
  const contents: ITranslation[] = [
    {
      en: 'Similarly, those who have lost their arms can use',
      ko: '마찬가지로 , 팔을 잃은 사람들도 동일한 방법으로 작동되는 의수를 사용할 수 있습니다 .',
    },
  ];
  const [chipButtonInfo, setChipButtonInfo] = useState<IChipButtonInfo[]>([
    ...
    {
      text: 'artificial arms',
      isError: false,
    },
  ]);

  const answer = 'artificial arms operated by the same mechanism';
