      ...
      >
        <Box useFull flexDirection='column' hAlign='center' gap='48px'>
          <Box vAlign='center' width='775px' height='156px' hAlign={'center'} background='white' useRound useShadow>
            <Box display='flex' hAlign='center'>
              <Typography>
              The technology has made it possible <Typography type='blank' width='100px' title='빈칸' boxColor='var(--color-black)'></Typography> instantly with people worldwide.
              </Typography>
            </Box>
          </Box>
          <BoxWrap>
        ...
        <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isShow}>
          <Box background='lightGray' borderRadius='12px' marginTop='0px'>
            ...
            <Box marginTop='10px'>
              <Typography useGap={false}>to communicate</Typography>
            </Box>
            <Box marginTop='30px'>
              <Box>
              ...
              <Box marginTop='10px'>
                <Typography useGap={false}>기술은 전 세계의 사람들과 즉각적으로 의사소통하는 것을 가능하게 만들었다.</Typography>
              </Box>
            </Box>
          </Box>
        </BottomSheet>
