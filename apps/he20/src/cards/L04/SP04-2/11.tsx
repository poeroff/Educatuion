...
const P11 = () => {
  ...
  const contents: ITranslation[] = [
    {
      en: 'My daughter finds ',
      ko: '우리 딸은 사람들 앞에서 춤추는 것을 흥미롭다고 생각한다.',
    },
  ];
  ...
  const answer = 'it interesting to dance in front of people';
  ...
  const chipButtonOnClick = (index: number) => {
    ...
    if (clickedChipButtons.includes(index)) {
      ...
      changeData(pageName, 1, 1, [...cardData.p11.answer, index]);
    }
  };
