        ...
        <Box useFull flexDirection='column' hAlign='center' gap='48px'>
          <Box vAlign='center' width='775px' height='156px' hAlign={'center'} background='white' useRound useShadow>
            <Box display='flex' hAlign='center'>
              <Typography>
              He said he didn’t agree with the idea <Typography type='blank' width='100px' title='빈칸' boxColor='var(--color-black)'></Typography> only the strongest can survive in our society.
              </Typography>
            </Box>
          </Box>
          <BoxWrap>
        ...
        <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isShow}>
          <Box background='lightGray' borderRadius='12px' marginTop='0px'>
            ...
            <Box marginTop='30px'>
              ...
              <Box marginTop='10px'>
                <Typography useGap={false}>그는 가장 강한 자가 우리 사회에서 살아남을 수 있다는 생각에 동의하지 않는다고 말했다.
                </Typography>
              </Box>
            </Box>
          </Box>
