...
import { titleA02a, semiTitleA02a, dialogContentA02a, imgContentA02aP01 } from './commonData';
    ...
    <Container headerInfo={headerInfo} questionInfo={questionInfo}>
      ...
      <BoxWrap useFull>
        <Box useFull>
          <ImgBox>
            <PinchZoom>
              <Image height='100%' width='380px' ariaDescribedby='imgDesc' alt='' src={imgSrc} />
      ...
      <ShowText title={titleA02a} semiTitle={semiTitleA02a} content={dialogContentA02a} isTextOpen={isTextOpen} handleTextClose={handleTextClose} />
    </Container>
  );
};
