...
export const imgContentA02P01 = {
  imgSrc: `/L04/C07/A02/HE2-L04-C07-A02-P01.jpg`,
  imgAlt: (
    <>
      <p>글의 구조가 보이는 인포그래픽 </p>
      <p>구역 1 AI-Powered Neural Implants에 관한 내용 중심으로 여러 방향으로 뻗어있는 화살표 </p>
      <p>구역 2 Current Medical Applications에 관한 내용 </p>
      <p>구역 3 Future Commercial Applications에 관한 내용 </p>
      <p>구역 4 Ethical Concerns에 관한 내용</p>
      <p>구역 5 Solutions에 관한 내용</p>
    </>
  ),
};
export const imgContentA02P02 = {
  imgSrc: `/L04/C07/A02/HE2-L04-C07-A02-P02.jpg`,
  imgAlt: (
    <>
      <p>1 AI-Powered Neural Implants에 관한 인포그래픽</p>
      <p>medical devices which can be implanted in the 빈칸 system</p>
      <p>인공지능을 가진 사람 얼굴 형태</p>
    </>
  ),
};
export const imgContentA02P03 = {
  imgSrc: `/L04/C07/A02/HE2-L04-C07-A02-P03.jpg`,
  imgAlt: (
    <>
      <p>2 Current Medical Applications 에 관한 인포그래픽</p>
      <p>treat brain 빈칸</p>
      <p>help 빈칸 people walk again</p>
      <p>enable people who have lost arms to use artificial arms</p>
      <p>한쪽 팔이 로봇 팔인 여자</p>
    </>
  ),
};
export const imgContentA02P04 = {
  imgSrc: `/L04/C07/A02/HE2-L04-C07-A02-P04.jpg`,
  imgAlt: (
    <>
      <p>3 Future Commercial Applications 에 관한 인포그래픽</p>
      <p>read human 빈칸</p>
      <p>enhance 빈칸</p>
      <p>revolutionize the way our brains work</p>
      <p>사람 머리 위 지구본과 돋보기</p>
    </>
  ),
};
export const imgContentA02P05 = {
  imgSrc: `/L04/C07/A02/HE2-L04-C07-A02-P05.jpg`,
  imgAlt: (
    <>
      <p>4 Ethical Concerns에 관한 인포그래픽</p>
      <p>빈칸 confusion : questioning our own humanity</p>
      <p>privacy worries: risks of illegal access and controlling our thoughts and emotions</p>
      <p>social 빈칸 : intensifying the social division due to the high cost</p>
      <p>의자에 앉아 노트북을 보고 있는 사람</p>
    </>
  ),
};
