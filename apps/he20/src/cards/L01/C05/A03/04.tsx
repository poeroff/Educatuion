    ...
    >
      <BoxWrap height={'340px'} paddingLeft={'16px'} paddingRight={'16px'}>
        <Box useFull width='40%' vAlign='center' hAlign='center'>
          <PinchZoom>
            <Image src={'/L01/C05/A03/HE2-L01-C05-A03-04.jpg'} width='100%' height='100%' alt='엄마 여우가 아기 여우의 이마에 턱을 부비고 있다.  ' />
          </PinchZoom>
        </Box>
        <Box useFull width='60%'>
          <Typography>
            ...
            to protect their babies is important for survival in the animal world.
          </Typography>
          <Box marginTop='10px'>
            <Textarea
              height='200px'
