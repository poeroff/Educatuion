    ...
    >
      <BoxWrap height={'340px'} paddingLeft={'16px'} paddingRight={'16px'}>
        <Box useFull width='40%' vAlign='center' hAlign='center'>
          <PinchZoom>
            <Image
              src={'/L01/C05/A03/HE2-L01-C05-A03-02.jpg'}
              width='100%'
              height='100%'
              alt='보호복을 입은 두 사람이 폐기물 표시가 되어있는 분홍색 봉투를 장갑 낀 손으로 들고 있다. '
            />
          </PinchZoom>
        </Box>
        <Box useFull width='60%'>
          <Typography>
            Medical waste must be handled properly because it can be a chemical
