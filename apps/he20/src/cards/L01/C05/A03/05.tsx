    ...
    >
      <BoxWrap height={'340px'} paddingLeft={'16px'} paddingRight={'16px'}>
        <Box useFull width='40%' vAlign='center' hAlign='center'>
          <PinchZoom>
            <Image src={'/L01/C05/A03/HE2-L01-C05-A03-05.jpg'} width='100%' height='100%' alt='수의사가 아기 고양이를 살펴보고 있다. ' />
          </PinchZoom>
        </Box>
        <Box useFull width='60%'>
          <Typography>
            We should refer to accurate information about an animal’s health from a qualified{' '}
