...
export const imgContentA02P01 = {
  imgSrc: `/L01/C07/A02/HE2-L01-C07-A02b-P01.jpg`,
  imgAlt: `글의 구조가 보이는 인포그래픽 첫 번째 칸 Introduction에 관한 내용 아래로 이어지는 화살표 두 번째 칸 July 29, Monday에 관한 내용 아래로 이어지는 화살표 세 번째 칸 July 30, Tuesday에 관한 내용 아래로 이어지는 화살표 네 번째 칸 July July 31, Wednesday에 관한 내용 아래로 이어지는 화살표 다섯 번 째 번째 August 1, Thursday에 관한 내용 아래로 이어지는 화살표 마지막 칸 Closing에 관한 내용`,
};

export const imgContentA02P02 = {
  imgSrc: `/L01/C07/A02/HE2-L01-C07-A02b-P02.jpg`,
  imgAlt: `July 29, Monday 에 관한 인포그래픽 A tour of the facility in the sanctuary Today’s Tasks: cleaning the habitats, preparing 1 빈칸`,
};

export const imgContentA02P03 = {
  imgSrc: `/L01/C07/A02/HE2-L01-C07-A02b-P03.jpg`,
  imgAlt: `July 30, Monday 에 관한 인포그래픽 Ben and Lily: two rescued baby bears Making Honey-Log Feeders: behavioral enrichment to help the bears restore their natural 2 빈칸`,
};

export const imgContentA02P04 = {
  imgSrc: `/L01/C07/A02/HE2-L01-C07-A02b-P04.jpg`,
  imgAlt: `July 31, Wednesday 에 관한 인포그래픽 Molly: an elderly elephant Helping with Molly’s Foot Care: positive reinforcement training using 3 빈칸 to encourage desirable behaviors`,
};

export const imgContentA02P05 = {
  imgSrc: `/L01/C07/A02/HE2-L01-C07-A02b-P05.jpg`,
  imgAlt: `August 1, Thursday에 관한 인포그래픽 Emergency: the fall of dehydrated birds Support: providing them with water while the vets treated them Reflection: the impact of human activities on climate change and its 4 빈칸 to animals`,
};

export const imgContentA02P06 = {
  imgSrc: `/L01/C07/A02/HE2-L01-C07-A02b-P06.jpg`,
  imgAlt: `Closing에 관한 인포그래픽 Lesson from Volunteering: the importance of treating animals with 5 빈칸 and care`,
};
