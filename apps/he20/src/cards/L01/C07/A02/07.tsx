...
import { imgContentA02P07, textContentA02 } from './commonData';
...
const P07 = () => {
  ...
  const PAGE_NAME = 'P07';
  const pageKey = PAGE_NAME.toLowerCase() as 'p07';
      ...
      <Scroll>
        ...
        <Box marginTop={'20px'}>
          <Typography useGap={false} weight={'normal'} size={EStyleFontSizes.MEDIUM}>
            • Lesson from Volunteering: the importance of treating animals with
          </Typography>
        </Box>
        ...
        <Box hAlign='flex' display='inline-flex'>
          <Typography>
            ...
            <Input
              width='150px'
              ariaLabel='8번 답 입력란 첫 번째 r로 시작하는 단어'
