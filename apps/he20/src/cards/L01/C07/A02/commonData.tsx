...
export const imgContentA02P01 = {
  imgSrc: `/L01/C07/A02/HE2-L01-C07-A02-P01.jpg`,
  imgAlt: (
    <>
      <h1>글의 구조가 보이는 인포그래픽</h1>
      <h2>첫 번째 칸 Introduction에 관한 내용</h2>
      <p>아래로 이어지는 화살표</p>
      <h2>두 번째 칸 July 29, Monday에 관한 내용</h2>
      <p>아래로 이어지는 화살표</p>
      <h2>세 번째 칸 July 30, Tuesday에 관한 내용</h2>
      <p>아래로 이어지는 화살표</p>
      <h2>네 번째 칸 July 31, Wednesday에 관한 내용</h2>
      <p>아래로 이어지는 화살표</p>
      <h2>다섯 번째 칸 August 1, Thursday에 관한 내용</h2>
      <p>아래로 이어지는 화살표</p>
      <h2>마지막 칸 Closing에 관한 내용</h2>
    </>
  ),
};

export const imgContentA02P02 = {
  imgSrc: `/L01/C07/A02/HE2-L01-C07-A02-P02.jpg`,
  imgAlt: `Introduction에 관한 인포그래픽 Reason for Volunteering: to learn about 1 빈칸 Volunteering Location: Free Animals sanctuary`,
};

export const imgContentA02P03 = {
  imgSrc: `/L01/C07/A02/HE2-L01-C07-A02-P03.jpg`,
  imgAlt: (
    <>
      <p>July 29, Monday 에 관한 인포그래픽</p>
      <p>A tour of the 2 빈칸 in the sanctuary</p>
      <p>Today’s Tasks: cleaning the habitats, preparing 3 빈칸</p>
    </>
  ),
};

export const imgContentA02P04 = {
  imgSrc: `/L01/C07/A02/HE2-L01-C07-A02-P04.jpg`,
  imgAlt: (
    <>
      <p>July 30, Monday 에 관한 인포그래픽</p>
      <p>Ben and Lily: two rescued baby bears</p>
      <p>Making Honey-Log Feeders: behavioral enrichment to help the bears restore their 4 빈칸</p>
    </>
  ),
};

export const imgContentA02P05 = {
  imgSrc: `/L01/C07/A02/HE2-L01-C07-A02-P05.jpg`,
  imgAlt: (
    <>
      <p>July 31, Wednesday 에 관한 인포그래픽</p>
      <p>Molly: an elderly elephant Helping with Molly’s Foot Care: positive reinforcement training using 5 빈칸 to encourage desirable behaviors</p>
    </>
  ),
};

export const imgContentA02P06 = {
  imgSrc: `/L01/C07/A02/HE2-L01-C07-A02-P06.jpg`,
  imgAlt: (
    <>
      <p>August 1, Thursday에 관한 인포그래픽</p>
      <p>Emergency: the fall of dehydrated birds</p>
      <p>Support: providing them with 6 빈칸 while the vets treated them</p>
      <p>Reflection: the impact of human activities on climate change and its 7 빈칸 to animals</p>
    </>
  ),
};

export const imgContentA02P07 = {
  imgSrc: `/L01/C07/A02/HE2-L01-C07-A02-P07.jpg`,
  imgAlt: `Closing에 관한 인포그래픽 Lesson from Volunteering: the importance of treating animals with 8 빈칸 and care`,
};
