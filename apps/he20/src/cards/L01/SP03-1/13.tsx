...
const P13 = ({ _page = 'P13' }: { _page?: string }) => {
  ...
  const contents: ITranslation[] = [
    {
      en: 'It was amazing to ',
      ko: '넓은 벌판에서 곰과 코끼리가 자유롭게 다니는 것을 보는 것은 놀라웠다.',
    },
  ];
  ...
  const answer = 'see bears and elephants moving freely in a large field';
  ...
  const chipButtonOnClick = (index: number) => {
    ...
    if (clickedChipButtons.includes(index)) {
      ...
      changeData(pageName, 1, 1, [...cardData.p13.answer, index]);
    }
  };
