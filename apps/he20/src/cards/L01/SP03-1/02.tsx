...
const P02 = () => {
  ...
  const wordList = useMemo(
    () => [
      { id: 1, word: 'facility', meaning: '시설', meaningOrder: 6 },
      { id: 2, word: 'restore', meaning: '회복하다', meaningOrder: 4 },
      { id: 3, word: 'habitat', meaning: '서식지', meaningOrder: 3 },
      { id: 4, word: 'instinct', meaning: '본능', meaningOrder: 7 },
      { id: 5, word: 'hazard', meaning: '위험', meaningOrder: 2 },
      { id: 6, word: 'carry out', meaning: '실행하다', meaningOrder: 1 },
      { id: 7, word: 'sugarcane', meaning: '사탕수수', meaningOrder: 9 },
      { id: 8, word: 'dehydrated', meaning: '탈수된', meaningOrder: 8 },
      { id: 9, word: 'rewarding', meaning: '보람 있는', meaningOrder: 10 },
      { id: 10, word: 'veterinarian', meaning: '수의사', meaningOrder: 5 },
    ],
    [],
  );
