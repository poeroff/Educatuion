    ...
    >
      <Box useFull flexDirection='column' hAlign='center' gap='48px'>
        <Box vAlign='center' width='775px' height='156px' hAlign={'center'} background='white' useRound useShadow>
          <Box display='flex' hAlign='center'>
            <Typography>
              Ferdi had never seen snow before he <Typography type='blank' width='100px' title='빈칸' boxColor='var(--color-black)'></Typography> to
              Korea from Indonesia.
            </Typography>
          </Box>
        </Box>
        <BoxWrap>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='0px'>
          ...
          <Box marginTop='10px'>
            <Typography useGap={false}>moved</Typography>
          </Box>
          <Box marginTop='30px'>
            <Box>
            ...
            <Box marginTop='10px'>
              <Typography useGap={false}>Ferdi는 인도네시아에서 한국으로 오기 전에는 눈을 한 번도 본 적이 없다.</Typography>
            </Box>
          </Box>
        </Box>
      </BottomSheet>
