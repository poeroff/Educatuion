    ...
    >
      <Box useFull flexDirection='column' hAlign='center' gap='48px'>
        <Box vAlign='center' width='775px' height='156px' hAlign={'center'} background='white' useRound useShadow>
          <Box display='flex' hAlign='center'>
            <Typography>
              The school bus had already left when Lisa{' '}
              <Typography type='blank' width='100px' title='빈칸' boxColor='var(--color-black)'></Typography> to the bus stop.
            </Typography>
          </Box>
        </Box>
        <BoxWrap>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='0px'>
          ...
          <Box marginTop='10px'>
            <Typography useGap={false}>got</Typography>
          </Box>
          <Box marginTop='30px'>
            <Box>
            ...
            <Box marginTop='10px'>
              <Typography useGap={false}>Lisa가 버스 정류장에 도착했을 때 학교 버스는 이미 떠났었다.</Typography>
            </Box>
          </Box>
        </Box>
      </BottomSheet>
