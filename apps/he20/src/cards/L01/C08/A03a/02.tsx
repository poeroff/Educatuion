...
const page = 'P02';
const answer = 'allow the audience to take';
...
const P02 = () => {
  ...
  const nodeData: { children: React.ReactNode }[] = [
    {
      children: <Typography>2. 극장은 공연 중 관객의 사진 촬영을 허용하지 않는다.</Typography>,
    },
    {
      children: (
        <Box marginTop='10px'>
          <SvgIcon src={arrow} size='38px' />
          <Typography>The theater does not </Typography>
          <Input
            ariaLabel='답란'
            value={userAnswer}
          ...
          />
          <Typography>photos during the performance.</Typography>
        </Box>
      ),
    },
    {
