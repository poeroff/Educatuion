    ...
    >
      <Box hAlign='start'>
        ...
        <Box backgroundColor='var(--color-blue-100)' border='none' useRound hAlign='center' padding='12px' margin='0 8px'>
          <Typography>People should raise a pet with responsibility!</Typography>
        </Box>
      </Box>
      <Box marginTop='20px'>
        <Box hAlign='end'>
          ...
          <TextView title='보기' hAlign='start'>
            <Box>
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                It’s important to remember that animals need love and care.
              </Typography>
            </Box>
            <Box>
              <Typography align='left' size={EStyleFontSizes['X-MEDIUM']}>
                I guess raising a pet is quite easy.
              </Typography>
            </Box>
          </TextView>
        </Box>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={isAnswerShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='30px'>
          ...
          <Box marginTop='10px'>
            <Typography>It’s important to remember that animals need love and care.</Typography>
          </Box>
          ...
          <Box marginTop='10px' display='flex' flexDirection='column'>
            <Typography>A: 사람들은 책임감을 가지고 애완동물을 키워야 해!</Typography>
            <Typography>B: 동의해. 동물들은 사랑과 보살핌을 필요로 한다는 걸 기억하는 것은 중요해.</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
