...
const P02 = () => {
  ...
  const list: IData[] = [
    {
      contents: '(1) The speakers are planning to donate the books that they have read.',
      answer: cardData[pageKey].answer1,
      solution: cardData[pageKey].solution1,
    },
    {
      contents: '(2) The girl is going to translate Korean folk tales into some different languages.',
      answer: cardData[pageKey].answer2,
      solution: cardData[pageKey].solution2,
    },
    {
      contents: '(3) The charity will provide books for children in other countries.',
