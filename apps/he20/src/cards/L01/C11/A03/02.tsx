...
const P02 = () => {
  ...
  const data: IListenAndAnswer[] = [
    {
      type: 'A',
      content: <span>Did you watch the documentary about animal abuse yesterday?</span>,
      audioSrc: '/L01/C11/A03/HE2-L01-C11-A03-P02-01.mp3',
    },
    {
      type: 'B',
      content: (
        <>
          Yes, I did. <BoldSpan>I felt terrible watching humans mistreat animals.</BoldSpan>
        </>
      ),
      audioSrc: '/L01/C11/A03/HE2-L01-C11-A03-P02-02.mp3',
    },
    {
      type: 'A',
      content: (
        <>
          Me, too. <BoldSpan> I was also shocked to see how many pets are thrown away just like trash every day.</BoldSpan>
        </>
      ),
      audioSrc: '/L01/C11/A03/HE2-L01-C11-A03-P02-03.mp3',
    },
    {
      type: 'B',
      content: <span> I feel the same. People need to learn that owning a pet comes with great responsibility!</span>,
      audioSrc: '/L01/C11/A03/HE2-L01-C11-A03-P02-04.mp3',
    },
    {
      type: 'A',
      content: (
        <>
          I couldn’t agree more. <BoldSpan> It’s important to understand that animals need love and care. </BoldSpan>
        </>
      ),
      audioSrc: '/L01/C11/A03/HE2-L01-C11-A03-P02-05.mp3',
    },
    {
      type: 'B',
      content: <span>You’re right. The documentary really helped me raise awareness about animal rights.</span>,
      audioSrc: '/L01/C11/A03/HE2-L01-C11-A03-P02-06.mp3',
    },
  ];
