...
const router: IRouteObject[] = [
  {
    ...
    children: [
      ...
      {
        path: `L01-C06-A03a`,
        element: lazyLoad(() => import('../../../cards/L01/C06/A03a')),
        params: {
          ...layouts[ELayout.INTRO],
          subChapter: 'Read',
        },
      ...
      {
        path: `L01-C06-A03b`,
        element: lazyLoad(() => import('../../../cards/L01/C06/A03b')),
        params: {
          ...layouts[ELayout.INTRO],
          subChapter: 'Read',
        },
      ...
      {
        path: `L01-C06-A04a`,
        element: lazyLoad(() => import('../../../cards/L01/C06/A04a')),
        params: {
          ...layouts[ELayout.INTRO],
          subChapter: 'Read',
        },
      ...
      {
        path: `L01-C06-A04b`,
        element: lazyLoad(() => import('../../../cards/L01/C06/A04b')),
        params: {
          ...layouts[ELayout.INTRO],
          subChapter: 'Read',
        },
      ...
      {
        path: `L01-C06-A07`,
        element: lazyLoad(() => import('../../../cards/L01/C06/A07')),
        params: {
          ...layouts[ELayout.INTRO],
          subChapter: 'Read',
        },
      ...
      {
        path: `L01-C06-A07a`,
        element: lazyLoad(() => import('../../../cards/L01/C06/A07a')),
        params: {
          ...layouts[ELayout.INTRO],
          subChapter: 'Read',
        },
      ...
      {
        path: `L01-C06-A07b`,
        element: lazyLoad(() => import('../../../cards/L01/C06/A07b')),
        params: {
          ...layouts[ELayout.INTRO],
          subChapter: 'Read',
        },
      ...
      {
        path: `L01-C06-A08`,
        element: lazyLoad(() => import('../../../cards/L01/C06/A08')),
        params: {
          ...layouts[ELayout.INTRO],
          subChapter: 'Read',
        },
