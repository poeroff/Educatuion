...
const P02 = () => {
  ...
  const checkAnswerCorrect = useCallback(() => {
    const correct1 = cardData.p02.answer1.value === ANSWER[0];
    const correct2 = cardData.p02.answer2.value === ANSWER[1];
    const correct3 = cardData.p02.answer3.value === ANSWER[2];
    setCardData(prev => ({
      ...prev,
      p02: {
        ...prev.p02,
        ...
        inputData: [
          {
            ...
            isCorrect: cardData.p02.answer1.value === ANSWER[0],
          },
          {
            subKey: 2,
            type: 'TEXT',
            value: cardData.p02.answer2,
            isCorrect: cardData.p02.answer2.value === ANSWER[1],
          },
          {
            subKey: 3,
            type: 'TEXT',
            value: cardData.p02.answer3,
            isCorrect: cardData.p02.answer3.value === ANSWER[2],
          },
        ],
        isCorrect: correct,
      },
