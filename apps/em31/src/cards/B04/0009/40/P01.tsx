...
const P01 = () => {
  ...
  const answerInputChange = (value: string, num: number) => {
    if (value.length > 0) {
      ...
      setCardData(prev => ({ ...prev, p01: { ...prev.p01, [`answer${num}`]: { value: value[value.length - 1] } } }));
  ...
  const isBtnDisabled = () => {
    ...
    const answer2 = cardData.p01.answer1.value;
  ...
  const checkAnswerCorrect = useCallback(() => {
    const correct1 = cardData.p01.answer1.value === ANSWER[0];
    const correct2 = cardData.p01.answer2.value === ANSWER[1];
    setCardData(prev => ({
      ...prev,
      p01: {
        ...prev.p01,
        ...
        inputData: [
          {
            ...
            isCorrect: cardData.p01.answer1.value === ANSWER[0],
          },
          {
            subKey: 2,
            type: 'TEXT',
            value: cardData.p01.answer2,
            isCorrect: cardData.p01.answer2.value === ANSWER[1],
          },
        ],
        isCorrect: correct,
      },
