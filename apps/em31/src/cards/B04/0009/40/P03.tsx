...
const P03 = () => {
  ...
  const answerInputChange = (value: string, num: number) => {
    if (value.length > 0) {
      ...
      setCardData(prev => ({ ...prev, p03: { ...prev.p03, [`answer${num}`]: { value: value[value.length - 1] } } }));
  ...
  const checkAnswerCorrect = useCallback(() => {
    const correct1 = cardData.p03.answer1.value === ANSWER[0];
    const correct2 = cardData.p03.answer2.value === ANSWER[1];
    setCardData(prev => ({
      ...prev,
      p03: {
        ...prev.p03,
        ...
        inputData: [
          {
            ...
            isCorrect: cardData.p03.answer1.value === ANSWER[0],
          },
          {
            subKey: 2,
            type: 'TEXT',
            value: cardData.p03.answer2,
            isCorrect: cardData.p03.answer2.value === ANSWER[1],
          },
        ],
        isCorrect: correct,
      },
