        ...
        <Box type='dashed' hAlign='center' useRound width='636px' height='172px'>
          <BoxWrap display='flex' justifyContent='center' boxGap={0} marginTop='65px'>
            ...
            <Box width='80px' hAlign='center'>
              <GrayRoundBox>x 3</GrayRoundBox>
            </Box>
            <Box>
              <Input
                width='130px'
                ariaLabel='29에 3를 곱한 값'
                value={cardData.p06.answer}
                onChange={event => handleChange(event.target.value)}
                readOnly={cardData.p06.isSubmitted}
                status={
                  cardData.p06.isSubmitted && cardData.p06.answer.trim() !== cardData.p06.solution
                    ? InputStatus.ERROR
                    : cardData.p06.answer
                    ? InputStatus.ENABLE
                    : InputStatus.DEFAULT
            ...
            <BoxWrap>
              <Box hAlign='start' marginTop='22px' useRound useFull>
                <Table color={EStyleTableTypes.MATH} sizes={['33%', '33%', '33%']}>
                  <TableMathCaption caption='세로셈' math={['29', 'x', '3']} />
                  <THead hidden>
                    <TR>
