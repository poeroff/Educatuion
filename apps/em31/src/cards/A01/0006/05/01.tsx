...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(A01_0006_05);
  ...
  const math: IMath = {
    ...
    input: content,
    superScript: [
      { value: isDisplaySuperscript3 ? '2' : '', left: '455px' },
      { value: isDisplaySuperscript2 ? '10' : '', left: '508px' },
      { value: '', left: '558px' },
    ],
    incorrectMark: [
      [false, false, isDisplaySuperscript3, false],
  ...
  const answer: IAnswer = {
    ...
    description: [
      '- 일의 자리끼리 빼면 $7-2=5$이므로 일의 자리에 5를 씁니다.',
      '- 십의 자리 수 1에서 7을 뺄 수 없으므로 백의 자리에서 받아내림하여 계산합니다. 백의 자리 수 3을 지우고 2를 표시한 다음 십의 자리 위에 10을 쓰고, $10+1=11$에서 7을 빼면 $11-7=4$이므로 십의 자리에 4를 씁니다.',
