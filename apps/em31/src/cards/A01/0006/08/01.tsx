...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(A01_0006_08);
  ...
  const questionInfo: IQuestionProps = {
    ...
    text: (
      <>
        ...
        <Box fontWeight='var(--font-weight-medium)'>이번 시간에 공부한 내용을 문제를 풀며 확인해 보세요.</Box>
      </>
    ),
      ...
      <BoxWrap height={'304px'}>
        <Box type='dashed' hAlign='center' flexDirection='column' useRound useFull>
          <Table color={EStyleTableTypes.MATH} sizes={['25%', '25%', '25%', '25%']}>
            <TableMathCaption caption='세로셈' math={['691', '-', '135']} />
            <THead hidden>
              <TR>
        ...
        <Box type='dashed' hAlign='center' flexDirection='column' useRound useFull>
          <Table color={EStyleTableTypes.MATH} sizes={['25%', '25%', '25%', '25%']}>
            <TableMathCaption caption='세로셈' math={['356', '-', '193']} />
            <THead hidden>
              <TR>
                <TH scope='col'>일의 자리</TH>
                <TH scope='col'>십의 자리</TH>
        ...
        <Box background='lightGray' borderRadius='12px' marginTop='48px' padding='28px'>
          ...
          <Box position='relative' marginTop='40px'>
            ...
            <BoxWrap marginTop='40px'>
              <Box flexDirection='column' useRound useFull>
                <Table color={EStyleTableTypes.MATH} sizes={['25%', '25%', '25%', '25%']}>
                  <TableMathCaption caption='세로셈' math={['850', '-', '238']} />
                  <THead hidden>
                    <TR>
                      <TH scope='col'>일의 자리</TH>
                      <TH scope='col'>십의 자리</TH>
              ...
              <Box flexDirection='column' useRound useFull>
                <Table color={EStyleTableTypes.MATH} sizes={['25%', '25%', '25%', '25%']}>
                  <TableMathCaption caption='세로셈' math={['527', '-', '336']} />
                  <THead hidden>
                    <TR>
                      <TH scope='col'>일의 자리</TH>
                      <TH scope='col'>십의 자리</TH>
