...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(A01_0004_08);
      ...
      <BoxWrap height={'304px'}>
        <Box type='dashed' hAlign='center' flexDirection='column' useRound useFull>
          <Table color={EStyleTableTypes.MATH} sizes={['25%', '25%', '25%', '25%']}>
            <TableMathCaption caption='세로셈' math={['285', '+', '279']} />
            <THead hidden>
              <TR>
        ...
        <Box type='dashed' hAlign='center' flexDirection='column' useRound useFull>
          <Table color={EStyleTableTypes.MATH} sizes={['25%', '20%', '20%', '20%', '20%']}>
            <TableMathCaption caption='세로셈' math={['758', '+', '566']} />
            <THead hidden>
              <TR>
                <TH scope='col'>일의 자리</TH>
                <TH scope='col'>십의 자리</TH>
            ...
            <TFoot>
              <TR>
                <TD>
                  <Input
                    value={getValue(cardData.p01.answer2[3])}
                    onChange={e => setAnswer(e, 2, 3)}
                    status={getStatus(cardData.p01.answer2[3], cardData.p01.solution2[3])}
                    ariaLabel='일의자리, 답'
                    maxLength={1}
                    readOnly={cardData.p01.isSubmitted}
                    tabIndex={105}
        ...
        <Box background='lightGray' borderRadius='12px' marginTop='48px' padding='28px'>
          <Box>
            ...
            <Box display={'flex'} flexDirection={'column'} marginTop='12px' gap={'20px'}>
              <Typography>5, 6, 4</Typography>
              <Typography>1, 3, 2, 4</Typography>
              <Typography>723, 900</Typography>
            </Box>
          </Box>
          <Box position='relative' marginTop='40px'>
            ...
            <BoxWrap marginTop='66px'>
              <Box hAlign='center' flexDirection='column' useRound useFull>
                <Table color={EStyleTableTypes.MATH} sizes={['25%', '25%', '25%', '25%']}>
                  <TableMathCaption caption='세로셈' math={['236', '+', '487']} />
                  <THead hidden>
                    <TR>
                      <TH scope='col'>일의 자리</TH>
                      <TH scope='col'>십의 자리</TH>
              ...
              <Box hAlign='center' flexDirection='column' useRound useFull>
                <Table color={EStyleTableTypes.MATH} sizes={['25%', '25%', '25%', '25%']}>
                  <TableMathCaption caption='세로셈' math={['351', '+', '549']} />
                  <THead hidden>
                    <TR>
                      <TH scope='col'>일의 자리</TH>
                      <TH scope='col'>십의 자리</TH>
              ...
              <Box position='absolute' top='60px' left='165px'>
              ...
              <Box position='absolute' top='285px' left='158px'>
                <Typography size={EStyleFontSizes['X-MEDIUM']} color='var(--color-pink-500)'>
                  1
                </Typography>
              </Box>
              ...
              <Box position='absolute' top='60px' left='630px'>
                <Typography size={EStyleFontSizes['X-MEDIUM']} color='var(--color-pink-500)'>
                  1
                </Typography>
              </Box>
              <Box position='absolute' top='60px' left='681px'>
                <Typography size={EStyleFontSizes['X-MEDIUM']} color='var(--color-pink-500)'>
                  1
                </Typography>
              </Box>
              ...
              <Box position='absolute' top='285px' left='638px'>
                <Typography size={EStyleFontSizes['X-MEDIUM']} color='var(--color-pink-500)'>
                  1
                </Typography>
              </Box>
