        ...
        <Box type='dashed' hAlign='center' flexDirection='column' useRound useFull>
              ...
              <TR>
                  ...
                  <Input
                    ...
                    status={
                      !cardData.p03.isSubmitted
                        ? cardData.p03.answer1.value.trim() === ""
                          ? InputStatus.DEFAULT
                          : InputStatus.ENABLE
                        : cardData.p03.answer1.value.trim() === ""
                        ? InputStatus.ENABLE
                ...
                <TD>
                  <Input
                    ...
                    status={
                      !cardData.p03.isSubmitted
                        ? cardData.p03.answer2.value.trim() === ""
                          ? InputStatus.DEFAULT
                          : InputStatus.ENABLE
                        : cardData.p03.answer2.value.trim() === ""
                        ? InputStatus.ENABLE
                ...
                <TD>
                  <Input
                    ...
                    status={
                      !cardData.p03.isSubmitted
                        ? cardData.p03.answer3.value.trim() === ""
                          ? InputStatus.DEFAULT
                          : InputStatus.ENABLE
                        : cardData.p03.answer3.value.trim() === ""
                        ? InputStatus.ENABLE
          ...
          <Box marginTop='24px'>
            ...
            <Input
              ...
              status={
                !cardData.p03.isSubmitted
                  ? cardData.p03.answer4.value.trim() === ""
                    ? InputStatus.DEFAULT
                    : InputStatus.ENABLE
                  : cardData.p03.answer4.value.trim() === ""
                  ? InputStatus.ENABLE
        ...
        <Box type='dashed' hAlign='center' flexDirection='column' useRound useFull>
              ...
              <TR>
                <TD>
                  <Input
                    ...
                    status={
                      !cardData.p03.isSubmitted
                        ? cardData.p03.answer5.value.trim() === ""
                          ? InputStatus.DEFAULT
                          : InputStatus.ENABLE
                        : cardData.p03.answer5.value.trim() === ""
                        ? InputStatus.ENABLE
                ...
                <TD>
                  <Input
                    ...
                    status={
                      !cardData.p03.isSubmitted
                        ? cardData.p03.answer6.value.trim() === ""
                          ? InputStatus.DEFAULT
                          : InputStatus.ENABLE
                        : cardData.p03.answer6.value.trim() === ""
                        ? InputStatus.ENABLE
                ...
                <TD>
                  <Input
                    ...
                    status={
                      !cardData.p03.isSubmitted
                        ? cardData.p03.answer7.value.trim() === ""
                          ? InputStatus.DEFAULT
                          : InputStatus.ENABLE
                        : cardData.p03.answer7.value.trim() === ""
                        ? InputStatus.ENABLE
          ...
          <Box marginTop='24px'>
            ...
            <Input
              ...
              status={
                !cardData.p03.isSubmitted
                  ? cardData.p03.answer8.value.trim() === ""
                    ? InputStatus.DEFAULT
                    : InputStatus.ENABLE
                  : cardData.p03.answer8.value.trim() === ""
                  ? InputStatus.ENABLE
                  : cardData.p03.isSubmitted && !cardData.p03.answer8.isCorrect
                  ? InputStatus.ERROR
                  : InputStatus.ENABLE
              }
