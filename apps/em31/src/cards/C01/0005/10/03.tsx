    ...
    if (subKey === 1) {
      setCardData(prev => ({
        ...
        p03: {
          ...prev.p03,
          answer1: value,
          isCorrect1: isExperessionCorrect(value, cardData.p03.solution1),
        },
      }));
    } else if (subKey === 2) {
      setCardData(prev => ({
        ...
        p03: {
          ...prev.p03,
          answer2: value,
          isCorrect2: isExperessionCorrect(value, cardData.p03.solution2),
        },
      }));
    }
          ...
          <Input
            status={
              !cardData.p03.answer1
                ? InputStatus.DEFAULT
                : cardData.p03.isSubmitted && !cardData.p03.isCorrect1
                ? InputStatus.ERROR
                : InputStatus.ENABLE
            }
          ...
          <Input
            status={
              !cardData.p03.answer2
                ? InputStatus.DEFAULT
                : cardData.p03.isSubmitted && !cardData.p03.isCorrect2
                ? InputStatus.ERROR
                : InputStatus.ENABLE
            }
            readOnly={cardData.p03.isSubmitted}
