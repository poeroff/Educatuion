...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(C01_0005_51);
        ...
        <Box type='dashed' hAlign='center' flexDirection='column' useRound useFull>
              ...
              <TR>
                <TD>
                  <Input
                    ...
                    status={
                      !cardData.p01.isSubmitted
                        ? cardData.p01.answer5.value.trim() === ""
                          ? InputStatus.DEFAULT
                          : InputStatus.ENABLE
                        : cardData.p01.answer5.value.trim() === ""
                        ? InputStatus.ENABLE
                        : cardData.p01.isSubmitted && !cardData.p01.answer5.isCorrect
                        ? InputStatus.ERROR
                        : InputStatus.ENABLE
                    }
                ...
                <TD>
                  <Input
                    ...
                    status={
                      !cardData.p01.isSubmitted
                        ? cardData.p01.answer6.value.trim() === ""
                          ? InputStatus.DEFAULT
                          : InputStatus.ENABLE
                        : cardData.p01.answer6.value.trim() === ""
                        ? InputStatus.ENABLE
                        : cardData.p01.isSubmitted && !cardData.p01.answer6.isCorrect
                        ? InputStatus.ERROR
                        : InputStatus.ENABLE
                    }
                ...
                <TD>
                  <Input
                    ...
                    status={
                      !cardData.p01.isSubmitted
                        ? cardData.p01.answer7.value.trim() === ""
                          ? InputStatus.DEFAULT
                          : InputStatus.ENABLE
                        : cardData.p01.answer7.value.trim() === ""
                        ? InputStatus.ENABLE
                        : cardData.p01.isSubmitted && !cardData.p01.answer7.isCorrect
                        ? InputStatus.ERROR
                        : InputStatus.ENABLE
                    }
          ...
          <Box marginTop='24px'>
            ...
            <Input
              ...
              status={
                !cardData.p01.isSubmitted
                  ? cardData.p01.answer8.value.trim() === ""
                    ? InputStatus.DEFAULT
                    : InputStatus.ENABLE
                  : cardData.p01.answer8.value.trim() === ""
                  ? InputStatus.ENABLE
                  : cardData.p01.isSubmitted && !cardData.p01.answer8.isCorrect
                  ? InputStatus.ERROR
                  : InputStatus.ENABLE
              }
