...
const P02 = () => {
  ...
  const isAnswer2Correct = useMemo(() => cardData.p02.input2.join('') === answers[1], [cardData.p02.input2]);
  const isAnswer3Correct = useMemo(() => cardData.p02.input3.join('') === answers[2], [cardData.p02.input3]);
  const isAnswer4Correct = useMemo(() => cardData.p02.input4.join('') === answers[3], [cardData.p02.input4]);
      ...
      if (userSubmissionList.length > 0) {
        setCardData(prev => ({
          ...
          p02: {
            ...
            input3: userSubmissionList[0].inputData[2]?.value || cardData.p02.input3,
            input4: userSubmissionList[0].inputData[3]?.value || cardData.p02.input4,
            isSubmitted,
          },
        }));
      }
  ...
  const isInputComplete = useMemo(() => {
    return (
      cardData.p02.input1.every(value => value !== '') &&
      cardData.p02.input2.every(value => value !== '') &&
      cardData.p02.input3.every(value => value !== '') &&
      cardData.p02.input4.every(value => value !== '')
    );
  }, [cardData.p02.input1, cardData.p02.input2, cardData.p02.input3, cardData.p02.input4]);
        ...
        <Box type='dashed' hAlign='center' flexDirection='column' useRound useFull>
          <Table color={EStyleTableTypes.MATH} sizes={['25%', '25%', '25%', '25%']}>
            ...
            <TFoot>
              <TR>
                <TD>
                  <Input
                    value={cardData.p02.input1[2]}
                    onChange={e => handleListInputChange(2, 1, e)}
                    status={
                      !cardData.p02.isSubmitted
                        ? InputStatus.ENABLE
                        : cardData.p02.input1[2].trim() === answers[0][2]
                        ? InputStatus.ENABLE
                        : InputStatus.ERROR
                    }
                ...
                <TD>
                  <Input
                    value={cardData.p02.input1[1]}
                    onChange={e => handleListInputChange(1, 1, e)}
                    status={
                      !cardData.p02.isSubmitted
                        ? InputStatus.ENABLE
                        : cardData.p02.input1[1].trim() === answers[0][1]
                        ? InputStatus.ENABLE
                        : InputStatus.ERROR
                    }
                    readOnly={cardData.p02.isSubmitted}
                ...
                <TD>
                  <Input
                    ...
                    status={
                      !cardData.p02.isSubmitted
                        ? InputStatus.ENABLE
                        : cardData.p02.input1[0].trim() === answers[0][0]
                        ? InputStatus.ENABLE
                        : InputStatus.ERROR
                    }
                    readOnly={cardData.p02.isSubmitted}
          ...
          <Box marginTop='24px'>
            ...
            <Input
              ...
              maxLength={5}
              value={cardData.p02.input3[0]}
              onChange={e => handleListInputChange(0, 3, e)}
              status={
                !cardData.p02.isSubmitted ? InputStatus.ENABLE : cardData.p02.input3[0].trim() === answers[2] ? InputStatus.ENABLE : InputStatus.ERROR
              }
              readOnly={cardData.p02.isSubmitted}
            />
          </Box>
        ...
        <Box type='dashed' hAlign='center' flexDirection='column' useRound useFull>
          <Table color={EStyleTableTypes.MATH} sizes={['25%', '25%', '25%', '25%']}>
            ...
            <TFoot>
              <TR>
                <TD>
                  <Input
                    value={cardData.p02.input2[3]}
                    onChange={e => handleListInputChange(3, 2, e)}
                    status={
                      !cardData.p02.isSubmitted
                        ? InputStatus.ENABLE
                        : cardData.p02.input2[3].trim() === answers[1][3]
                        ? InputStatus.ENABLE
                        : InputStatus.ERROR
                    }
                    readOnly={cardData.p02.isSubmitted}
                ...
                <TD>
                  <Input
                    value={cardData.p02.input2[2]}
                    onChange={e => handleListInputChange(2, 2, e)}
                    status={
                      !cardData.p02.isSubmitted
                        ? InputStatus.ENABLE
                        : cardData.p02.input2[2].trim() === answers[1][2]
                        ? InputStatus.ENABLE
                        : InputStatus.ERROR
                    }
                    readOnly={cardData.p02.isSubmitted}
                ...
                <TD>
                  <Input
                    value={cardData.p02.input2[1]}
                    onChange={e => handleListInputChange(1, 2, e)}
                    status={
                      !cardData.p02.isSubmitted
                        ? InputStatus.ENABLE
                        : cardData.p02.input2[1].trim() === answers[1][1]
                        ? InputStatus.ENABLE
                        : InputStatus.ERROR
                    }
                    readOnly={cardData.p02.isSubmitted}
                ...
                <TD>
                  <Input
                    value={cardData.p02.input2[0]}
                    onChange={e => handleListInputChange(0, 2, e)}
                    status={
                      !cardData.p02.isSubmitted
                        ? InputStatus.ENABLE
                        : cardData.p02.input2[0].trim() === answers[1][0]
                        ? InputStatus.ENABLE
                        : InputStatus.ERROR
                    }
                    readOnly={cardData.p02.isSubmitted}
          ...
          <Box marginTop='24px'>
            ...
            <Input
              ...
              maxLength={5}
              value={cardData.p02.input4[0]}
              onChange={e => handleListInputChange(0, 4, e)}
              status={
                !cardData.p02.isSubmitted ? InputStatus.ENABLE : cardData.p02.input4[0].trim() === answers[3] ? InputStatus.ENABLE : InputStatus.ERROR
              }
              readOnly={cardData.p02.isSubmitted}
            />
          </Box>
