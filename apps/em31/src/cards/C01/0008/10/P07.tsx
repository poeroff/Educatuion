...
const P07 = () => {
  ...
  const onCalculate = () => {
    if (cardData.p07.isSubmitted) {
      ...
      const isCorrect2 = cardData.p07.answer2.trim() === cardData.p07.solution2;
      const isCorrect3 = cardData.p07.answer3.trim() === cardData.p07.solution3;
      const isCorrect4 = cardData.p07.answer4.trim() === cardData.p07.solution4;
      console.log(isCorrect1);
      const isCorrect = isCorrect1 && isCorrect2 && isCorrect3 && isCorrect4;
      setCardData(prev => ({
        ...prev,
        p07: { ...prev.p07, isSubmitted: true, isCorrect: isCorrect, isCorrect1, isCorrect2, isCorrect3, isCorrect4 },
      }));
      ...
      if (userSubmissionList.length > 0) {
        setCardData(prev => ({
          ...
          p07: {
            ...
            isSubmitted,
            isCorrect1: userSubmissionList[0].inputData[0]?.isCorrect || cardData.p07.isCorrect1,
            isCorrect2: userSubmissionList[0].inputData[1]?.isCorrect || cardData.p07.isCorrect2,
            isCorrect3: userSubmissionList[0].inputData[2]?.isCorrect || cardData.p07.isCorrect3,
            isCorrect4: userSubmissionList[0].inputData[3]?.isCorrect || cardData.p07.isCorrect4,
  ...
  const handleChange = (subKey: number, value: string) => {
    if (subKey === 1) {
      ...
      setCardData(prev => ({ ...prev, p07: { ...prev.p07, answer2: value } }));
    } else if (subKey === 3) {
      setCardData(prev => ({ ...prev, p07: { ...prev.p07, answer3: value } }));
    } else if (subKey === 4) {
      setCardData(prev => ({ ...prev, p07: { ...prev.p07, answer4: value } }));
    }
  ...
  return (
    <Container
      ...
      submitDisabled={!(cardData.p07.answer1 && cardData.p07.answer2 && cardData.p07.answer3 && cardData.p07.answer4)}
      submitBtnColor={
        !(cardData.p07.answer1 && cardData.p07.answer2 && cardData.p07.answer3 && cardData.p07.answer4)
        ...
        <Box vAlign='flex-start' marginTop='24px'>
          <Typography>
            ...
            <Input
              ...
              status={cardData.p07.isSubmitted && !cardData.p07.isCorrect1 ? InputStatus.ERROR : InputStatus.ENABLE}
      ...
      <Box hAlign='center' marginTop='24px'>
        <Box vAlign='flex-start' marginTop='24px'>
          ...
          <Input
            ...
            value={cardData.p07.answer2}
            readOnly={cardData.p07.isSubmitted}
            status={cardData.p07.isSubmitted && !cardData.p07.isCorrect2 ? InputStatus.ERROR : InputStatus.ENABLE}
          ...
          <Input
            ...
            value={cardData.p07.answer3}
            readOnly={cardData.p07.isSubmitted}
            status={cardData.p07.isSubmitted && !cardData.p07.isCorrect3 ? InputStatus.ERROR : InputStatus.ENABLE}
          ...
          <Input
            ...
            value={cardData.p07.answer4}
            readOnly={cardData.p07.isSubmitted}
            status={cardData.p07.isSubmitted && !cardData.p07.isCorrect4 ? InputStatus.ERROR : InputStatus.ENABLE}
