...
const P08 = () => {
  ...
  const onCalculate = () => {
    if (cardData.p08.isSubmitted) {
      ...
      setCardData(prev => ({
        ...prev,
        p08: { ...prev.p08, isSubmitted: true, isCorrect: isCorrect, isCorrect1, isCorrect2, isCorrect3 },
      }));
  ...
  const rowAnswer = useMemo(() => {
    if (cardData.p08.answer1 !== 0) {
      return cardData.p08.answer1;
    }
  }, [cardData]);
  ...
  return (
    <Container
      ...
      submitDisabled={!(cardData.p08.answer1 && cardData.p08.answer2 && cardData.p08.answer3)}
      submitBtnColor={
        !(cardData.p08.answer1 && cardData.p08.answer2 && cardData.p08.answer3)
                ...
                data.map((item, index) => (
                  <span key={'stage' + index}>
                    <Radio
                      ...
                      isError={cardData.p08.isSubmitted && rowAnswer !== cardData.p08.solution1}
                    >
                      {/* {item.text} */}
