              ...
              <TFoot>
                <TR>
                  <TD>
                    <Input
                      status={
                        !cardData.p03.answer2.value ? 'default' : cardData.p03.isSubmitted && !cardData.p03.answer2.isCorrect ? 'error' : 'enable'
                      }
                  ...
                  <TD>
                    <Input
                      status={
                        !cardData.p03.answer3.value ? 'default' : cardData.p03.isSubmitted && !cardData.p03.answer3.isCorrect ? 'error' : 'enable'
                      }
                      readOnly={cardData.p03.isSubmitted}
                      value={cardData.p03.answer3.value}
                  ...
                  <TD>
                    <Input
                      status={
                        !cardData.p03.answer4.value ? 'default' : cardData.p03.isSubmitted && !cardData.p03.answer4.isCorrect ? 'error' : 'enable'
                      }
                      readOnly={cardData.p03.isSubmitted}
                      value={cardData.p03.answer4.value}
              ...
              <TFoot>
                <TR>
                  <TD>
                    <Input
                      status={
                        !cardData.p03.answer5.value ? 'default' : cardData.p03.isSubmitted && !cardData.p03.answer5.isCorrect ? 'error' : 'enable'
                      }
                      readOnly={cardData.p03.isSubmitted}
                      value={cardData.p03.answer5.value}
                  ...
                  <TD>
                    <Input
                      status={
                        !cardData.p03.answer6.value ? 'default' : cardData.p03.isSubmitted && !cardData.p03.answer6.isCorrect ? 'error' : 'enable'
                      }
                      readOnly={cardData.p03.isSubmitted}
                      value={cardData.p03.answer6.value}
                  ...
                  <TD>
                    <Input
                      status={
                        !cardData.p03.answer7.value ? 'default' : cardData.p03.isSubmitted && !cardData.p03.answer7.isCorrect ? 'error' : 'enable'
                      }
                      readOnly={cardData.p03.isSubmitted}
                      value={cardData.p03.answer7.value}
        ...
        <Box background='lightGray' borderRadius='12px' marginTop='48px' padding='28px'>
          ...
          <Box position='relative' marginTop='40px'>
            ...
            <Box marginTop='12px'>
              <Box>
                <Typography>
                  각 자리 수 7, 4, 8, 9, 2, 5에 알맞은 글자를 찾아 문장을 만들면 '독도야
                  <br />
                  사랑해'입니다.
                </Typography>
              </Box>
