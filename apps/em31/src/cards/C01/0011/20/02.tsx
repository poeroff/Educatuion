...
const P01 = () => {
  ...
  const explanVal1 = () => {
    return (
      <>
        <InputGuide size={EStyleFontSizes['X-SMALL']} useGap={false} color='var(--color-green-800)' right='-55px'>
          2+4=6
        </InputGuide>
      </>
    );
  ...
  const explanVal2 = () => {
    return (
      <>
        <InputGuide size={EStyleFontSizes['X-SMALL']} useGap={false} color='var(--color-green-800)' right='-14px'>
          9+9=
  ...
  return (
    <Container headerInfo={headerInfo} questionInfo={questionInfo} background={'var(--color-white)'} vAlign='flex-start' useRound>
      <Typography fontSize='32px'>492+194의 계산</Typography>
      <Box vAlign='flex-end' justifyContent='center' marginTop={value > 1 ? 52 : 104}>
