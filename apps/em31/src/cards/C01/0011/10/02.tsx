    ...
    >
      <Box useFull justifyContent='flex-start' flexDirection='column' height={'224px'}>
        ...
        <Box vAlign='center'>
          ...
          <Typography>가장 큰 수와 가장 작은 수의 합을 구해 보세요.</Typography>
        </Box>
        <BoxWrap marginTop='10px' flex='1'>
          ...
          <Box useFull>
            <Drawing width='800px' height='115px' ref={canvasRef} tmpSave={tmpSaveCanvas} disabled={cardData.P02.isSubmitted} />
          </Box>
        </BoxWrap>
        ...
        <Box background='lightGray' borderRadius='12px' marginTop='200px' padding='28px'>
          <Box>
            ...
            <Box display={'flex'} flexDirection={'column'} marginTop='12px' gap={'20px'}>
              <Typography>{'947'}</Typography>
            </Box>
          </Box>
          <Box position='relative' marginTop='40px'>
            <Tag type={ETagLine.GREEN} label='풀이' />
            <Box display={'flex'} flexDirection={'column'} marginTop='12px' gap={'20px'}>
              <Typography>{'예) 가장 큰 수 652와 가장 작은 수 295의 합은 652+295=947입니다.'}</Typography>
            </Box>
          </Box>
        </Box>
      </BottomSheet>
