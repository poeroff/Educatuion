...
const P02 = () => {
  const [cardData, setCardData] = useRecoilState(A04_0005_05);
  ...
  const answers = [
    '일의 자리 수와 십의 자리 수에 4를 각각 곱하여 자리에 맞추어 씁니다.',
    '일의 자리 수 7과 4를 곱하면 28이므로 8을 일의 자리에 쓰고, 2를 십의 자리 수 1과 4를 곱한 4에 더하여 6을 십의 자리에 씁니다.',
