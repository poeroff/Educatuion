...
const P05 = () => {
  ...
  const questionInfo: IQuestionProps = {
    ...
    mark: getMarking(cardData.p05.isSubmitted, cardData.p05.isAllCorrect),
  };
      ...
      if (userSubmissionList.length > 0) {
        setCardData(prev => ({
          ...
          p05: {
            ...prev.p05,
            answer1:
              { ...prev.p05.answer1, value: userSubmissionList[0]?.inputData[0]?.value, isCorrect: userSubmissionList[0]?.inputData[0]?.isCorrect } ||
              cardData.p05.answer1,
            answer2:
              { ...prev.p05.answer2, value: userSubmissionList[0]?.inputData[1]?.value, isCorrect: userSubmissionList[0]?.inputData[1]?.isCorrect } ||
  ...
  const handleChange = (subKey: number, value: string) => {
    if (subKey === 1) {
      ...
      setCardData(prev => ({ ...prev, p05: { ...prev.p05, answer2: { ...prev.p05.answer2, value } } }));
    }
    changeData('P05', 1, subKey, value);
  };

  const handleSubmit = () => {
    const isCorrect1 = cardData.p05.answer1.value === cardData.p05.answer1.solution;
    const isCorrect2 = cardData.p05.answer2.value === cardData.p05.answer2.solution;
  ...
  const getAllInputFilled = () => {
    return cardData.p05.answer1.value && cardData.p05.answer2.value;
  };
  ...
  return (
    ...
    >
          ...
          <BoxWrap display='flex' justifyContent='center' boxGap={0} marginTop='65px'>
            ...
            <Box>
              <Input
                ...
                maxLength={3}
                status={
                  !isNotEmptyString(cardData.p05.answer1.value)
                    ? InputStatus.DEFAULT
                    : cardData.p05.isSubmitted && !cardData.p05.answer1.isCorrect
                    ? InputStatus.ERROR
                    : InputStatus.ENABLE
                }
              />
            ...
            <Box>
              <Input
                ...
                maxLength={3}
                status={
                  !isNotEmptyString(cardData.p05.answer2.value)
                    ? InputStatus.DEFAULT
                    : cardData.p05.isSubmitted && !cardData.p05.answer2.isCorrect
                    ? InputStatus.ERROR
                    : InputStatus.ENABLE
                }
              />
      ...
      <BottomSheet bottomSheetTargetId={`targetContainer_p05`} height='40%' show={showAnswer}>
