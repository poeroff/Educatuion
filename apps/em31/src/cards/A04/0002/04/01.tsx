...
const P01 = () => {
  ...
  const explanation = '한 상자에 20개씩 4상자에 담았으므로 20+20+20+20 또는 20×4입니다.';
  ...
  const questionInfo: IQuestionProps = {
    ...
    text: (
      <Box vAlign={'center'}>
        ...
        <Typography>모은 폐건전지 수를 구하는 식을 써 보세요.</Typography>
      </Box>
    ),
        ...
        <Box type='dashed' padding={'20px 44px'} useRound>
          <Input
            ...
            status={
              !cardData.p01.answer
                ? InputStatus.DEFAULT
                : cardData.p01.isSubmitted && !isAnswer(removeSpaces(cardData.p01.answer), cardData.p01.solution)
                ? InputStatus.ERROR
                : InputStatus.ENABLE
            }
            width='300px'
