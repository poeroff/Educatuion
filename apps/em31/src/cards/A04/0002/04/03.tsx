...
const P03 = () => {
  ...
  const explanation = '20×4=80이므로 80개입니다.';
  const answer = '20, 4, 80 또는 4, 20, 80';
  ...
  const questionInfo: IQuestionProps = {
    ...
    text: (
      <Box vAlign={'center'}>
        ...
        <Typography>모은 폐건전지 수를 구해 보세요</Typography>
      </Box>
    ),
