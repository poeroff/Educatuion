...
import { A04_0004_08 } from './store';
import star from '../../../../assets/icon/header_star.svg';
import { Container } from '@maidt-cntn/ui/math';
import P02 from '@/cards/A04/0004/08/02';
import P03 from '@/cards/A04/0004/08/03';
import P04 from '@/cards/A04/0004/08/04';
import P05 from '@/cards/A04/0004/08/05';
import P06 from '@/cards/A04/0004/08/06';
import P07 from '@/cards/A04/0004/08/07';
import P08 from '@/cards/A04/0004/08/08';
import Slider from 'react-slick';

const P01 = () => {
  const { changeData, initData, submitDataWithResult, saveData } = usePageData();
  const [cardData, setCardData] = useRecoilState(A04_0004_08);
      ...
      <BoxWrap height={'304px'}>
        <Box type='dashed' hAlign='center' flexDirection='column' useRound useFull>
          <Table color={EStyleTableTypes.MATH_NONE} sizes={['33%', '33%', '33%']}>
            <TableMathCaption caption='세로셈' math={['31', '×', '9']} />
            <THead hidden>
              <TR>
        ...
        <Box type='dashed' hAlign='center' flexDirection='column' useRound useFull>
          <Table color={EStyleTableTypes.MATH_NONE} sizes={['33%', '33%', '33%']}>
            <TableMathCaption caption='세로셈' math={['73', '×', '3']} />
            <THead hidden>
              <TR>
                <TH scope='col'>일의 자리</TH>
                <TH scope='col'>십의 자리</TH>
          ...
          <Box position='relative' marginTop='40px'>
            ...
            <BoxWrap flexWrap='wrap'>
              ...
              <Box hAlign='center' flexDirection='column' flex='1 1 45%' marginTop='20px' useRound useFull>
                <Table color={EStyleTableTypes.MATH} sizes={['33%', '33%', '33%']}>
                  <TableMathCaption caption='세로셈' math={['53', '×', '2']} />
                  <THead hidden>
                    <TR>
                      <TH scope='col'>일의 자리</TH>
                      <TH scope='col'>십의 자리</TH>
              ...
              <Box hAlign='center' flexDirection='column' flex='1 1 45%' marginTop='20px' marginRight='24px' useRound useFull>
                <Table color={EStyleTableTypes.MATH} sizes={['33%', '33%', '33%']}>
                  <TableMathCaption caption='세로셈' math={['80', '×', '8']} />
                  <THead hidden>
                    <TR>
                      <TH scope='col'>일의 자리</TH>
                      <TH scope='col'>십의 자리</TH>
          ...
          <Carousel
            ...
            controller={({ goto }) => (
              <BoxWrap justifyContent='center' alignItems='center' position='absolute' left={0} right={0} bottom={0}>
                <DotIndicator length={!cardData.p01.isCorrect ? 4 : 3} activeNumber={activeIndex} onClick={idx => goto(idx)} />
              </BoxWrap>
            )}
          >
            {!cardData.p01.isCorrect
              ? [<P02 key={'P02'} />, <P03 key={'P03'} />, <P04 key={'P04'} />, <P05 key={'P05'} />]
              : [<P06 key={'P06'} />, <P07 key={'P07'} />, <P08 key={'P08'} />]}
          </Carousel>
        </Box>
      </Dialog>
    </Container>
