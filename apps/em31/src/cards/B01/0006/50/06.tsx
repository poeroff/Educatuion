...
const P06 = () => {
  ...
  return (
    <Container
      ...
      submitLabel={cardData.p06.isSubmitted ? (showAnswer ? '풀이 닫기' : '풀이 보기') : '채점하기'}
            ...
            <BoxWrap>
              <Box flexDirection='column' useRound useFull>
                <Table color={EStyleTableTypes.MATH} sizes={['33%', '33%', '33%']}>
                  <TableMathCaption caption='가로셈' math={['565', '-', '319']} />
                  <THead hidden>
                    <TR>
                  ...
                  <TFoot>
                    <TR>
                      ...
                      <TD>{cardData.p06.solution1_3}</TD>
                      <TD></TD>
                    </TR>
                  </TFoot>
                </Table>
