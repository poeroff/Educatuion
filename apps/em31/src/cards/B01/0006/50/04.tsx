...
const P04 = () => {
  ...
  return (
    <Container
      ...
      submitLabel={cardData.p04.isSubmitted ? (showAnswer ? '풀이 닫기' : '풀이 보기') : '채점하기'}
    ...
    >
      <Box hAlign='center' flexDirection='column' useRound useFull>
        <Box type='dashed' vAlign='center' useRound padding='24px 48px'>
          <Typography>
            <MathExpression equation={'$494-208=$'} />
          </Typography>
          <Input
            width='130px'
            value={cardData.p04.answer1}
            ...
            <BoxWrap>
              <Box flexDirection='column' useRound useFull>
                <Table color={EStyleTableTypes.MATH} sizes={['33%', '33%', '33%']}>
                  <TableMathCaption caption='가로셈' math={['494', '-', '208']} />
                  <THead hidden>
                    <TR>
                  ...
                  <TFoot>
                    <TR>
                      ...
                      <TD>{cardData.p04.solution1_3}</TD>
                      <TD></TD>
                    </TR>
                  </TFoot>
                </Table>
