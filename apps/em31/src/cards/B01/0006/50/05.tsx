...
const P05 = () => {
  ...
  const handleSubmit = () => {
    ...
    setCardData(prev => ({ ...prev, p05: { ...prev.p05, isSubmitted: true, isCorrect: isCorrect1 } }));
    ...
    submitDataWithResult('P05', userSubmission, isCorrect1);
  };
  ...
  return (
    <Container
      ...
      submitLabel={cardData.p05.isSubmitted ? (showAnswer ? '풀이 닫기' : '풀이 보기') : '채점하기'}
      background={'var(--color-white)'}
      useRound
      submitDisabled={!cardData.p05.answer1}
      submitBtnColor={!cardData.p05.answer1 ? EStyleButtonTypes.SECONDARY : showAnswer ? EStyleButtonTypes.GRAY : EStyleButtonTypes.YELLOW}
    >
      <Box hAlign='center'>
            ...
            <BoxWrap>
              <Box flexDirection='column' useRound useFull>
                <Table color={EStyleTableTypes.MATH} sizes={['33%', '33%', '33%']}>
                  <TableMathCaption caption='가로셈' math={['819', '-', '627']} />
                  <THead hidden>
                    <TR>
                  ...
                  <TFoot>
                    <TR>
                      <TD>{cardData.p05.solution1_1}</TD>
                      <TD>{cardData.p05.solution1_2}</TD>
                      <TD>{cardData.p05.solution1_3}</TD>
                      <TD></TD>
                    </TR>
                  </TFoot>
                </Table>
