...
const P06 = () => {
  ...
  return (
    <Container
      ...
      submitDisabled={(cardData.p06.isSubmitted || !cardData.p06.answer) && !cardData.p06.isSubmitted && !isShow}
          ...
          <BoxWrap display='flex' justifyContent='center' boxGap={0} marginTop='65px'>
            ...
            <Box>
              <Input
                ...
                ariaLabel='307+506의 값'
                status={cardData.p06.isSubmitted && cardData.p06.answer !== cardData.p06.solution ? 'error' : ''}
              />
            </Box>
          </BoxWrap>
        </Box>
              ...
              <Box hAlign='center' flexDirection='column' useRound useFull>
                <Table color={EStyleTableTypes.MATH} sizes={['33%', '33%', '33%']}>
                  ...
                  <TFoot>
                    <TR>
                      <TD>
                        <Input value={'3'} ariaLabel='일의 자리의 답' maxLength={1} />
                      </TD>
                      <TD>
                        <Input value={'1'} ariaLabel='십의 자리의 답' maxLength={1} />
                      </TD>
                      <TD>
                        <Input value={'8'} ariaLabel='십의 자리의 답' maxLength={1} />
                      </TD>
                      <TD></TD>
                    </TR>
                  </TFoot>
