...
const EM00401 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(B01000370);
            ...
            <BoxWrap>
              <Box hAlign='center' flexDirection='column' useRound useFull>
                <Table color={EStyleTableTypes.MATH} sizes={['25%', '25%', '25%', '25%']}>
                  <TableMathCaption caption='세로셈' math={['34☐', '+', '☐45']} />
                  <THead hidden>
                    <TR>
              ...
              <Box hAlign='center' flexDirection='column' useRound useFull>
                <Typography>㉠+5=13, ㉠=8</Typography>
                <Typography>1+4+4=9, ㉢=9</Typography>
                <Typography>3+㉡=8, ㉡=5</Typography>
              </Box>
            </BoxWrap>
          </Box>
          <Box>
            ...
            <Box display={'flex'} flexDirection={'column'} marginTop='12px' gap={'20px'}>
              <Typography>가로셈을 세로셈으로 바꿔 계산하여 ☐ 안에 알맞은 수를 구해 봐요.</Typography>
            </Box>
          </Box>
        </Box>
      </BottomSheet>
