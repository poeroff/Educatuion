            ...
            <Box type='dashed' hAlign='center' useRound width='636px' height='172px'>
                <BoxWrap display='flex' justifyContent='center' boxGap={0} marginTop='65px'>
                    ...
                    <Box>
                        ...
                        status={cardData.p09.isSubmitted && cardData.p09.answer1.trim() !== cardData.p09.solution1 ? 'error' : ''}
                        ariaLabel='298+151의 값.'
                        tabIndex={104}
                        />
                    </Box>
                </BoxWrap>
            ...
            <BoxWrap marginTop='12px'>
              <Box hAlign='center' flexDirection='column' useRound useFull>
                <Table color={EStyleTableTypes.MATH} sizes={['33%', '33%', '33%']}>
                  <TableMathCaption caption='세로셈' math={['298', '+', '151']} />
                  <THead hidden>
                    <TR>
