...
const P04 = () => {
  ...
  return (
    <Container
      ...
      submitDisabled={!(cardData.p04.answer1 && cardData.p04.answer2) && !cardData.p04.isSubmitted && !isShow}
      submitBtnColor={
    ...
    >
      ...
      <Box marginTop='10px' vAlign='flex-start' paddingBottom='6px'>
      ...
      <BottomSheet height={'50%'} show={isShow} bottomSheetTargetId={'targetContainer'} closeOption={{ useYn: true, onClose: () => setShow(false) }}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px' padding='28px'>
          ...
          <Box position='relative' marginTop='40px'>
            ...
            <Box display={'flex'} flexDirection={'column'} marginTop='12px' gap={'20px'}>
              <Typography>
                표에서 쓰담 달리기에서 주운 알루미늄 캔의 지난달과 이번 달의 양을 살펴보면 지난달은 287개, 이번 달은 121개입니다.
              </Typography>
            </Box>
          </Box>
        </Box>
