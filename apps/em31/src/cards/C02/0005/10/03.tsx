    ...
    >
      <BoxWrap>
        <Box display='flex' vAlign='center' flexDirection='column' useFull>
          ...
          <Box display='flex' useFull marginTop='10px' paddingLeft={24}>
            <Checkbox
              readOnly={cardData[storeKey].isSubmitted}
              isError={
      ...
      <BottomSheet bottomSheetTargetId='targetContainer3' height='40%' show={isShow}>
          ...
          <Box marginTop='10px'>
            ...
            <Box marginTop='12px'>
              <List gap={30} align='horizontal' data={SOLUTION_DATA}>
                {({ value, index = 1 }) => (
                  <Box display='flex' width='120px' height='120px' hAlign='center' paddingRight={15}>
                    <Box display='flex'>
                      <Label type='text'>{value?.label}</Label>
                      <Box hAlign='center' type='line' width='100px' height='100px' useRound>
                        <Image src={value?.src as string} alt={value?.alt} width='75px' />
                      </Box>
                    </Box>
                  </Box>
                )}
