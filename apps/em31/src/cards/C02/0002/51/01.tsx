...
const P01 = () => {
  ...
  const [cardData, setCardData] = useRecoilState(C02_0002_51);
  ...
  const imageInfo = {
    ...
    imageSrc: '/C02/0002/51/DEC312004.png',
    imageWidth: '750px',
  };
  const questionNode = (
  ...
  const commentary = '곧은 선은 구부러지거나 휘어지지 않고 반듯한 선입니다.';
