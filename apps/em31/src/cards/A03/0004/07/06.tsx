...
const P06 = () => {
    ...
    text: (
      <>
        ...
        <Box display='flex' marginTop={'5px'}>
          <Typography fontSize='25px'>주어진 세 수를 이용하여</Typography>
  ...
  const handleSubmit = () => {
    ...
    const isAnswer1 = checkAnswers(cardData.p06.answer1, cardData.p06.solution1[0]);
    const isAnswer2 = checkAnswers(cardData.p06.answer1, cardData.p06.solution1[1]);
    const isAnswer3 = checkAnswers(cardData.p06.answer2, cardData.p06.solution2[0]);
    const isAnswer4 = checkAnswers(cardData.p06.answer2, cardData.p06.solution2[1]);
    ...
    setCardData(prev => ({ ...prev, p06: { ...prev.p06, isSubmitted: true, isCorrect1, isCorrect2, isAllCorrect } }));
        ...
        inputData: [
          {
            subKey: 1,
            type: 'TEXT',
            value: cardData.p06.answer1[0],
          },
          {
            subKey: 2,
            type: 'TEXT',
            value: cardData.p06.answer1[1],
          },
          {
            subKey: 3,
            type: 'TEXT',
            value: cardData.p06.answer1[2],
          },
          {
            subKey: 4,
            type: 'TEXT',
            value: cardData.p06.answer1[3],
          },
          {
            subKey: 5,
            type: 'TEXT',
            value: cardData.p06.answer1[4],
          },
          {
            subKey: 6,
            type: 'TEXT',
            value: cardData.p06.answer1[5],
          },
          {
            subKey: 7,
            type: 'TEXT',
            value: cardData.p06.answer2[0],
          },
          {
            subKey: 8,
            type: 'TEXT',
            value: cardData.p06.answer2[1],
          },
          {
            subKey: 9,
            type: 'TEXT',
            value: cardData.p06.answer2[2],
          },
          {
            subKey: 10,
            type: 'TEXT',
            value: cardData.p06.answer2[3],
          },
          {
            subKey: 11,
            type: 'TEXT',
            value: cardData.p06.answer2[4],
          },
          {
            subKey: 12,
            type: 'TEXT',
            value: cardData.p06.answer2[5],
          },
        ],
  ...
  const handleChange = (key: number, index: number, value: string) => {
    if (key === 1) {
      const inputAnswer = [...cardData.p06.answer1];
      inputAnswer[index] = value;
      setCardData(prev => ({ ...prev, p06: { ...prev.p06, answer1: inputAnswer } }));
    } else if (key === 2) {
      const inputAnswer = [...cardData.p06.answer2];
      inputAnswer[index - 6] = value;
      setCardData(prev => ({ ...prev, p06: { ...prev.p06, answer2: inputAnswer } }));
    }
    changeData('P06', 1, index + 1, value);
  };

  const handleInputStatus = (key: number, index: number): InputStatus => {
    if (key === 1) {
      return !isNotEmptyString(cardData.p06.answer1[index])
        ? InputStatus.DEFAULT
        : cardData.p06.isSubmitted && !cardData.p06.isCorrect1
        ? InputStatus.ERROR
        : InputStatus.ENABLE;
    }
    return !isNotEmptyString(cardData.p06.answer2[index])
      ? InputStatus.DEFAULT
      : cardData.p06.isSubmitted && !cardData.p06.isCorrect2
      ? InputStatus.ERROR
      : InputStatus.ENABLE;
  };

  const isInputAnswer = () => {
    const answerList1 = [...cardData.p06.answer1];
    const answerList2 = [...cardData.p06.answer2];
  ...
  return (
    ...
    >
      ...
      <BottomSheet bottomSheetTargetId='targetContainer6' show={isShow} height='30%'>
