...
const P02 = () => {
  ...
  const handleSubmit = () => {
    ...
    const isCorrect =
      (cardData.p02.answer[0] === cardData.p02.solution[1] &&
        cardData.p02.answer[1] === cardData.p02.solution[0] &&
        cardData.p02.answer[2] === cardData.p02.solution[0] &&
        cardData.p02.answer[3] === cardData.p02.solution[1]) ||
      (cardData.p02.answer[0] === cardData.p02.solution[0] &&
        cardData.p02.answer[1] === cardData.p02.solution[1] &&
        cardData.p02.answer[2] === cardData.p02.solution[1] &&
        cardData.p02.answer[3] === cardData.p02.solution[0]);
      ...
      <Box display='flex' hAlign='center'>
        ...
        <Box>
          <Box type='dashed' useRound hAlign='center' padding='24px'>
            <MathExpression equation={'$20\\div$'} />
            <Input
              width='121px'
              maxLength={1}
              type='number'
        ...
        <Box background='lightGray' borderRadius='12px' marginTop='48px' padding='28px'>
          <Box>
            ...
            <Box display={'flex'} flexDirection={'column'} marginTop='12px' gap={'20px'}>
              <Typography>5, 4, 4, 5 또는 4, 5, 5, 4</Typography>
            </Box>
          </Box>
          <Box position='relative' marginTop='40px'>
            <Tag type={ETagLine.GREEN} label='풀이' />
            <Box display={'flex'} flexDirection={'column'} marginTop='12px' gap={'20px'}>
              <Typography>곱셈식 5×4=20을 나눗셈식 2개로 나타내면 20÷5=4, 20÷4=5입니다.</Typography>
            </Box>
          </Box>
        </Box>
      </BottomSheet>
