...
const P02 = () => {
  ...
  return (
    ...
    >
      ...
      <BottomSheet height={'50%'} show={cardData.p02.isSubmitted && isShow} bottomSheetTargetId={'targetContainer'}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px' padding='28px'>
          <Box>
            <Tag type={ETagLine.GREEN} label='예시 답안' />
            <Box display={'flex'} flexDirection={'column'} marginTop='12px' gap={'20px'}>
              <Typography>해열제 종류별로 하루 동안 먹을 수 있는 횟수를 구하려고 합니다.</Typography>
            </Box>
          </Box>
        </Box>
      </BottomSheet>
