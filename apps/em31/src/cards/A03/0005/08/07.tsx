...
const P07 = () => {
  ...
  const isAnswerUnfilled = () => {
    let flag = false;
    cardData.p07.answer.forEach(ans => {
  ...
  const setSubmitLabel = () => {
    if (cardData.p07.isSubmitted && isShow) {
      return '답안닫기';
    } else if (cardData.p07.isSubmitted && !isShow) {
      return '답안보기';
    } else {
      return '채점하기';
    }
  ...
  const handleSubmit = () => {
    ...
    const isCorrect1 = cardData.p07.answer[0] === cardData.p07.solution[0];
    const isCorrect2 = cardData.p07.answer[1] === cardData.p07.solution[1];
    const isCorrect3 = cardData.p07.answer[2] === cardData.p07.solution[2];
  ...
  const handleChange = (subKey: number, value: string) => {
    const answerList = [...cardData.p07.answer];
    answerList[subKey - 1] = value;

    setCardData(prev => ({ ...prev, p07: { ...prev.p07, answer: answerList } }));
      ...
      <Box vAlign='center' marginTop={30}>
        ...
        <Input
          ...
          status={
            !cardData.p07.answer[0]
              ? InputStatus.DEFAULT
              : cardData.p07.isSubmitted && cardData.p07.answer[0] !== cardData.p07.solution[0]
              ? InputStatus.ERROR
              : InputStatus.ENABLE
          }
          ...
          <Input
            ...
            status={
              !cardData.p07.answer[1]
                ? InputStatus.DEFAULT
                : cardData.p07.isSubmitted && cardData.p07.answer[1] !== cardData.p07.solution[1]
                ? InputStatus.ERROR
                : InputStatus.ENABLE
            }
            readOnly={cardData.p07.isSubmitted}
        ...
        <Box marginLeft={50}>
          ...
          <Input
            ...
            type='number'
            status={
              !cardData.p07.answer[2]
                ? InputStatus.DEFAULT
                : cardData.p07.isSubmitted && cardData.p07.answer[2] !== cardData.p07.solution[2]
                ? InputStatus.ERROR
                : InputStatus.ENABLE
            }
            readOnly={cardData.p07.isSubmitted}
