  ...
  return (
    ...
    >
      <Box justifyContent='center' marginTop='24px'>
        <Typography size={EStyleFontSizes.MEDIUM}>바둑돌 12개를 주머니 3개에 똑같이 나누어 넣으면</Typography>
        <Typography size={EStyleFontSizes.MEDIUM}>주머니 한 개에 넣을 수 있는 바둑돌은</Typography>
        <Input
          value={cardData.p02.answer1}
          ...
          status={
            !cardData.p02.answer1 ? InputStatus.DEFAULT : cardData.p02.isSubmitted && !cardData.p02.isCorrect ? InputStatus.ERROR : InputStatus.ENABLE
          }
        />
        &nbsp;개입니다.
      </Box>
      ...
      <Box justifyContent='center' marginTop='24px'>
        <SvgIcon style={{ verticalAlign: 'text-bottom' }} src={arrow_right} size='35px' />
        <Typography size={EStyleFontSizes.MEDIUM}>12를 3으로 나누면</Typography>
        <Input
          value={cardData.p02.answer2}
          onChange={e => handleChange(2, e.target.value)}
          width='100px'
          ariaLabel='12를 3으로 나눈 값'
          readOnly={cardData.p02.isSubmitted}
          status={
            !cardData.p02.answer2 ? InputStatus.DEFAULT : cardData.p02.isSubmitted && !cardData.p02.isCorrect ? InputStatus.ERROR : InputStatus.ENABLE
          }
        />
        &nbsp;입니다.
      </Box>
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='30%' show={isShow} closeOption={{ useYn: true, onClose: () => setIsShow(false) }}>
        <Box background='lightGray' borderRadius='12px' marginTop='35px'>
          ...
          <Box marginTop='12px'>
            <Typography>바둑돌 12개를 주머니 3개에 똑같이 나누어 넣으면 주머니 한 개에 넣을 수 있는 바둑돌은 4개입니다. </Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
