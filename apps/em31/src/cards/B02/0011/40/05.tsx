...
const P05 = () => {
  ...
  const images = [
    <Image
      type={EImageType.IMG}
      src={'/B02/0011/40/DKC312M03_01.png'}
      width='160px'
      alt='한 점에서 한 선은 굽은 선으로, 다른 한 선은 곧은 선으로 그려진 그림'
    />,
    <Image type={EImageType.IMG} src={'/B02/0011/40/DKC312M03_02.png'} width='160px' alt='이어지지 않은 두 선이 그려진 그림' />,
    <Image type={EImageType.IMG} src={'/B02/0011/40/DKC312M03_03.png'} width='160px' alt='한 점에서 그은 두 반직선이 그려진 그림' />,
  ];
      ...
      <BottomSheet bottomSheetTargetId={'targetContainer'} height='40%' show={isShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box marginTop={'40px'}>
            ...
            <Box marginTop='12px'>
              <Typography>각은 한 점에서 그은 두 반직선으로 이루어진 도형입니다.</Typography>
            </Box>
          </Box>
        </Box>
      </BottomSheet>
