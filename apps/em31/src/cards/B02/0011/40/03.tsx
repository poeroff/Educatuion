...
const P03 = () => {
  ...
  const images = [
    <Image
      type={EImageType.IMG}
      src={'/B02/0011/40/DKC312M02(1).png'}
      width='190px'
      alt='차례로 한 점에서 시작하여 다른 한 점을 지나 끝없이 늘인 곧은 선'
    />,
    <Image type={EImageType.IMG} src={'/B02/0011/40/DKC312M02(2).png'} width='190px' alt='두 점을 곧게 이은 선' />,
    <Image type={EImageType.IMG} src={'/B02/0011/40/DKC312M02(3).png'} width='190px' alt='두 점을 지나 끝없이 늘인 곧은 선이 그려진 그림' />,
  ];
      ...
      <BottomSheet bottomSheetTargetId={'targetContainer'} height='40%' show={isShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box marginTop={'40px'}>
            ...
            <Box marginTop='12px'>
              <Typography>반직선은 한 점에서 시작하여 한쪽으로 끝없이 늘인 곧은 선입니다.</Typography>
            </Box>
          </Box>
        </Box>
      </BottomSheet>
