...
const P08 = () => {
  ...
  const images = [
    <Image
      type={EImageType.IMG}
      src={'/B02/0011/40/DKC312M06_03.png'}
      width='190px'
      alt='한 각의 크기가 직각보다 크고 다른 두 각의 크기가 직각보다 작은 삼각형이 그려진 그림'
    />,
    <Image type={EImageType.IMG} src={'/B02/0011/40/DKC312M06_01.png'} width='190px' alt='세 각의 크기가 모두 직각보다 작은 삼각형이 그려진 그림' />,
    <Image
      type={EImageType.IMG}
      src={'/B02/0011/40/DKC312M06_02.png'}
      width='190px'
      alt='한 각의 크기가 직각이고 다른 두 각의 크기가 직각보다 작은 삼각형이 그려진 그림'
    />,
  ];
      ...
      <BottomSheet bottomSheetTargetId={'targetContainer'} height='40%' show={isShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box marginTop={'40px'}>
            ...
            <Box marginTop='12px'>
              <Typography>직각삼각형은 직각이 있는 삼각형입니다.</Typography>
            </Box>
          </Box>
        </Box>
      </BottomSheet>
