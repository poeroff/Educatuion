...
const P10 = () => {
  ...
  const images = [
    <Image
      type={EImageType.IMG}
      src={'/B02/0011/40/DKC312M08_01.png'}
      width='180px'
      alt='네 변의 길이가 같고, 마주보는 두 쌍의 각 중 한 쌍은 직각보다 크기가 크고 다른 한 쌍은 직각보다 크기가 작은 사각형이 그려진 그림'
    />,
    <Image
      type={EImageType.IMG}
      src={'/B02/0011/40/DKC312M08_02.png'}
      width='180px'
      alt='네 변의 길이가 같고, 네 각의 크기가 모두 직각인 사각형이 그려진 그림'
    />,
    <Image
      type={EImageType.IMG}
      src={'/B02/0011/40/DKC312M08_03.png'}
      width='180px'
      alt='마주보는 두 쌍의 변의 길이가 같고 네 각의 크기가 모두 직각인 사각형이 그려진 그림'
    />,
  ];
      ...
      <BottomSheet bottomSheetTargetId={'targetContainer'} height='40%' show={isShow}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box marginTop={'40px'}>
            ...
            <Box marginTop='12px'>
              <Typography>정사각형은 네 각이 모두 직각이고 네 변의 길이가 모두 같은 사각형입니다.</Typography>
            </Box>
          </Box>
        </Box>
      </BottomSheet>
