...
const P01 = ({ _page = 'P01' }: pageType) => {
  ...
  const [cardData, setCardData] = useRecoilState(C03_0003_40);
  ...
  const questionInfo: IQuestionProps = {
    ...
    text: (
      <>
        ...
        구슬 18개를 6개씩 묶으면 몇 묶음이 되는지 구해 보세요.
      </>
    ),
    size: 'small',
    ...
    >
      <Box display='flex' alignItems='center' flexDirection='column' height={'100%'}>
        <Box padding='32px 20px' useRound>
          <Image src={'/C03/0003/40/DEC313009.png'} alt='구슬 18개가 그려진 그림입니다.' width='638px' height='180px' />
        </Box>
        <Box marginTop='24px'>
          <Box vAlign='center' whiteSpace='nowrap'>
            ...
            />
            <Typography useGap={false}>18</Typography>
          ...
          <Box vAlign='center' marginTop='8px'>
            ...
            <Input
              ...
              readOnly={cardData.p01.isSubmitted}
              status={handleInputStatus(cardData.p01.answer8, cardData.p01.solution8)}
              ariaLabel='8번째 빈칸의 값'
            />
            <Typography useGap={false}>묶음이 됩니다.</Typography>
          </Box>
        ...
        <Box background='lightGray' borderRadius='12px' marginTop='48px'>
          ...
          <Box marginTop='10px' marginBottom='22px'>
            <Typography>
              ...
              {cardData.p01.solution6}, {cardData.p01.solution7}, {cardData.p01.solution8}
            </Typography>
          </Box>
          <Box>
          ...
          <Box marginTop='10px'>
            <Typography>
              <p>뺄셈식과 나눗셈식을 이용하여 구하면 구슬은 3묶음이 됩니다.</p>
            </Typography>
          </Box>
        </Box>
      </BottomSheet>
