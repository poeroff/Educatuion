...
import { C03_0005_51 } from './store';

const P01 = () => {
  const [isShow, setShow] = useState(false);
  const [cardData, setCardData] = useRecoilState(C03_0005_51);
        ...
        <Box background='lightGray' borderRadius='12px' marginTop='48px' padding='28px'>
          <Box>
            ...
            <Box display={'flex'} flexDirection={'column'} marginTop='12px' gap={'20px'}>
              <Typography>2, 8, 7</Typography>
            </Box>
          </Box>
          <Box position='relative' marginTop='40px'>
            <Tag type={ETagLine.GREEN} label='풀이' />
            <Box display={'flex'} flexDirection={'column'} marginTop='12px' gap={'20px'}>
              <Typography>7×2=14이므로 14÷7=2입니다.</Typography>
              <Typography>3×8=24이므로 24÷3=8입니다.</Typography>
              <Typography>9×7=63이므로 63÷9=7입니다.</Typography>
            </Box>
          </Box>
        </Box>
      </BottomSheet>
