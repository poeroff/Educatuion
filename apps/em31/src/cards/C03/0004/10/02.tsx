...
const P02 = ({ _page = 'P02', _store = C03000410_store }: Props) => {
  ...
  const info = {
    imageSrc: '/C03/0004/10/EC31309.png',
    imageAlt: '선인장이 있는 화분이 5개씩 4줄 그려진 그림입니다.',
    imageWidth: '208.95px',
    imageHeight: '155.1px',
    imagePadding: '10px 20px',
  };
...
const SolutionNode = () => {
  const explains = [
    '화분이 5개씩 4줄이므로 5×4=20입니다.',
    '화분이 4개씩 5줄이므로 4×5=20입니다.',
    '화분 20개를 5개씩 묶으면 4묶음이므로 20÷5=4입니다. ',
    '화분 20개를 4개씩 묶으면 5묶음이므로 20÷4=5입니다.',
  ];

  return (
    <>
      <AnswerTagBox marginTop={0} label='답안'>
        <Typography>5, 4, 20, 4, 5, 20 (또는 4, 5, 20, 5, 4, 20)</Typography>
        <Typography>/ 20, 5, 4, 20, 4, 5 (또는 20, 4, 5, 20, 5, 4)</Typography>
      </AnswerTagBox>
