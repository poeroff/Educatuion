...
const EEL07C02A07P03 = ({ layout, pageData, contentInfo }: Props) => {
  const CONST = { ...layout };
    ...
    >
      <Scroll>
        <BoxWrap>
          ...
          <Box useFull textAlign='center'>
            <LabelTypes info='title2' fontSize={32} background='#9747ff' color='#fff' type='paint' value={contentInfo[1]} />
            <Box {...{ marginTop: '20px' }}>
              <Box  height='206px' hAlign='center'>
