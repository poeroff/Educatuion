...
export interface IEEL02C03A07P02 {
...
const EEL02C03A07P02 = ({ headerInfo, questionInfo, cards, number, imageInfo, pageInfo, getCorrectData, getDefaultData }: IEEL02C03A07P02) => {
  ...
  useEffect(() => {
    if (accessToken) {
      setIconSrc(getFileFromCDNWithToken(prefix + '/drop_icon.png', accessToken));
    }
  }, [accessToken]);
