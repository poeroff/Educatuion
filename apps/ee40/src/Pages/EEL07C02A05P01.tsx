...
const EEL07C02A05P01 = ({ headerInfo, questionInfo, audioInfo, data, mainKey, getDefaultData, getCorrectData, imageList }: IEEL07C02A05P01) => {
            ...
            {({ value, index = 1 }) => (
              <Box hAlign='flex-start' gap={4}>
                <Box hAlign='flex-start' gap={8}>
                  <Box alignSelf='flex-start' marginTop={15}>
