...
export interface EEL10C03A08P01 {
...
const EEL10C03A08P01 = ({ headerInfo, questionInfo, text, imageInfo, pageInfo, getCorrectData, getDefaultData }: EEL10C03A08P01) => {
    ...
    >
      <BoxWrap useFull>
        ...
        <Box display={'flex'} flexDirection={'column'} gap={20} justifyContent={'center'} alignItems={'center'}>
          <Drawing width={'650px'} height={'90px'} image={backgroundImage} />
          <Drawing width={'650px'} height={'90px'} image={backgroundImage} />
          <Drawing width={'650px'} height={'90px'} image={backgroundImage} />
        </Box>
      </BoxWrap>
