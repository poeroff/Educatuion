...
const EEL05C02A08P03 = ({ layout, pageData, contentInfo }: Props) => {
  const CONST = { ...layout };
  ...
  return (
    ...
    >
      <Scroll>
        <BoxWrap gap='40px' {...{ marginTop: '25px' }}>
          <Box useFull textAlign='center' marginRight='0'>
            <LabelTypes info='title' fontSize={32} background='#0091FF' color='#fff' type='paint' value={contentInfo[0]} />
            <Box {...{ height: '258px', marginTop: '20px' }} hAlign='center'>
