...
const router: IRouteObject[] = [
  {
    ...
    children: [
      ...
      {
        path: `L04-C02-A05`,
        element: lazyLoad(() => import('../../../cards/L04/C02/A05')),
        params: {
          ...layouts[ELayout.L04C02],
        },
        children: [],
      ...
      {
        path: `L04-C02-A06`,
        element: lazyLoad(() => import('../../../cards/L04/C02/A06')),
        params: {
          ...layouts[ELayout.L04C02],
        },
        children: [],
      ...
      {
        path: `L04-C02-A07`,
        element: lazyLoad(() => import('../../../cards/L04/C02/A07')),
        params: {
          ...layouts[ELayout.L04C02],
        },
        children: [],
      ...
      {
        path: `L04-C02-A08`,
        element: lazyLoad(() => import('../../../cards/L04/C02/A08')),
        params: {
          ...layouts[ELayout.L04C02],
        },
        children: [],
