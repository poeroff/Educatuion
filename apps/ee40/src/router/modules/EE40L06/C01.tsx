...
const router: IRouteObject[] = [
  {
    ...
    children: [
      ...
      {
        path: `L06-C01-A03`,
        element: lazyLoad(() => import('../../../cards/L06/C01/A03')),
        params: {
          ...layouts[ELayout.L06C01],
        },
        children: [],
      ...
      {
        path: `L06-C01-A04`,
        element: lazyLoad(() => import('../../../cards/L06/C01/A04')),
        params: {
          ...layouts[ELayout.L06C01],
        },
        children: [],
      ...
      {
        path: `L06-C01-A05`,
        element: lazyLoad(() => import('../../../cards/L06/C01/A05')),
        params: {
          ...layouts[ELayout.L06C01],
        },
        children: [],
      ...
      {
        path: `L06-C01-A06`,
        element: lazyLoad(() => import('../../../cards/L06/C01/A06')),
        params: {
          ...layouts[ELayout.L06C01],
        },
        children: [],
      ...
      {
        path: `L06-C01-A07`,
        element: lazyLoad(() => import('../../../cards/L06/C01/A07')),
        params: {
          ...layouts[ELayout.L06C01],
        },
        children: [],
      ...
      {
        path: `L06-C01-A08`,
        element: lazyLoad(() => import('../../../cards/L06/C01/A08')),
        params: {
          ...layouts[ELayout.L06C01],
        },
        children: [],
