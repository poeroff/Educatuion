...
const router: IRouteObject[] = [
  {
    ...
    children: [
      ...
      {
        path: `L01-C04-A04`,
        element: lazyLoad(() => import('../../../cards/L01/C04/A04')),
        params: {
          ...layouts[ELayout.QUINARY],
        },
        children: [],
      ...
      {
        path: `L01-C04-A05`,
        element: lazyLoad(() => import('../../../cards/L01/C04/A05')),
        params: {
          ...layouts[ELayout.QUINARY],
        },
        children: [],
      ...
      {
        path: `L01-C04-A06`,
        element: lazyLoad(() => import('../../../cards/L01/C04/A06')),
        params: {
          ...layouts[ELayout.QUINARY],
        },
        children: [],
      ...
      {
        path: `L01-C04-A07`,
        element: lazyLoad(() => import('../../../cards/L01/C04/A07')),
        params: {
          ...layouts[ELayout.QUINARY],
        },
        children: [],
      ...
      {
        path: `L01-C04-A08`,
        element: lazyLoad(() => import('../../../cards/L01/C04/A08')),
        params: {
          ...layouts[ELayout.QUINARY],
        },
        children: [],
