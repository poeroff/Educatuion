...
const P03 = () => {
  ...
  const CONST: Props['Layout'] = {
    ...
    questionInfo: {
      text: '영상을 보고, 민지가 주말에 하는 활동이 무엇인지 골라 봅시다.',
      mark:
        isSubmittedInput(mainKey, 'TEXT-01')
    ...
    video: {
      src: '/L12/C01/A05/EE4-L12-C01-A05-P03.mp4',
      srt: `
      1
    ...
    cardList: ['play the piano', 'ride my bike', 'walk my dog'],
  };
