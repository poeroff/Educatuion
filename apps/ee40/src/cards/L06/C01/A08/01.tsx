...
const CONST: Props = {
  ...
  audioInfo: { audioSrc: '/L06/C01/A08/EE4-L06-C01-A08-P01.mp3', captionSrc: '/L06/C01/A08/EE4-L06-C01-A08-P01.srt' },
  data: [{ text: 'O' }, { text: 'X' }],
  image: {
    src: '/L06/C01/A08/EE4-L06-C01-A08-P01.png',
    alt: '남자아이와 빗자루와 쓰레받기를 들고 있는 여자아이',
  },
  label: ['답안', '대본', '해석'],
};
