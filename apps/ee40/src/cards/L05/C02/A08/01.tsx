...
const CONST: Props = {
  ...
  audioInfo: { audioSrc: '/L05/C02/A08/EE4-L05-C02-A08-P01.mp3' },
  data: [{ text: 'O' }, { text: 'X' }],
  image: {
    src: '/L05/C02/A08/EE4-L05-C02-A08-P01.png',
    alt: '야구 방망이와 야구공을 들고 있는 남자아이와 바이올린 케이스를 매고 난처한 표정을 짓고 있는 여자아이',
  },
  label: ['답안', '대본', '해석'],
};
