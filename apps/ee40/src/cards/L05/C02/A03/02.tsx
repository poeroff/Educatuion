...
const pageInfo: PageProps = {
  ...
  // srtFile:'/L05/C02/A03/EE4-L05-C02-A03-P02.srt',
  srtFile: `
    1
  ...
  `,
  video: '/L05/C02/A03/EE4-L05-C02-A03-P02.mp4',
  mainKey: 0,
};
...
const P02 = () => {
  ...
  const recorderValue = getValueInputData(mainKey, 'RECORDER-03') as boolean;
  ...
  return (
    ...
    >
      <BoxWrap>
        <Box position='relative' zIndex={0} width={480} height={360} marginRight='40px'>
          <VideoPlayer srtFile={srtFile} videoSrc={video} />
        </Box>
        <Box hAlign='center' width={480} height={360}>
