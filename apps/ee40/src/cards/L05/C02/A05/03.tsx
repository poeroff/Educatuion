...
const P03 = () => {
  const data: IListenAndAnswer[] = [
    {
      ...
      audioSrc: '/L05/C02/A05/EE4-L05-C02-A05-P03-01.mp3',
    },
    {
      type: 'B',
      color: '#FFF0CC',
      content: <>Sure.</>,
      audioSrc: '/L05/C02/A05/EE4-L05-C02-A05-P03-02.mp3',
    },
  ];
  ...
  return (
    <EEL01C02A05P01
      ...
      audioInfo={{
        audioSrc: '/L05/C02/A05/EE4-L05-C02-A05-P03.mp3',
        // captionSrc: '/L05/C02/A05/EE4-L05-C02-A05-P03.srt',
      }}
      data={data}
      mainKey={3}
