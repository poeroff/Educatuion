...
const layout = {
  ...
  audioInfo: { audioSrc: '/L11/C01/A05/EE4-L11-C01-A05-P13.mp3', captionSrc: '/L11/C01/A05/EE4-L11-C01-A05-P13.srt' },
};
...
const audioArr = ['/L11/C01/A05/EE4-L11-C01-A05-P13-01.mp3', '/L11/C01/A05/EE4-L11-C01-A05-P13-02.mp3'];

const pageData = { pageNumber: 13, mainKey: 13, getDefaultData, getCorrectData };
