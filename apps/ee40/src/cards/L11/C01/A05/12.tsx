...
const layout = {
  ...
  audioInfo: { audioSrc: '/L11/C01/A05/EE4-L11-C01-A05-P12.mp3', captionSrc: '/L11/C01/A05/EE4-L11-C01-A05-P12.srt' },
};
...
const audioArr = ['/L11/C01/A05/EE4-L11-C01-A05-P12-01.mp3', '/L11/C01/A05/EE4-L11-C01-A05-P12-02.mp3'];
