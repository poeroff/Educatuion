...
const layout = {
  ...
  audioInfo: { audioSrc: '/L11/C01/A05/EE4-L11-C01-A05-P09.mp3', captionSrc: '/L11/C01/A05/EE4-L11-C01-A05-P09.srt' },
};
...
const audioArr = ['/L11/C01/A05/EE4-L11-C01-A05-P09-01.mp3', '/L11/C01/A05/EE4-L11-C01-A05-P09-02.mp3'];
