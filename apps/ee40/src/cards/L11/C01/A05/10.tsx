...
const layout = {
  ...
  audioInfo: { audioSrc: '/L11/C01/A05/EE4-L11-C01-A05-P10.mp3', captionSrc: '/L11/C01/A05/EE4-L11-C01-A05-P10.srt' },
};
...
const audioArr = ['/L11/C01/A05/EE4-L11-C01-A05-P10-01.mp3', '/L11/C01/A05/EE4-L11-C01-A05-P10-02.mp3'];
