...
const pageInfo: PageProps = {
  ...
  questionInfo: {
    text: `활동 방법을 보고, ‘순서대로 네 박자치기’ 활동을 해 봅시다. `,
  },
  data: [
    { question: '교사와 함께 네 박자 치기를 연습한다. 7명씩 한 모둠을 이루고, 요일 카드를 한 장씩 나누어 가진다.' },

    {
      question: `학생들은 네 박자 치기를 하면서 요일을 묻고 월요일 카드를 가진 학생(S1)부터 순서대로 자신이 	가진 카드에 맞게 요일을 말한다.
Ss: What day is it today?
S1(월요일 카드를 가진 학생): It’s Monday.`,
    },
    {
      question: `같은 방법으로 일요일까지 말한다.`,
    },
    {
      question: `일요일까지 모든 요일을 묻고 답하면 다시 카드를 나누어 갖고 놀이를 3회 반복한다.`,
    },
  ],
  srtFile: `1
            00:00:00,000 --> 00:00:03,500
          `,
  video: '/L11/C01/A07/EE4-L11-C01-A07-P01.mp4',
  pdf: '/L11/C01/A07/EE4-L11-C01-A07-P01.pdf',
};
