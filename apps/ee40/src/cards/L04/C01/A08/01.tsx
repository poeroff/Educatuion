...
const CONST: Props = {
  ...
  audioInfo: { audioSrc: '/L04/C01/A08/EE4-L04-C01-A08-P01.mp3', captionSrc: '/L04/C01/A08/EE4-L04-C01-A08-P01.srt' },
  data: [{ text: 'O' }, { text: 'X' }],
  image: {
    src: '/L04/C01/A08/EE4-L04-C01-A08-P01.png',
    alt: '공사장 앞에 서 있는 여자아이와 그 앞에서 헬멧을 쓰고 팔로 금지 표시를 하는 남자 어른',
  },
  label: ['답안', '대본', '해석'],
};
