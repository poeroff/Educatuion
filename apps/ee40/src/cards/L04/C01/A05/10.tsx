...
const layout = {
  ...
  audioInfo: { audioSrc: '/L04/C01/A05/EE4-L04-C01-A05-P10.mp3', captionSrc: '/L04/C01/A05/EE4-L04-C01-A05-P10.srt' },
};
...
const audioArr = ['/L04/C01/A05/EE4-L04-C01-A05-P10-01.mp3', '/L04/C01/A05/EE4-L04-C01-A05-P10-02.mp3'];
