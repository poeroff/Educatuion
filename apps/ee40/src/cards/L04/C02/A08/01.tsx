...
const CONST: Props = {
  ...
  audioInfo: { audioSrc: '/L04/C02/A08/EE4-L04-C02-A08-P01.mp3', captionSrc: '/L04/C02/A08/EE4-L04-C02-A08-P01.srt' },
  data: [{ text: 'O' }, { text: 'X' }],
  image: {
    src: '/L04/C02/A08/EE4-L04-C02-A08-P01.png',
    alt: '급식실에서 식판을 둔 채 줄을 서 있는 아이들과 그 앞에 서서 무언가를 지시하고 있는 남자 선생님',
  },
  label: ['답안', '대본', '해석'],
};
