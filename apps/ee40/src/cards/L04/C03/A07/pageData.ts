  ...
  switch (pageNumber) {
    ...
    case 2:
      return [
        {
          mainKey: 2,
          inputDatas: [[{ subKey: 'TEXT-0', value: 'Don’t run, please.' }]],
        },
      ];
    case 3:
      return [
        {
          mainKey: 3,
          inputDatas: [[{ subKey: 'TEXT-0', value: 'Don’t push, please.' }]],
        },
      ];
    case 4:
      return [
        {
          mainKey: 4,
          inputDatas: [[{ subKey: 'TEXT-0', value: 'Don’t talk, please.' }]],
        },
      ];
    case 5:
      return [
        {
          mainKey: 5,
          inputDatas: [[{ subKey: 'TEXT-0', value: 'Don’t enter, please.' }]],
        },
      ];
    default:
      return [];
