...
const pageInfo: PageProps = {
  ...
  questionInfo: {
    text: `활동 방법을 보고, ‘내 방 꾸미기’ 활동을 해 봅시다.`,
  },
  data: [
    { question: '두 명씩 짝을 이루고, 그림 카드를 섞어서 책상에 엎어 놓는다.' },
    {
      question: `가위바위보를 하여 이긴 학생(S1)은 교과서의 물건 중 하나에 표시(V)하고 위치를 묻는다.
S1: Where is my ruler?`,
    },
    {
      question: `진 학생(S2)은 그림 카드 한 장을 뒤집으며 물건의 위치를 답한다.
S2: (‘탁자 위’ 카드를 뒤집으며) It’s on the table.`,
    },
    {
      question: `S1은 S2의 대답에 맞게 자신의 방 그림에 물건을 그린다.`,
    },
    { question: 'S2는 물음표 카드가 나오면 “I don’t know.”라고 답하고, S1은 원하는 위치에 물건을 그려	넣을 수 있다.' },
    { question: '이미 표시한 물건은 고를 수 없다.' },
    { question: '번갈아 가며 놀이를 계속하여 짝과 서로 완성된 방의 모습을 비교한다.' },
  ],
  srtFile: `1
            00:00:00,000 --> 00:00:03,500
          `,
  video: '/L09/C02/A06/EE4-L09-C02-A06-P01.mp4',
  pdf: '/L09/C02/A06/EE4-L09-C02-A06-P01.zip',
};
