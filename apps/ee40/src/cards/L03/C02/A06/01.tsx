...
import Ico_label01 from '@/assets/icon/ico_label01.png';
import IconDownload from '@/assets/icon/ico_download_white.png';
...
const pageInfo: PageProps = {
  ...
  questionInfo: {
    text: `활동 방법을 보고, ‘손가락 접기 놀이' 활동을 해 봅시다.`,
  },
  data: [
    { question: '학생들은 손가락에 붙임 딱지를 붙이고, 〈Story Song〉을 부르며 교실을 돌아다닌다.' },
    {
      question: `노래가 멈추면, 학생들은 자신과 가장 가까이 있는 친구와 가위바위보를 한다.`,
    },
    {
      question: `진 학생(S1)은 이긴 학생(S2)의 손가락 중 하나를 가리키며 누구인지 묻고, 이긴 학생은 인물을	묘사하는 말을 덧붙여 대답한다.
                  S1: Who is she?
                  S2: She’s my friend. She’s cute.   `,
    },
    { question: 'S2가 대답을 바르게 하면 해당 인물을 붙인 손가락을 접는다.' },
    {
      question: `놀이를 계속하여 모든 손가락을 접으면 주먹을 쥐고 손을 들며 “Great!”라고 외친다.`,
    },
  ],
  srtFile: `1
            00:00:00,000 --> 00:00:03,500
          `,
  video: '/L03/C02/A06/EE4-L03-C02-A06-P01.mp4',
  pdf: '/L03/C02/A06/EE4-L03-C02-A06-P01.pdf',
};
