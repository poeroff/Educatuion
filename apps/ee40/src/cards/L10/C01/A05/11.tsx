...
const layout = {
  ...
  audioInfo: { audioSrc: '/L10/C01/A05/EE4-L10-C01-A05-P11.mp3', captionSrc: '/L10/C01/A05/EE4-L10-C01-A05-P11.srt' },
};
...
const audioArr = ['/L10/C01/A05/EE4-L10-C01-A05-P11-01.mp3', '/L10/C01/A05/EE4-L10-C01-A05-P11-02.mp3'];
