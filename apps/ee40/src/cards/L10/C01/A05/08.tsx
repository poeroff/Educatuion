...
const layout = {
  ...
  audioInfo: { audioSrc: '/L10/C01/A05/EE4-L10-C01-A05-P08.mp3', captionSrc: '/L10/C01/A05/EE4-L10-C01-A05-P08.srt' },
};
...
const audioArr = ['/L10/C01/A05/EE4-L10-C01-A05-P08-01.mp3', '/L10/C01/A05/EE4-L10-C01-A05-P08-02.mp3'];
