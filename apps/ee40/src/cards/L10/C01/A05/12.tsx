...
const layout = {
  ...
  audioInfo: { audioSrc: '/L10/C01/A05/EE4-L10-C01-A05-P12.mp3', captionSrc: '/L10/C01/A05/EE4-L10-C01-A05-P12.srt' },
};
...
const audioArr = ['/L10/C01/A05/EE4-L10-C01-A05-P12-01.mp3', '/L10/C01/A05/EE4-L10-C01-A05-P12-02.mp3'];

const pageData = { pageNumber: 12, mainKey: 12, getDefaultData, getCorrectData };
