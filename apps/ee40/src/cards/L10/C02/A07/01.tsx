...
const CONST: Props = {
  ...
  audioInfo: { audioSrc: '/L10/C02/A07/EE4-L10-C02-A07-P01.mp3', captionSrc: '/L10/C02/A07/EE4-L10-C02-A07-P01.srt' },
  data: [{ text: 'O' }, { text: 'X' }],
  image: {
    src: '/L10/C02/A07/EE4-L10-C02-A07-P01.png',
    alt: '짧은 치마를 입고 있는 여자아이',
  },
  label: ['답안', '대본', '해석'],
};
