...
const P02 = ({ _page = 'P02' }) => {
  ...
  const onSubmit = () => {
    ...
    const isCorrect: boolean =
      isAnswer(cardData.p02.answer1.value, cardData.p02.solution1) &&
      isAnswer(cardData.p02.answer2.value, cardData.p02.solution2) &&
      isAnswer(cardData.p02.answer3.value, cardData.p02.solution3);
  ...
  const handleInputChange = (index: Number, value: string) => {
    if (index === 0) {
      ...
      setCardData(prev => ({ ...prev, p02: { ...prev.p02, answer2: { ...prev.p02.answer2, value: value } } }));
      changeData(_page, 1, 2, value);
    } else {
      setCardData(prev => ({ ...prev, p02: { ...prev.p02, answer3: { ...prev.p02.answer3, value: value } } }));
    ...
    >
        ...
        <Box useFull useRound padding='20px'>
          <BoxWrap justifyContent='center'>
            <Box>
              ...
              <Image type={EImageType.IMG_BG} src={'/B02/0008/10/B-EM32-02-0008-1002(1).png'} alt={''} width='85px' height='81.6px' />
            ...
            <Box marginLeft={'30px'}>
              ...
              <Box display='flex' vAlign='center' hAlign='center'>
                ...
                <Input
                  type='number'
                  width={'65px'}
                  value={String(cardData.p02.answer3.value)}
      ...
      <BottomSheet bottomSheetTargetId='targetContainer' height='40%' show={showAnswer}>
        <Box background='lightGray' borderRadius='12px' marginTop='48px' gap='8px'>
          ...
          <Box marginTop='12px'>
            <Typography> 5, 5, 10</Typography>
          </Box>
          <Box marginTop='12px'>
            <Tag type={ETagLine.GREEN} label='풀이' />
          </Box>
          <Box marginTop='12px'>
            <Typography>첫 번째 원의 반지름은 5 cm이고, 두 번째 원의 반지름은 첫 번째 원의 지름이므로 5×2=10 (cm)입니다.</Typography>
          </Box>
        </Box>
      </BottomSheet>
    </Container>
