    ...
    >
      <Box useRound tabIndex={101}>
        <Box vAlign='center' flexDirection='column'>
          <Box padding='24px 12px' type='line' justifyContent='space-between' hAlign='center' useFull useRound>
            <Box width={'100%'} hAlign='center' flexDirection='column'>
              <Image
